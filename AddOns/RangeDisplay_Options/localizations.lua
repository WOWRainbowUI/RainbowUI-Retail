...
L["Background Tile Size"] = "Размер плитки фона"
L["Border Color"] = "Цвет границы"
L["Border Texture"] = "Текстура границы"
L["Border Thickness"] = "Толщина границы"
L["Check if the unit is visible before doing the range check"] = "Проверять видимость цели перед расчетом дистанции"
L["Check visibility"] = "Проверка видимости"
L["Close range section"] = "Ближний диапазон"
L["Color"] = "Цвет"
L["Copy section settings to other units"] = "Копировать настройки диапазона для других целей"
L["Default section"] = "Диапазон по умолчанию"
L["Enable this color section"] = "Включить этот цвет для диапазона"
L["Enabled"] = "Включено"
L["Enemy only"] = "Только враги"
L["Enemy only sound"] = "Звук только для врагов"
L["Font"] = "Шрифт"
L["Font outline"] = "Контур шрифта"
L["Font size"] = "Размер шрифта"
L["Frame strata"] = "Слой фрейма"
L["Frame's background color"] = "Цвет фона фрейма"
L["Frame's border color"] = "Цвет границы фрейма"
L["Height"] = "Высота"
L["Hide the background if the range display is not active"] = "Скрывать фон, если замер дистанции неактивен"
L["High"] = "Высокий"
L["Lock/Unlock display frame"] = "Закрепить/разблокировать фрейм"
L["Locked"] = "Закреплено"
L["Long range section"] = "Дальний диапазон"
L["Low"] = "Низкий"
L["Medium"] = "Средний"
L["Medium range section"] = "Средний диапазон"
L["Mute"] = "Без звука"
L["None"] = "Нет"
L["Normal"] = "Обычный"
L["Out of range section"] = "Вне зоны досягаемости"
L["Over limit display"] = "Отображение при превышении лимита"
L["Over limit text"] = "Текст при превышении лимита"
L["Play a sound when entering this range"] = "Звуковой сигнал при входе в этот диапазон"
L["Range limit"] = "Лимит дистанции"
L["Ranges above this are not reported"] = "Дистанция выше этого значения не отображается"
L["Reverse"] = "Инвертировать"
L["Short range section"] = "Малый диапазон"
L["Show max-min instead of min-max"] = "Показывать max-min вместо min-max"
L["Show range for enemy targets only"] = "Показывать дистанцию только для врагов"
L["Show/Hide display if the target is further than range limit"] = "Показать/скрыть фрейм, если цель дальше лимита"
L["Strata"] = "Слой"
L["Text"] = "Текст"
...
L["Tile the background texture"] = "Повторять текстуру фона плиткой"
L["Toggle sound"] = "Вкл/выкл звук"
L["Use Section Colors"] = "Цвета диапазонов"
L["Use section colors for background and background color for text"] = "Цвета диапазонов для фона, а цвет фона — для текста"
L["Use warning sound for enemy targets only"] = "Звук предупреждения только для врагов"
