...
ns.optionDefs = {
    ...
    { type="slider", cat="CHAR-FONT", ver=bit.bor(CCS.ALL), key="fontsize_iilvl", label=FONT_SIZE, value=14, default=14, min=3, max=36, step=1, slots=1 }, -- 更改預設值
...
CCS.fontLabels = {
    ...
    ["AR Hei UHK Bold"] = {
        ...
        zhCN = "arheiuhk_bd (繁中聊天字型)",
        zhTW = "arheiuhk_bd (繁中聊天字型)",
    },
    ...
    ["ARKai_T (Traditional Chinese)"] = {
        enUS = "ARKai_T (Simplified Chinese)",      
        zhCN = "ARKai_T（简体中文）",
        zhTW = "ARKai_T（簡體中文）",
    },
