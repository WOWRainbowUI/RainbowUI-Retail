...
local GLOW_REFRESH_SCOPES = { "glow", "viewers" }

local function RefreshGlowConfig()
    if API.RefreshScopes then
        API:RefreshScopes(GLOW_REFRESH_SCOPES)
        return
    end
    API:RefreshConfig()
end
...
local function CreateGlowTab(page, tabId)
    ...
    local colorPicker = UI.CreateColorSwatch(scrollChild, L["Glow Color"], "glowColor", GLOW_REFRESH_SCOPES)
    ...
    page.controls.pixelLines = UI.CreateModernSlider(
        ...
        function(v) CDM.db.glowPixelLines = v; RefreshGlowConfig() end
    )
    ...
    page.controls.pixelFrequency = UI.CreateModernSliderPrecise(
        ...
        function(v) CDM.db.glowPixelFrequency = v; RefreshGlowConfig() end
    )
    ...
    page.controls.pixelLength = UI.CreateModernSlider(
        ...
        function(v) CDM.db.glowPixelLength = v; RefreshGlowConfig() end
    )
    ...
    page.controls.pixelThickness = UI.CreateModernSlider(
        ...
        function(v) CDM.db.glowPixelThickness = v; RefreshGlowConfig() end
    )
    ...
    page.controls.pixelXOffset = UI.CreateModernSlider(
        ...
        function(v) CDM.db.glowPixelXOffset = v; RefreshGlowConfig() end
    )
    ...
    page.controls.pixelYOffset = UI.CreateModernSlider(
        ...
        function(v) CDM.db.glowPixelYOffset = v; RefreshGlowConfig() end
    )
    ...
    page.controls.autocastParticles = UI.CreateModernSlider(
        ...
        function(v) CDM.db.glowAutocastParticles = v; RefreshGlowConfig() end
    )
    ...
    page.controls.autocastFrequency = UI.CreateModernSliderPrecise(
        ...
        function(v) CDM.db.glowAutocastFrequency = v; RefreshGlowConfig() end
    )
    ...
    page.controls.autocastXOffset = UI.CreateModernSlider(
        ...
        function(v) CDM.db.glowAutocastXOffset = v; RefreshGlowConfig() end
    )
    ...
    page.controls.autocastYOffset = UI.CreateModernSlider(
        ...
        function(v) CDM.db.glowAutocastYOffset = v; RefreshGlowConfig() end
    )
    ...
    page.controls.buttonFrequency = UI.CreateModernSlider(
        ...
        function(v) CDM.db.glowButtonFrequency = v / 100; RefreshGlowConfig() end
    )
    ...
    page.controls.procDuration = UI.CreateModernSlider(
        ...
        function(v) CDM.db.glowProcDuration = v / 10; RefreshGlowConfig() end
    )
    ...
    page.controls.procXOffset = UI.CreateModernSlider(
        ...
        function(v) CDM.db.glowProcXOffset = v; RefreshGlowConfig() end
    )
    ...
    page.controls.procYOffset = UI.CreateModernSlider(
        ...
        function(v) CDM.db.glowProcYOffset = v; RefreshGlowConfig() end
    )
