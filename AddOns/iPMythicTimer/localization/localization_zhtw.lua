...
Addon.localization.CURSEASON  = "當前賽季" -- need correct
...
Addon.localization.KEYSNAME   = "鑰石名稱" -- need correct
...
Addon.localization.RNMKEYSBT  = "重新命名鑰石" -- need correct
Addon.localization.RNMKEYSTT  = "這裡可以更改計時器的鑰石名稱。" -- need correct
