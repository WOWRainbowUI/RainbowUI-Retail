...
GTFO = {
	...
	Version = "5.11"; -- Version number (text format)
	VersionNumber = 0; -- Numeric version number for checking out-of-date clients (placeholder until client is detected)
	RetailVersionNumber = 51010; -- Numeric version number for checking out-of-date clients (retail)
	ClassicVersionNumber = 51010; -- Numeric version number for checking out-of-date clients (Vanilla classic)
	...
	CataclysmVersionNumber = 51010; -- Numeric version number for checking out-of-date clients (Wrath classic)
