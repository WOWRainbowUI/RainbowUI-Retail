...
--------
if MSQ then
    NameplateSCT.frame.MSQGroup = MSQ:Group("血條浮動戰鬥文字")
end

local defaultFont = "PEPSI"
if (SharedMedia:IsValid("font", "PEPSI")) then
	defaultFont = "PEPSI"
end
...
function NameplateSCT:RegisterMenu()
	...
	_, optionsMenuName = LibStub("AceConfigDialog-3.0"):AddToBlizOptions("NameplateSCT", L["NameplateSCT"])
	LibStub("AceConfigDialog-3.0"):AddToBlizOptions("Filters", L["Filters"], L["NameplateSCT"])
end
