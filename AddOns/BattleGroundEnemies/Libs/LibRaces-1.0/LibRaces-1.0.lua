...
local MAJOR, MINOR = "LibRaces-1.0", tonumber((gsub("r53","r",""))) or 9999;
...
local data = {
	...
	tauren={deDE={"Tauren","Taurenfrau"},enUS={"Tauren"},esES={"Tauren"},esMX={"Tauren"},frFR={"Tauren","Taurène"},itIT={"Tauren"},koKR={"타우렌"},ptBR={"Tauren","Taurena"},ptPT={"Tauren","Taurena"},ruRU={"Таурен","Тауренка"},zhCN={"牛头人"},zhTW={"牛頭人"}},
	...
	goblin={deDE={"Goblin","Goblinfrau"},enUS={"Goblin"},esES={"Goblin"},esMX={"Goblin"},frFR={"Gobelin","Gobeline"},itIT={"Goblin"},koKR={"고블린"},ptBR={"Goblin","Goblina"},ptPT={"Goblin","Goblina"},ruRU={"Гоблин"},zhCN={"地精"},zhTW={"哥布林"}},
	...
	pandaren={deDE={"Pandaren"},enUS={"Pandaren"},esES={"Pandaren"},esMX={"Pandaren"},frFR={"Pandaren","Pandarène"},itIT={"Pandaren"},koKR={"판다렌"},ptBR={"Pandaren","Pandarena"},ptPT={"Pandaren","Pandarena"},ruRU={"Пандарен","Пандаренка"},zhCN={"熊猫人"},zhTW={"熊貓人"}},
	...
	zandalaritroll={deDE={"Zandalaritroll"},enUS={"Zandalari Troll"},esES={"Trol Zandalari"},esMX={"Trol zandalari"},frFR={"Troll zandalari","Trolle zandalari"},itIT={"Troll Zandalari"},koKR={"잔달라 트롤"},ptBR={"Troll Zandalari","Trolesa Zandalari"},ptPT={"Troll Zandalari","Trolesa Zandalari"},ruRU={"Зандалар","Зандаларка"},zhCN={"赞达拉巨魔"},zhTW={"贊達拉食人妖"}},
