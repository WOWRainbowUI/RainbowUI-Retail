...
function BigDebuffs:SetupOptions()
                    ...
                    friendlyAnchor = {
                        ...
                        args = {
                            friendlyAnchorEnabled = {
                                ...
                                desc = L["Use a separate anchor for friendly nameplates. If disabled, will use the primary anchor settings instead"],
                                type = "toggle",
                                width = "full",
                                order = 1,
                            },
    ...
    LibStub("AceConfigDialog-3.0"):AddToBlizOptions("BigDebuffs", L["BigDebuffs"])
end
