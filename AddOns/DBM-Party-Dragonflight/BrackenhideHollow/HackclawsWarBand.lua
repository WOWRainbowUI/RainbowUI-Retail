...
local specWarnSavageCharge						= mod:NewSpecialWarningYou(381461, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local yellSavageCharge							= mod:NewYell(381461)
local specWarnSavageChargeTarget				= mod:NewSpecialWarningTarget(381461, nil, nil, nil, 1, 2, nil, nil, "helpsoak")
local specWarnBladestorm						= mod:NewSpecialWarningYou(377827, nil, nil, nil, 1, 2, nil, nil, "whirlwind")
...
local specWarnDecayedSenses						= mod:NewSpecialWarningDispel(381379, "RemoveMagic", nil, nil, 1, 2, nil, nil, "helpdispel")
local specWarnGashFrenzy						= mod:NewSpecialWarningCount(378029, "Healer", nil, nil, 2, 2, nil, nil, "healfull")
local specWarnMarkedforButchery					= mod:NewSpecialWarningDefensive(378229, nil, nil, nil, 1, 2, nil, nil, "defensive")
...
local specWarnHextrickTotem						= mod:NewSpecialWarningSwitch(381470, "-Healer", nil, nil, 1, 2, nil, nil, "attacktotem")
local specWarnGreaterHealingRapids				= mod:NewSpecialWarningInterrupt(377950, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
