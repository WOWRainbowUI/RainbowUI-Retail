...
ns.Patrons = "|cFFFFD100目前狀態|r\n\n"
    .. "目前支援所有現有的專精，儘管治療者的優先順序是實驗性，並且僅專注於 DPS 的迴圈。\n\n"
    .. "如果你發現奇怪的建議或其他問題，請點擊下面的 |cFFFFD100問題回報|r 連結並提交所有必要的資訊以調查你的問題。\n\n"
    .. "請|cffff0000不要|r提交例行的優先順序更新 (即來自 SimulationCraft 的更新)，我會定期更新。"
