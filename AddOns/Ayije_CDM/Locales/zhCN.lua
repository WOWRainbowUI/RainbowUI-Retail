...
L["Height"] = "高度"
L["Buff"] = "BUFF增益"
L["Secondary Buff"] = "次要BUFF增益"
L["Tertiary Buff"] = "第三类BUFF增益"
L["Icon Sizes"] = "图标尺寸"
...
L["Buff Layout"] = "BUFF增益布局"
L["Secondary Buffs Grow Horizontally (Centered)"] = "次要BUFF横向扩展（居中）"
L["Tertiary Buffs Grow Horizontally (Centered)"] = "第三类BUFF横向扩展（居中）"
L["Layout"] = "布局"
...
L["Secondary Buff Offset (relative to Main)"] = "次要BUFF偏移（相对于主容器）"
L["Tertiary Buff Offset (relative to Main)"] = "第三类BUFF偏移（相对于主容器）"
...
L["Position"] = "位置"
L["Buff Cooldown Timer"] = "BUFF冷却计时器"
L["Buff Stacks"] = "BUFF层数"
L["Anchor"] = "锚点"
L["Main Buff Bar Position"] = "主BUFF条位置"
L["Secondary Buff Bar Position"] = "次要BUFF条位置"
L["Tertiary Buff Bar Position"] = "第三类BUFF条位置"
...
L["Primary Buff Order"] = "主要BUFF顺序"
L["Press icon to color the border"] = "按下图标以设置边框颜色"
L["Click to change border color"] = "单击以更改边框颜色"
L["Right-click to reset to default"] = "右键单击以重置为默认值"
L["Unknown"] = "未知"
L["Empty Slot %d"] = "空槽位 %d"
L["Spell ID..."] = "法术ID..."
L["Add"] = "添加"
L["Secondary Group"] = "次要组"
L["Tertiary Group"] = "第三类组"
L["Border:"] = "边框："
L["Enable Glow"] = "启用发光"
L["Glow Color:"] = "发光颜色："
L["No specialization detected!"] = "未检测到专精！"
L["Please enter a valid spell ID!"] = "请输入有效的法术ID！"
L["Spell ID %d does not exist!"] = "法术ID %d 不存在！"
L["Category full (max 7 spells)"] = "分类已满（最多7个法术）"
L["Icons"] = "图标"
...
L["Text styling (font size, color, offsets): see Text tab"] = "文字样式（字体大小、颜色、偏移）：请查看文字选项卡"
L["Position lock and X/Y controls: see Positions tab"] = "位置锁定及X/Y控制：请查看位置选项卡"
L["Bars"] = "条形"
