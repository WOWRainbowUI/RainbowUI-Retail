...
L["Height"] = "Höhe"
L["Buff"] = "Buff"
L["Secondary Buff"] = "Sekundärer Buff"
L["Tertiary Buff"] = "Tertiärer Buff"
...
L["Secondary Buffs Grow Horizontally (Centered)"] = "Sekundäre Buffs wachsen horizontal (zentriert)"
L["Tertiary Buffs Grow Horizontally (Centered)"] = "Tertiäre Buffs wachsen horizontal (zentriert)"
L["Layout"] = "Layout"
...
L["Secondary Buff Offset (relative to Main)"] = "Sekundärer Buff-Versatz (relativ zum Haupt-Container)"
L["Tertiary Buff Offset (relative to Main)"] = "Tertiärer Buff-Versatz (relativ zum Haupt-Container)"
...
L["Position"] = "Position"
L["Buff Cooldown Timer"] = "Buff-Abklingzeit-Timer"
L["Buff Stacks"] = "Buff-Stapel"
L["Anchor"] = "Ankerpunkt"
L["Main Buff Bar Position"] = "Haupt-Buff-Leisten-Position"
L["Secondary Buff Bar Position"] = "Sekundäre Buff-Leisten-Position"
L["Tertiary Buff Bar Position"] = "Tertiäre Buff-Leisten-Position"
...
L["Primary Buff Order"] = "Primäre Buff-Reihenfolge"
L["Press icon to color the border"] = "Symbol klicken, um den Rahmen einzufärben"
L["Click to change border color"] = "Klicken, um die Rahmenfarbe zu ändern"
L["Right-click to reset to default"] = "Rechtsklick zum Zurücksetzen auf Standard"
L["Unknown"] = "Unbekannt"
L["Empty Slot %d"] = "Leerer Slot %d"
L["Spell ID..."] = "Zauber-ID..."
L["Add"] = "Hinzufügen"
L["Secondary Group"] = "Sekundäre Gruppe"
L["Tertiary Group"] = "Tertiäre Gruppe"
L["Border:"] = "Rahmen:"
L["Enable Glow"] = "Leuchten aktivieren"
L["Glow Color:"] = "Leuchtfarbe:"
L["No specialization detected!"] = "Keine Spezialisierung erkannt!"
L["Please enter a valid spell ID!"] = "Bitte eine gültige Zauber-ID eingeben!"
L["Spell ID %d does not exist!"] = "Zauber-ID %d existiert nicht!"
L["Category full (max 7 spells)"] = "Kategorie voll (max. 7 Zauber)"
L["Icons"] = "Symbole"
