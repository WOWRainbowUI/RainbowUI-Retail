...
function WhisperEngine:CHAT_MSG_WHISPER(...)
    ...
    local win = getWhisperWindowByUser(arg2, nil, nil, true);
...
function WhisperEngine:CHAT_MSG_BN_WHISPER_INFORM(...)
    ...
    local win = getWhisperWindowByUser(arg2, true, arg13, true);
