...
L["Adjust the X position of the spark"] = true
...
L["Anchor point"] = true
L["AOE Rez"] = true
L["Assign aura sections (buff and debuff presets or custom filters) to each unit of the Buff module, and create your own spell filters."] = true
L["Aura Filters"] = true
...
L["Channeling"] = true
L["Click to remove this spell"] = true
...
L["Enable %s"] = true
L["Enabled"] = true
L["Enabled only out of combat"] = true
L["Enable the casting bar spark"] = true
L["Enemy CastBars"] = true
L["Enter a spell ID, a spell name, or shift-click a spell or talent to link it"] = true
L["Exhaustion"] = true
L["Failed"] = true
L["Feign Death"] = true
...
L["Hide the cast bar immediately after the cast ends instead of fading out"] = true
...
L["Offset"] = true
L["Once created, add spells to the filter, then apply it by adding it as a section on the Player, Target or Focus panel."] = true
L["Outline"] = true
...
L["Open configuration - /quartz"] = true
...
L["Pulse an overlay on the bar while the aura is in its pandemic refresh window"] = true
L["Quartz 3 uses a detached configuration window."] = true
L["Quartz3"] = true
L["Quit"] = true
L["Raid Marker"] = true
L["Raid Marker Position"] = true
L["Range"] = true
L["Release"] = true
L["Remaining Text"] = true
L["Remaining Time"] = true
L["Remove Section"] = true
L["Resurrect"] = true
...
L["Scale"] = true
L["Select a filter or preset to add as a section"] = true
L["Set a name for the new filter"] = true
L["Set the color and maximum opacity of the pandemic overlay"] = true
...
L["Set the color of the bars for stealable buffs"] = true
L["Shadow"] = true
L["Spell whitelists cannot filter debuffs on friendly units or buffs on hostile units (Blizzard restriction); those sections are hidden on such units, except spells Blizzard flags as never secret."] = true
L["Stealable Color"] = true
L["Shadow Color"] = true
...
L["Set the color of the channeling ticks"] = true
...
L["Set the height of the casting bar spark"] = true
L["Set the height of the channeling ticks"] = true
L["Set the height of the GCD bar"] = true
L["Set the height of the swing timer bar"] = true
L["Set the position of the GCD bar"] = true
L["Set the position mode for the latency indicator"] = true
...
L["Set the side of the bar that the raid icon appears on"] = true
...
L["Set the texture of the casting bar spark"] = true
L["Set the texture of the channeling ticks"] = true
L["Set the thickness of the casting bar spark"] = true
L["Set the thickness of the channeling ticks"] = true
...
L["Show raid target markers on the cast bars"] = true
...
L["Show Text"] = true
L["Show the aura tooltip when hovering its bar"] = true
L["Show the icon of the spell being cast"] = true
...
L["Spark Thickness"] = true
L["Spark X Offset"] = true
L["Spell -> Target"] = true
L["Spell Icon"] = true
L["Spell Icon Position"] = true
L["Spell Name"] = true
...
L["Type |cffffd700/quartz|r or click below to open it."] = true
...
L["Vertical"] = true
L["Which auras are displayed on each unit is configured in the Aura Filters module."] = true
L["Width"] = true
L["X"] = true
L["Y"] = true
