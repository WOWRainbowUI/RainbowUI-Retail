...
L["Adjust the X position of the spark"] = "Ajuste la position en X de l'étincelle"
...
L["All Debuffs"] = "Tous les debuffs"
L["All HoTs"] = "Tous les HoTs"
L["Alpha"] = "Transparence"
L["Always Right"] = "Toujours à droite"
L["Anchor Frame"] = "Ancrage"
L["Anchor point"] = "Point d'ancrage"
L["AOE Rez"] = "AOE Rez"
L["Assign aura sections (buff and debuff presets or custom filters) to each unit of the Buff module, and create your own spell filters."] = "Permet d'assigner des sections d'auras aux unités du module Buff (préréglages de buffs et debuffs ou filtres personnalisés) et de créer ses propres filtres de sorts."
L["Aura Filters"] = "Filtres d'auras"
L["Aura Tooltips"] = "Infobulles des auras"
L["Background"] = "Fond"
...
L["Click to remove this spell"] = "Cliquez pour retirer ce sort"
...
L["Create an Aura Filter"] = "Créer un filtre d'auras"
...
L["Enabled"] = "Activé"
L["Enabled only out of combat"] = "Activé uniquement hors combat"
L["Enable the casting bar spark"] = "Active l'étincelle de la barre d'incantation"
L["Enemy CastBars"] = "Barres de sort des ennemis"
L["Enter a spell ID, a spell name, or shift-click a spell or talent to link it"] = "Entrez un ID de sort, un nom de sort, ou maj-cliquez un sort ou un talent pour le lier"
...
L["Hide the cast bar immediately after the cast ends instead of fading out"] = "Masque la barre immédiatement à la fin de l'incantation au lieu du fondu"
...
L["My HoTs"] = "Mes HoTs"
L["New Filter Name"] = "Nom du nouveau filtre"
L["Once created, add spells to the filter, then apply it by adding it as a section on the Player, Target or Focus panel."] = "Une fois créé, ajoutez des sorts au filtre, puis appliquez-le en l'ajoutant comme section dans le panneau Joueur, Cible ou Focus."
L["Poison Color"] = "Couleur des poisons"
L["Raid Marker"] = "Marque de raid"
L["Raid Marker Position"] = "Position de la marque de raid"
...
L["Instant Hide"] = "Masquage instantané"
...
L["Open configuration - /quartz"] = "Ouvrir la configuration - /quartz"
L["Out of Range Color"] = "Couleur de hors portée"
L["Outside"] = "Extérieur"
L["Pandemic Color"] = "Couleur pandémique"
L["Pandemic Highlight"] = "Surbrillance pandémique"
...
L["Pulse an overlay on the bar while the aura is in its pandemic refresh window"] = "Fait pulser un overlay sur la barre quand l'aura est dans sa fenêtre de rafraîchissement pandémique"
L["Quartz 3 uses a detached configuration window."] = "Quartz 3 utilise une fenêtre de configuration détachée."
L["Quartz3"] = "Quartz3"
L["Quit"] = "Quitter"
L["Range"] = "Portée"
L["Release"] = "Libérer"
...
L["Remove Section"] = "Retirer la section"
...
L["Scale"] = "Echelle"
L["Select a filter or preset to add as a section"] = "Sélectionnez un filtre ou un préréglage à ajouter comme section"
L["Set a name for the new filter"] = "Définissez un nom pour le nouveau filtre"
...
L["Set the color of the bars for stealable buffs"] = "Règle la couleur des barres pour les buffs volables"
L["Shadow"] = "Ombre"
...
L["Set the color and maximum opacity of the pandemic overlay"] = "Règle la couleur et l'opacité maximale de l'overlay pandémique"
...
L["Set the color of the channeling ticks"] = "Définit la couleur des ticks de canalisation"
...
L["Set the height of the casting bar spark"] = "Définit la hauteur de l'étincelle"
L["Set the height of the channeling ticks"] = "Définit la hauteur des ticks de canalisation"
...
L["Set the position mode for the latency indicator"] = "Choisit le mode de positionnement de l'indicateur de latence"
...
L["Set the side of the bar that the raid icon appears on"] = "Définit le côté des barres sur lequel l'icône de raid apparaît."
...
L["Set the texture of the casting bar spark"] = "Définit la texture de l'étincelle"
L["Set the texture of the channeling ticks"] = "Définit la texture des ticks de canalisation"
L["Set the thickness of the casting bar spark"] = "Définit l'épaisseur de l'étincelle"
L["Set the thickness of the channeling ticks"] = "Définit l'épaisseur des ticks de canalisation"
...
L["Show raid target markers on the cast bars"] = "Affiche les marqueurs de cible de raid sur les barres de cast"
...
L["Show the aura tooltip when hovering its bar"] = "Affiche l'infobulle de l'aura au survol de sa barre"
L["Show the icon of the spell being cast"] = "Affiche l'icône du sort en cours d'incantation"
...
L["Spark X Offset"] = "Décalage X de l'étincelle"
L["Spell Icon"] = "Icône du sort"
L["Spell Icon Position"] = "Position de l'icône du sort"
...
L["Spell whitelists cannot filter debuffs on friendly units or buffs on hostile units (Blizzard restriction); those sections are hidden on such units, except spells Blizzard flags as never secret."] = "Les listes blanches de sorts ne peuvent pas filtrer les debuffs sur les unités alliées ni les buffs sur les unités hostiles (restriction Blizzard) ; ces sections sont masquées sur ces unités, sauf pour les sorts marqués comme jamais secrets par Blizzard."
L["Stop Timer"] = "Arrêter le minuteur"
L["Summon"] = "Invocation"
L["Stealable Color"] = "Couleur des buffs volables"
L["Swing"] = "Swing"
L["Target"] = "Cible"
...
L["Tick Color"] = "Couleur des ticks"
L["Tick Height"] = "Hauteur des ticks"
L["Tick Texture"] = "Texture des ticks"
L["Tick Thickness"] = "Épaisseur des ticks"
...
L["Type |cffffd700/quartz|r or click below to open it."] = "Tapez |cffffd700/quartz|r ou cliquez ci-dessous pour l'ouvrir."
...
L["Vertical"] = "Vertical"
L["Which auras are displayed on each unit is configured in the Aura Filters module."] = "Les auras affichées pour chaque unité se configurent dans le module Filtres d'auras."
L["Width"] = "Largeur"
L["X"] = "X"
L["Y"] = "Y"
