...
L["Count up from zero instead of down from the cast duration"] = "从零开始计数，而不是从施法持续时间开始计数"
...
L["HIGH"] = "高"
L["Horizontal"] = "水平"
L["How to display target name of spellcasts after spell name"] = "目标法术名称后面显示法术施放名称"
L["Icon"] = "图标"
L["Icon Alpha"] = "图标透明度"
L["Icon Gap"] = "图标间隙"
...
L["Set the bar in front of or behind other UI elements."] = "将条设定在其他用户界面元素的前面或后面。"
...
L["Set the side of the bar that the raid icon appears on"] = "设置团队标记在施法条上显示的位置"
