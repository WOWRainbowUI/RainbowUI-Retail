...
L["Always Right"] = "Всегда справа"
L["Anchor Frame"] = "Фрейм Якоря"
L["Anchor point"] = "Точка привязки"
L["AOE Rez"] = "Масс Возр"
L["Assign aura sections (buff and debuff presets or custom filters) to each unit of the Buff module, and create your own spell filters."] = "Позволяет назначать секции аур целям модуля баффов (пресеты баффов и дебаффов или собственные фильтры) и создавать свои фильтры заклинаний."
...
L["Click to remove this spell"] = "Нажмите, чтобы убрать это заклинание"
...
L["Create an Aura Filter"] = "Создать фильтр аур"
...
L["Enter a spell ID, a spell name, or shift-click a spell or talent to link it"] = "Введите ID заклинания, его название или добавьте ссылку на заклинание или талант через Shift+клик"
...
L["My HoTs"] = "Мои ХоТы"
L["New Filter Name"] = "Название нового фильтра"
L["Once created, add spells to the filter, then apply it by adding it as a section on the Player, Target or Focus panel."] = "После создания добавьте в фильтр заклинания, затем примените его, добавив как секцию на панели «Игрок», «Цель» или «Фокус»."
L["Pandemic Color"] = "Пандемический цвет"
L["Pandemic Highlight"] = "Пандемическая подсветка"
L["Poison Color"] = "Цвет ядов"
L["Pulse an overlay on the bar while the aura is in its pandemic refresh window"] = "Пульсирующий слой на полосе, пока аура находится в пандемическом окне обновления"
L["Raid Icon Position"] = "Позиция рейдовой метки"
...
L["Remove Section"] = "Убрать секцию"
...
L["Select a filter or preset to add as a section"] = "Выберите фильтр или пресет, чтобы добавить его как секцию"
...
L["Set a name for the new filter"] = "Задать название нового фильтра"
...
L["Set the color and maximum opacity of the pandemic overlay"] = "Задать цвет и максимальную непрозрачность пандемического слоя"
...
L["Set the color of the bars for stealable buffs"] = "Установить цвет полос для похищаемых баффов"
...
L["Set the position mode for the latency indicator"] = "Установить режим расположения индикатора задержки"
...
L["Set the side of the bar that the raid icon appears on"] = "Установить сторону полосы, на которой должна находиться рейдовая метка"
...
L["Show Raid Icons"] = "Показывать рейдовые метки"
L["Show raid target markers on the cast bars"] = "Отображать рейдовые метки цели на полосах заклинаний"
...
L["Spell whitelists cannot filter debuffs on friendly units or buffs on hostile units (Blizzard restriction); those sections are hidden on such units, except spells Blizzard flags as never secret."] = "Белые списки заклинаний не могут фильтровать дебаффы на дружественных целях и баффы на враждебных (ограничение Blizzard); такие секции скрываются на этих целях, кроме заклинаний, помеченных Blizzard как никогда не секретные."
L["Stealable Color"] = "Цвет похищаемых баффов"
...
L["Which auras are displayed on each unit is configured in the Aura Filters module."] = "Какие ауры отображаются для каждой цели, настраивается в модуле «Фильтры аур»."
L["Width"] = "Ширина"
L["X"] = "X"
L["Y"] = "Y"
