...
L["Customize the talking head frame."] = "自訂對話頭像框架。"
L["Dialog"] = "對話框"
...
L["Disable overlay backgrounds"] = "停用疊層背景"
...
L["The regular talking head frame appears in the same place as Immersion when you're not interacting with anything and on top of Immersion if they are visible at the same time."] = "沒有和 NPC 或任何事物互動時，遊戲原本的對話頭像框架會和這個插件出現在同一個位置。同時出現時，對話頭像框架會在這個插件的上方。"
L["Tooltip"] = "滑鼠提示"
...
L["Reads quest text aloud using text-to-speech based on options selected."] = "依據所選的選項，使用文字轉語音功能大聲唸出任務內容。"

-- 自行加入
L["Immersion "] = "任務對話 (對話頭像)"
L["Immersion"] = "任務-對話"
L["INSTANT"] = "立即"
