...
local function handleUnitFramePortraitUpdate(self)
	...
	-- else
		-- healthBar:SetStatusBarDesaturated(false) -- 暫時修正
		-- healthBar:SetStatusBarColor(1, 1, 1)
	end
end
...
function BUII_HealthClassColorCheckButton_OnClick(self)
	...
	if self:GetChecked() then
		...
		-- PlayerFrame.PlayerFrameContent.PlayerFrameContentMain.HealthBarArea.HealthBar:SetStatusBarDesaturated(false) -- 暫時修正
