...
L["DYNAMIC_COLORS_GENERAL_DESC"] = "Applique les mêmes seuils de temps restant à toutes les catégories MiniCE activées, y compris le texte d'aura du groupe/raid compact. La gestion des valeurs secrètes est compatible Midnight."
