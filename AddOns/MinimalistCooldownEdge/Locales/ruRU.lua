...
L["ON"] = "ВКЛ"
L["OFF"] = "ВЫКЛ"
L["Category Status"] = "Статус категорий"
...
L["NAMEPLATE_DESC"] = "Стилизуйте перезарядки на индикаторах имён врагов и союзников (Plater, KuiNameplates и т.д.)."
L["UNITFRAME_DESC"] = "Настройте стиль перезарядок на фреймах игрока, цели и фокуса."
L["GLOBAL_DESC"] = "Общая категория для перезарядок, не относящихся к другим категориям (средства просмотра менеджера КД, сумки, меню, прочие аддоны). Включает стилизацию зарядов для Essential и Utility обозревателей перезарядок."
