...
L["PLAYERAURA_DESC"] = "Style Blizzard's default player buff and debuff buttons, including duration text, stack text, fading behavior, and optional cooldown swipes."
