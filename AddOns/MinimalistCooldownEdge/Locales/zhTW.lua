...
L["COMPACT_PARTY_AURA_TEXT_DESC"] = "在內建隊伍框架與團隊框架的增益與減益圖示上顯示樣式化的倒數文字。隊伍與團隊可分別切換。"
...
L["NAMEPLATE_DESC"] = "設定敵方與友方名條上的冷卻樣式（Plater、KuiNameplates 等），包含光環按鈕顯示的層數計數。"
L["UNITFRAME_DESC"] = "調整玩家、目標、焦點、首領與競技場單位框架上的冷卻樣式。"
L["PARTYRAIDFRAMES_DESC"] = "調整隊伍與團隊單位框架上的冷卻樣式。精簡的隊伍與團隊光環文字會使用此分類的字體與定位設定。"
...
L["DYNAMIC_COLORS_GENERAL_DESC"] = "將相同的剩餘時間閾值套用到所有已啟用的極簡冷卻時間類別，包括隊伍/團隊框架光環文字。當暴雪公開隱藏數值時，會使用至暗之夜安全的持續時間處理方式。"
L["Behavior"] = "行為"
