...
L["COMPACT_PARTY_AURA_TEXT_DESC"] = "在內建隊伍框架與團隊框架的增益與減益圖示上顯示樣式化的倒數文字。隊伍與團隊可分別切換。此功能獨立於「其他」選項。"
...
L["DYNAMIC_COLORS_GENERAL_DESC"] = "將相同的剩餘時間閾值套用到所有已啟用的極簡冷卻時間類別，包括隊伍/團隊光環文字。當暴雪公開隱藏數值時，會使用至暗之夜安全的持續時間處理方式。"
L["Behavior"] = "行為"
