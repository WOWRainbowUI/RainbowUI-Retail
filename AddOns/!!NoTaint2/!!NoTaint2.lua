...
if not NoTaint2_Proc_ResetActionButtonAction then
    ...
    local TXT_WARNING_WINDOW = "快捷列已被汙染\n建議盡快 /reload"
    local TXT_WARNING_CHAT_MESSAGE = "無汙染2 提醒: 快捷列已被 [|cffffff00%s|r] |cffff0000汙染|r，已緊急處理，建議|cffffff00盡快重新載入介面|r。"
    local TXT_NOTICE_DISABLE = "輸入 '/notaint2' 停止顯示警告訊息。"
    local TXT_SLASH_SHOW = "無汙染2: 將恢復顯示警告訊息。"
    local TXT_SLASH_STOP = "無汙染2: 此帳號將不再顯示警告訊息，輸入 '/notaint2 show' 恢復警告。"
