...
DBM.Revision = parseCurseDate("20260813223013")
...
---@param revision number|string Either a number in the format "202101010000" (year, month, day, hour, minute) or string "20260813223013" to be auto set by packager
