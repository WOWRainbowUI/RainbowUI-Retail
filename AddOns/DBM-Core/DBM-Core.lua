...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20240912083714")
...
---@param revision number|string Either a number in the format "202101010000" (year, month, day, hour, minute) or string "20240912083714" to be auto set by packager
