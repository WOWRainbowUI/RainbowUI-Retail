...
-- 自行加入
L["Icon for category"] = true
L["HealthBar Left Text"] = true
L["HealthBar Right Text"] = true
L["PowerBar Left Text"] = true
L["PowerBar Right Text"] = true
L["TargetBar Left Text"] = true
L["TargetBar Right Text"] = true
L["PetBar Left Text"] = true
L["PetBar Right Text"] = true
L["GladiusEx"] = true
L["GladiusEx "] = "GladiusEx"
L["InterruptPrio"] = true
L["Sets the priority of interrupts (as compared to regular Class Icon auras)"] = true