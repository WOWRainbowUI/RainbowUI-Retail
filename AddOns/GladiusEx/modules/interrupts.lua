	...
	return {
		general = {
			...
			args = {
				sep2 = {
					type = "description",
					name = L["This module shows interrupt durations over the Arena Enemy Class Icons when they are interrupted."],
					width = "full",
					order = 17,
				},
				interruptPrio = {
					type = "range",
					name = L["InterruptPrio"],
					desc = L["Sets the priority of interrupts (as compared to regular Class Icon auras)"],
