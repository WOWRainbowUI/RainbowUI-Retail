...
local Clicks = GladiusEx:NewGladiusExModule("Clicks", {
	clickAttributes = {
		[L["Left"]] = { button = "1", modifier = "", action = "target", macro = "" },
		[L["Right"]] = { button = "2", modifier = "", action = "focus", macro = "" },
	},
})
			...
			action = {
				...
				args = {
					action = {
						...
						values = {["macro"] = MACRO, ["target"] = TARGET, ["focus"] = MINIMAP_TRACKING_FOCUS, ["spell"] = L["Cast spell"]},
						disabled = function() return not self:IsUnitEnabled(unit) end,
						order = 10,
					},
					sep = {
