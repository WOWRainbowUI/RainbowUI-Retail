...
https://github.com/WeakAuras/WeakAuras2/wiki/Deprecated-CLEU]=] ] = "|cFFFF0000已不再支援未過濾的 COMBAT_LOG_EVENT_UNFILTERED|r建議不要使用未過濾的 COMBAT_LOG_EVENT_UNFILTERED，因為它需要耗費非常高的效能。更多資訊請看 https://github.com/WeakAuras/WeakAuras2/wiki/Deprecated-CLEU"
