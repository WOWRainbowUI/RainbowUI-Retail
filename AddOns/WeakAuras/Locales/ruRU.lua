...
L["Warning: Anchoring to your own child '%s' in aura '%s' is imposssible."] = "Предупреждение: Привязка к вашему собственному дочернему элементу '%s' в ауре '%s' невозможна."
