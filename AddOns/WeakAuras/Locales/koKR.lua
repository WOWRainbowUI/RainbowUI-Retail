...
L["Cooldown/Charges/Count"] = "재사용 대기시간/충전량/횟수"
...
L["Hide"] = "숨기기"
L["Hide 0 cooldowns"] = "재사용 대기시간 0초 숨김"
...
L["Note: This trigger internally stores the shape shift positon, and thus is incompatible with learning stances on the fly, like e.g. the Gladiator Rune."] = "참고: 이 활성 조건은 내부에서 변신/태세 번호를 저장하고 있습니다. 따라서 검투사 룬같은 스킬을 비행 상태에서 배우면 제대로 작동하지 않습니다."
...
L["Player Location ID(s)"] = "내가 위치한 지역 ID (복수 가능)"
...
L["Relative"] = "상대적"
L["Relative X-Offset"] = "상대적 X-위치조정"
L["Relative Y-Offset"] = "상대적 Y-위치조정"
...
L["Tracking Only Cooldown"] = "재사용 대기일때만 추적"
