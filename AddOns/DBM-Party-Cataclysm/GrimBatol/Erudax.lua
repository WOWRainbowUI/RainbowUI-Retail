...
local specWarnMending	= mod:NewSpecialWarningInterrupt(75763, nil, nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnGale		= mod:NewSpecialWarningCount(DBM:IsRetail() and 449939 or 75664, nil, nil, nil, 2, 2, nil, nil, "findshelter")
local specWarnAdds		= mod:NewSpecialWarningAddsCount(75704, "Dps", nil, nil, 3, 2, nil, nil, "killmob")
...
if not mod:IsCata() then
	...
	specWarnAbyssal		= mod:NewSpecialWarningYou(448057, nil, nil, nil, 3, 2, nil, nil, "scatter")
	specWarnVoidSurge	= mod:NewSpecialWarningDodgeCount(450077, nil, nil, nil, 2, 2, nil, nil, "watchstep")
	specWarnCrush		= mod:NewSpecialWarningDefensive(450100, nil, nil, nil, 2, 2, nil, nil, "defensive")
