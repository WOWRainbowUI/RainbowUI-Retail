...
L["Line"] = "边框"
L["Background"] = "背景"
L["Fade out line"] = "淡出|cff%s框架边框|r"
L["Fade out bar"] = "淡出框架"
L["Opacity"] = "透明度"
L["Hide the bar in Pet Battle"] = "在宠物对战中隐藏框架"
L["Line width"] = "边框粗细"
L["Line Border"] = "线条边框"
L["Line Border Offset"] = "|cff%s框架边框|r 边界偏移"
L["Line Border Size"] = "|cff%s框架边框|r 边框尺寸"
L["Distance from line to bar"] = "从|cff%s框架边框|r到框架的距离"
L["Orientation"] = "方向"
L["Auto"] = "自动"
L["Horizontal"] = "水平"
L["Vertical"] = "垂直"
...
L["Button Size"] = "按钮尺寸"
L["Distance from button to bar"] = "按钮到框架的距离"
L["Bar offset relative to the button"] = "相对于按钮的框架偏移"
