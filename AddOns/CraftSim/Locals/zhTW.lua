...
function CraftSim.LOCAL_TW:GetData()
    ...
    return {
        ...
        [CraftSim.CONST.TEXT.CRAFT_LOG_TITLE] = "CraftSim 製造記錄",
        [CraftSim.CONST.TEXT.CRAFT_LOG_ADV_TITLE] = "CraftSim 進階製造記錄",
		[CraftSim.CONST.TEXT.CRAFT_LOG_LOG] = "製造記錄",
        [CraftSim.CONST.TEXT.CRAFT_LOG_LOG_1] = "利潤: ",
        [CraftSim.CONST.TEXT.CRAFT_LOG_LOG_2] = "節省專注:",
        ...
        [CraftSim.CONST.TEXT.CRAFT_LOG_DISABLE_CHECKBOX] = f.r("停用") .. "製造記錄",
        [CraftSim.CONST.TEXT.CRAFT_LOG_DISABLE_CHECKBOX_TOOLTIP] = "啟用此選項會停止在製造時記錄任何製造，並且會" .. f.g("增加效能"),
		[CraftSim.CONST.TEXT.CRAFT_LOG_REAGENT_DETAILS_TAB] = "材料詳細內容",
        [CraftSim.CONST.TEXT.CRAFT_LOG_RESULT_ANALYSIS_TAB] = "結果分析",
        [CraftSim.CONST.TEXT.CRAFT_LOG_RESULT_ANALYSIS_TAB_DISTRIBUTION_LABEL] = "結果分佈",
        [CraftSim.CONST.TEXT.CRAFT_LOG_RESULT_ANALYSIS_TAB_DISTRIBUTION_HELP] = "製作物品結​​果的相對分佈。\n(忽略複數製造數量)",
        [CraftSim.CONST.TEXT.CRAFT_LOG_RESULT_ANALYSIS_TAB_MULTICRAFT] = "複數製造",
        [CraftSim.CONST.TEXT.CRAFT_LOG_RESULT_ANALYSIS_TAB_RESOURCEFULNESS] = "精明",
        [CraftSim.CONST.TEXT.CRAFT_LOG_RESULT_ANALYSIS_TAB_YIELD_DDISTRIBUTION] = "收益分配",
        ...
        [CraftSim.CONST.TEXT.RECIPE_SCAN_MODE_OPTIMIZE] = "最佳化",
		...
		[CraftSim.CONST.TEXT.RECIPE_SCAN_SORT_MODE_CRAFTING_COST] = "製造成本",
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_CRAFT_PROFESSION_GEAR_HEADER] = "工具",
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_ADD_OPEN_RECIPE_BUTTON_LABEL] = "排程打開配方",
		[CraftSim.CONST.TEXT.CRAFT_QUEUE_ADD_FIRST_CRAFTS_BUTTON_LABEL] = "排程首次製作",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_ADD_WORK_ORDERS_BUTTON_LABEL] = "排程工作順序",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_ADD_WORK_ORDERS_ALLOW_CONCENTRATION_CHECKBOX] = "允許專注",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_ADD_WORK_ORDERS_ALLOW_CONCENTRATION_TOOLTIP] =
            "如果無法達到最低品質，可以的話使用" .. f.l("專注"),
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_RECIPE_REQUIREMENTS_HEADER] = "狀態",
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_CRAFT_AVAILABLE_AMOUNT] = "最大",
...
是否大於或等於設定的銷售比率門檻。
		...
		[CraftSim.CONST.TEXT.CRAFT_QUEUE_EDIT_RECIPE_SPARK_LABEL] = "必要的",
