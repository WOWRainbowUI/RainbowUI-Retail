...
greater or equal the configured sale rate threshold.
		...
		[CraftSim.CONST.TEXT.CRAFT_QUEUE_EDIT] = "Edit",
		[CraftSim.CONST.TEXT.REAGENT_DATA_INVENTORY] = "\n(Inventory of ",
		[CraftSim.CONST.TEXT.REAGENT_DATA_PREREQUISITE] = "\n\nPrerequisite of:",
		[CraftSim.CONST.TEXT.TAB_OVERVIEW] = "Overview",
		[CraftSim.CONST.TEXT.TAB_OPTIONS] = "Options",
		[CraftSim.CONST.TEXT.COOLDOWNS_EXPANSION_FILTER] = "Expansion Filter",
		[CraftSim.CONST.TEXT.NODE_DATA_RANK] = "Rank ",
		[CraftSim.CONST.TEXT.STATS_FROM_TALENT] = "\n\nTotal Stats from Talent:\n",
		[CraftSim.CONST.TEXT.CRAFT_RESULT_TAB_PROFITS] = "Craft Profits",
		[CraftSim.CONST.TEXT.CRAFT_RESULT_TAB_TRACKER] = "Statistics Tracker",
		[CraftSim.CONST.TEXT.CRAFT_RESULT_RESULT_DISTRIBUTION] = "Result Distribution",
		[CraftSim.CONST.TEXT.CRAFT_RESULT_RESULT_DISTRIBUTION_TOOLTIP] = "Relative distribution of crafted item results.\n(Ignoring Multicraft Quantities)",
		[CraftSim.CONST.TEXT.CRAFT_RESULT_YIELD_DISTRIBUTION] = "Yield Distribution",
		[CraftSim.CONST.TEXT.CRAFT_COST_TAB_COSTS] = "Reagent Costs",
		[CraftSim.CONST.TEXT.CRAFT_COST_TAB_OPTIONS] = "Sub Recipe Options",
		[CraftSim.CONST.TEXT.CRAFT_COST_OPTIMIZATION] = "Sub Recipe Optimization " .. f.bb("(experimental)"),
		[CraftSim.CONST.TEXT.CRAFT_COST_OPTIMIZATION_TOOLTIP] = "If enabled " .. f.l("CraftSim") .. " considers the " .. f.g("optimized crafting costs") .. " of your character and your alts\nif they are able to craft that item.\n\n"
                .. f.r("Might decrease performance a bit due to a lot of additional calculations"),
		[CraftSim.CONST.TEXT.CRAFT_COST_CALCULATION_DEPTH] = "Sub Recipe Calculation Depth",
		[CraftSim.CONST.TEXT.CRAFT_COST_ENABLE_CONCENTRATION] = "Enable Concentration",
		[CraftSim.CONST.TEXT.CRAFT_COST_ENABLE_CONCENTRATION_TOOLTIP] =  "If enabled, " .. f.l("CraftSim") .. " will include reagent qualities even if concentration is necessary.",
		[CraftSim.CONST.TEXT.CRAFT_COST_INCLUDE_COOLDOWN] = "Include Cooldown Recipes",
		[CraftSim.CONST.TEXT.CRAFT_COST_INCLUDE_COOLDOWN_TOOLTIP] = "If enabled, " .. f.l("CraftSim") .. " will ignore cooldown requirements of recipes when calculating self crafted materials",
		[CraftSim.CONST.TEXT.CRAFT_COST_SELECT_CRAFTER] = "Select Recipe Crafter",
		[CraftSim.CONST.TEXT.CRAFT_COST_AUCTION_BUYOUT] = "Auction Buyout: ",
		...
		[CraftSim.CONST.TEXT.CRAFT_COST_CONCENTRATION_COST] = "Concentration Cost: ",
		[CraftSim.CONST.TEXT.STATISTICS_TAB_PROBABILITY] = "Probability Table",
		[CraftSim.CONST.TEXT.STATISTICS_TAB_CONCENTRATION] = "Concentration",
		[CraftSim.CONST.TEXT.STATISTICS_CONCENTRATION_CURVE] = "Concentration Cost Curve",
		[CraftSim.CONST.TEXT.STATISTICS_CONCENTRATION_CURVE_TOOLTIP] = "Concentration Cost based on Player Skill for given Recipe\n" ..
            f.bb("X Axis: ") .. " Player Skill\n" ..
            f.bb("Y Axis: ") .. " Concentration Cost",
		[CraftSim.CONST.TEXT.RECIPE_SCAN_CONCENTRATION] = " Concentration",
		[CraftSim.CONST.TEXT.RECIPE_SCAN_CONCENTRATION_TOOLTIP] = "Toggle Concentration",
		[CraftSim.CONST.TEXT.RECIPE_SCAN_OPTIMIZATION] = "Optimize Sub Recipes " .. f.bb("(experimental)"),
		[CraftSim.CONST.TEXT.RECIPE_SCAN_OPTIMIZATION_TOOLTIP] = "If enabled, " .. f.l("CraftSim") .. " also optimizes crafts of cached reagent recipes of scanned recipes and uses their\n" ..
		...
		[CraftSim.CONST.TEXT.RECIPE_SCAN_QUEUE_TOOLTIP] = "Press " ..
