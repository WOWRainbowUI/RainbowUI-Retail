...
L["Press Key To Open Container"] = "按下按鈕打開容器";
L["Press Key To Open Container Desc PC"] = "非戰鬥中時按下 [KEY:PC:SPACE] 打開獎勵的容器。";
L["Press Key To Open Container Desc Xbox"] = "非戰鬥中時按下 [KEY:XBOX:PAD3] 打開獎勵的容器。";
L["Press Key To Open Container Desc PlayStation"] = "非戰鬥中時按下 [KEY:PS:PAD3] 打開獎勵的容器。";
L["Press Key To Open Container Desc Switch"] = "非戰鬥中時按下 [KEY:SWITCH:PAD3] 打開獎勵的容器。";
L["Auto Select"] = "自動選擇";
