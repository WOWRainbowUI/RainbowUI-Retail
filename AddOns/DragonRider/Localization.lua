...
if LOCALE == "enUS" then
	...
	L["RightClick_TT_Line"] = "Open Settings"
	L["LeftClick_TT_Line"] = "Open Journal"
	...
	L["HousingDashboard"] = "Housing Dashboard"
	L["ChallengeModeTimer"] = "Challenge Mode Timer"
	L["Cosmic"] = "Cosmic"
	L["DelvesDashboard"] = " Delves Dashboard"
	L["HousingAdvMode"] = "Housing Advanced Mode"
	L["AzeriteIslands"] = "Azerite Islands"
	L["JourneysRenown"] = "Journeys Renown"
	L["LegionfallConstruction"] = "Legionfall Construction"
	L["ActivitiesBar"] = "Activities"
	L["ActivitiesBarBonus"] = "Activities Bonus"
	L["ProfessionsSkillBar"] = "Professions Skill"
	L["ProfessionsQualityBar"] = "Professions Quality"
	L["JunkyardScore"] = "Junkyard Score"
	L["JailersTowerScore"] = "Jailer's Tower Score"
	L["CastBarEmpower"] = "Cast Bar Empower"
	L["CastBarInterrupted"] = "Cast Bar Interrupted"
	L["CastBarStandard"] = "Cast Bar Standard"
	L["CastBarApplyingCrafting"] = "Cast Bar Applying Crafting"
	L["CastBarUninterruptable"] = "Cast Bar Uninterruptable"
	L["PowerDemonHunterFury"] = "Demon Hunter Fury"
	L["PowerDruidAstral"] = "Druid Astral Power"
	L["PowerEvokerEbonMight"] = "Evoker Ebon Might"
	L["PowerMonkStagger"] = "Monk Stagger"
	L["PowerPriestInsanity"] = "Priest Insanity"
	L["PowerShamanMaelstrom"] = "Shaman Maelstrom"
	L["PlunderstormStormBar"] = "Plunderstorm"
	L["AlchemyFlipbook"] = "Alchemy (Flipbook)"
	L["BlacksmithFlipbook"] = "Blacksmith (Flipbook)"
	L["CookingFlipbook"] = "Cooking (Flipbook)"
	L["EnchantingFlipbook"] = "Enchanting (Flipbook)"
	L["EngineeringFlipbook"] = "Engineering (Flipbook)"
	L["FishingFlipbook"] = "Fishing (Flipbook)"
	L["HerbalismFlipbook"] = "Herbalism (Flipbook)"
	L["InscriptionFlipbook"] = "Inscription (Flipbook)"
	L["JewelcraftingFlipbook"] = "Jewelcrafting (Flipbook)"
	L["LeatherworkingFlipbook"] = "Leatherworking (Flipbook)"
	L["MiningFlipbook"] = "Mining (Flipbook)"
	L["SkinningFlipbook"] = "Skinning (Flipbook)"
	L["TailoringFlipbook"] = "Tailoring (Flipbook)"
	L["ProfessionsQualityFlipbook"] = "Professions Quality (Flipbook)"
	...
	L["ProfileLoaded"] = "Profile '%s' loaded!"
	L["ProfileDeleted"] = "Profile '%s' deleted."
	L["ImportStringDifferentAddon"] = "This string belongs to a different addon."
	L["ImportStringOutdatedUnrecognized"] = "The following outdated or unrecognized options were skipped: %s"
	L["ProfileImportedAs"] = "Profile imported as '%s'."
	L["ActiveSettingsOverwritten"] = "Active settings overwritten by import!"
	L["CopyProfileCode"] = "Copy Profile Code (control-c)"
	L["PasteProfileCode"] = "Paste Profile Code (control-v)"
	L["InvalidImportCode"] = "Invalid Import Code"
	L["NewProfileName"] = "New Profile Name"
	L["SavetoCurrentProfile"] = "Save to Current Profile"
	L["Import"] = "Import"
	L["Export"] = "Export"
	L["NoneWillCreateDefault"] = "None (Will Create Default)"
	L["NoActiveProfileSelected"] = "No active profile selected. Creating new one or overwriting active."
	L["Dialog_DeleteProfile"] = "Are you sure you want to delete the profile '%s'?"
	L["Dialog_RenameProfile"] = "Enter a new name for profile '%s':"
	L["ProfileRenamed"] = "Profile '%s' renamed to '%s'."
	L["ProfileManager"] = "Profile Manager"
	L["SelectActiveProfile"] = "Select Active Profile"
	L["AccountProfile"] = "Account Profile"
	L["ProfileOptions"] = "Profile Options"
	L["RenameProfile"] = "Rename Profile"
	L["DeleteProfile"] = "Delete Profile"
	L["ProfileCurrentSpec"] = "Current Specialization Profile"
	L["LinkToSpec"] = "Link to Specialization"
	L["SaveCurrentToNewProfile"] = "Save Current Loadout as New Profile"
	L["SaveAsNew"] = "Save as New"
	L["SettingsCatMissing"] = "SettingsCategory was missing??"
	L["ProfileLinkedToSpec"] = "Profile '%s' linked to Specialization %s."
	L["Profiles"] = "Profiles"
...
if LOCALE == "zhCN" then
	...
	L["DragonRider"] = "龙骑手"
	L["RightClick_TT_Line"] = "打开设置"
	L["LeftClick_TT_Line"] = "打开日志"
	L["RightClick"] = "右键点击："
	L["LeftClick"] = "左键点击："
	...
	L["HousingDashboard"] = "住房面板"
	L["ChallengeModeTimer"] = "挑战模式计时器"
	L["Cosmic"] = "宇宙"
	L["DelvesDashboard"] = "地下探险面板"
	L["HousingAdvMode"] = "住房高级模式"
	L["AzeriteIslands"] = "艾泽里特群岛"
	L["JourneysRenown"] = "旅程声望"
	L["LegionfallConstruction"] = "军团再临建设"
	L["ActivitiesBar"] = "活动"
	L["ActivitiesBarBonus"] = "活动加成"
	L["ProfessionsSkillBar"] = "专业技能"
	L["ProfessionsQualityBar"] = "专业品质"
	L["JunkyardScore"] = "垃圾场评分"
	L["JailersTowerScore"] = "典狱长之塔评分"
	L["CastBarEmpower"] = "施法条 – 强化"
	L["CastBarInterrupted"] = "施法条 – 被打断"
	L["CastBarStandard"] = "施法条 – 标准"
	L["CastBarApplyingCrafting"] = "施法条 – 应用制作"
	L["CastBarUninterruptable"] = "施法条 – 不可打断"
	L["PowerDemonHunterFury"] = "恶魔猎手 怒气"
	L["PowerDruidAstral"] = "德鲁伊 星界能量"
	L["PowerEvokerEbonMight"] = "唤魔师 黑曜之力"
	L["PowerMonkStagger"] = "武僧 醉拳"
	L["PowerPriestInsanity"] = "牧师 疯狂"
	L["PowerShamanMaelstrom"] = "萨满祭司 漩涡"
	L["PlunderstormStormBar"] = "霸业风暴"
	L["AlchemyFlipbook"] = "炼金术 (Flipbook)"
	L["BlacksmithFlipbook"] = "锻造 (Flipbook)"
	L["CookingFlipbook"] = "烹饪 (Flipbook)"
	L["EnchantingFlipbook"] = "附魔 (Flipbook)"
	L["EngineeringFlipbook"] = "工程学 (Flipbook)"
	L["FishingFlipbook"] = "钓鱼 (Flipbook)"
	L["HerbalismFlipbook"] = "草药学 (Flipbook)"
	L["InscriptionFlipbook"] = "铭文 (Flipbook)"
	L["JewelcraftingFlipbook"] = "珠宝加工 (Flipbook)"
	L["LeatherworkingFlipbook"] = "制皮 (Flipbook)"
	L["MiningFlipbook"] = "采矿 (Flipbook)"
	L["SkinningFlipbook"] = "剥皮 (Flipbook)"
	L["TailoringFlipbook"] = "裁缝 (Flipbook)"
	L["ProfessionsQualityFlipbook"] = "专业品质 (Flipbook)"
	...
	L["ProfileLoaded"] = "配置文件“%s”已加载！"
	L["ProfileDeleted"] = "配置文件“%s”已删除。"
	L["ImportStringDifferentAddon"] = "此字符串属于其他插件。"
	L["ImportStringOutdatedUnrecognized"] = "以下过时或无法识别的选项已跳过：%s"
	L["ProfileImportedAs"] = "配置文件已导入为“%s”。"
	L["ActiveSettingsOverwritten"] = "当前设置已被导入覆盖！"
	L["CopyProfileCode"] = "复制配置文件代码（Ctrl+C）"
	L["PasteProfileCode"] = "粘贴配置文件代码（Ctrl+V）"
	L["InvalidImportCode"] = "无效的导入代码"
	L["NewProfileName"] = "新配置文件名称"
	L["SavetoCurrentProfile"] = "保存到当前配置文件"
	L["Import"] = "导入"
	L["Export"] = "导出"
	L["NoneWillCreateDefault"] = "无（将创建默认配置）"
	L["NoActiveProfileSelected"] = "未选择活动配置文件。将创建新配置或覆盖当前活动配置。"
	L["Dialog_DeleteProfile"] = "确定要删除配置文件“%s”吗？"
	L["Dialog_RenameProfile"] = "请输入配置文件“%s”的新名称："
	L["ProfileRenamed"] = "配置文件“%s”已重命名为“%s”。"
	L["ProfileManager"] = "配置文件管理器"
	L["SelectActiveProfile"] = "选择活动配置文件"
	L["AccountProfile"] = "账户配置文件"
	L["ProfileOptions"] = "配置文件选项"
	L["RenameProfile"] = "重命名配置文件"
	L["DeleteProfile"] = "删除配置文件"
	L["ProfileCurrentSpec"] = "当前专精配置文件"
	L["LinkToSpec"] = "关联到专精"
	L["SaveCurrentToNewProfile"] = "将当前配置保存为新配置文件"
	L["SaveAsNew"] = "另存为新配置"
	L["SettingsCatMissing"] = "缺少 SettingsCategory？？"
	L["ProfileLinkedToSpec"] = "配置文件“%s”已关联到专精 %s。"
	L["Profiles"] = "配置文件"
...
if LOCALE == "zhTW" then
	...
	L["COMMAND_dragonrider"] = "dragonrider"
	L["DragonRider"] = "飛行速度條"
	L["RightClick_TT_Line"] = "打開設定"
	L["LeftClick_TT_Line"] = "打開日誌"
	L["RightClick"] = "右鍵："
	L["LeftClick"] = "左鍵："
	L["SlashCommands_TT_Line"] = "'輸入 /dragonrider' 以獲取其他指令"
	L["Score"] = "分數"
	L["Guide"] = "指南"
	L["Settings"] = "設定"
	L["ComingSoon"] = "即將推出"
	...
	L["HousingDashboard"] = "住房面板"
	L["ChallengeModeTimer"] = "挑戰模式計時器"
	L["Cosmic"] = "宇宙"
	L["DelvesDashboard"] = "探究面板"
	L["HousingAdvMode"] = "住房進階模式"
	L["AzeriteIslands"] = "艾澤萊特群島"
	L["JourneysRenown"] = "旅程聲望"
	L["LegionfallConstruction"] = "軍臨天下建設"
	L["ActivitiesBar"] = "活動"
	L["ActivitiesBarBonus"] = "活動加成"
	L["ProfessionsSkillBar"] = "專業技能"
	L["ProfessionsQualityBar"] = "專業品質"
	L["JunkyardScore"] = "廢料場分數"
	L["JailersTowerScore"] = "獄主之塔分數"
	L["CastBarEmpower"] = "施法條 – 強化"
	L["CastBarInterrupted"] = "施法條 – 被打斷"
	L["CastBarStandard"] = "施法條 – 標準"
	L["CastBarApplyingCrafting"] = "施法條 – 套用製作"
	L["CastBarUninterruptable"] = "施法條 – 不可打斷"
	L["PowerDemonHunterFury"] = "惡魔獵人 憤怒"
	L["PowerDruidAstral"] = "德魯伊 星能"
	L["PowerEvokerEbonMight"] = "喚能師 黑曜之力"
	L["PowerMonkStagger"] = "武僧 醉拳"
	L["PowerPriestInsanity"] = "牧師 瘋狂"
	L["PowerShamanMaelstrom"] = "薩滿 漩渦"
	L["PlunderstormStormBar"] = "強襲風暴"
	L["AlchemyFlipbook"] = "鍊金術 (Flipbook)"
	L["BlacksmithFlipbook"] = "鍛造 (Flipbook)"
	L["CookingFlipbook"] = "烹飪 (Flipbook)"
	L["EnchantingFlipbook"] = "附魔 (Flipbook)"
	L["EngineeringFlipbook"] = "工程學 (Flipbook)"
	L["FishingFlipbook"] = "釣魚 (Flipbook)"
	L["HerbalismFlipbook"] = "草藥學 (Flipbook)"
	L["InscriptionFlipbook"] = "銘文學 (Flipbook)"
	L["JewelcraftingFlipbook"] = "珠寶設計 (Flipbook)"
	L["LeatherworkingFlipbook"] = "製皮 (Flipbook)"
	L["MiningFlipbook"] = "採礦 (Flipbook)"
	L["SkinningFlipbook"] = "剝皮 (Flipbook)"
	L["TailoringFlipbook"] = "裁縫 (Flipbook)"
	...
	L["ProfileLoaded"] = "設定檔「%s」已載入！"
	L["ProfileDeleted"] = "設定檔「%s」已刪除。"
	L["ImportStringDifferentAddon"] = "此字串屬於另一個插件。"
	L["ImportStringOutdatedUnrecognized"] = "已略過下列過時或無法辨識的選項：%s"
	L["ProfileImportedAs"] = "設定檔已匯入為「%s」。"
	L["ActiveSettingsOverwritten"] = "目前設定已被匯入內容覆蓋！"
	L["CopyProfileCode"] = "複製設定檔代碼（Ctrl+C）"
	L["PasteProfileCode"] = "貼上設定檔代碼（Ctrl+V）"
	L["InvalidImportCode"] = "無效的匯入代碼"
	L["NewProfileName"] = "新設定檔名稱"
	L["SavetoCurrentProfile"] = "儲存到目前設定檔"
	L["Import"] = "匯入"
	L["Export"] = "匯出"
	L["NoneWillCreateDefault"] = "無（將建立預設設定檔）"
	L["NoActiveProfileSelected"] = "未選擇作用中的設定檔。將建立新的設定檔或覆寫目前作用中的設定檔。"
	L["Dialog_DeleteProfile"] = "確定要刪除設定檔「%s」嗎？"
	L["Dialog_RenameProfile"] = "請輸入設定檔「%s」的新名稱："
	L["ProfileRenamed"] = "設定檔「%s」已重新命名為「%s」。"
	L["ProfileManager"] = "設定檔管理員"
	L["SelectActiveProfile"] = "選擇作用中的設定檔"
	L["AccountProfile"] = "帳號設定檔"
	L["ProfileOptions"] = "設定檔選項"
	L["RenameProfile"] = "重新命名設定檔"
	L["DeleteProfile"] = "刪除設定檔"
	L["ProfileCurrentSpec"] = "目前專精設定檔"
	L["LinkToSpec"] = "連結至專精"
	L["SaveCurrentToNewProfile"] = "將目前配置儲存為新設定檔"
	L["SaveAsNew"] = "另存為新設定檔"
	L["SettingsCatMissing"] = "缺少 SettingsCategory？？"
	L["ProfileLinkedToSpec"] = "設定檔「%s」已連結至專精 %s。"
	L["Profiles"] = "設定檔"
