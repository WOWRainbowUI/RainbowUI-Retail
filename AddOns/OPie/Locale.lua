...
V =
    C == "zhCN" and { -- 204/214 (95%)
      ...
      "此快捷键当前无法使用，因为它和另一个绑定冲突。", "专业技能", z, z, "明白了；继续编辑", "撤销变动", "未移动的光标", "光标未移动，或者在环中心", "需要更新", "使用默认环快捷键",
    ...
    or C == "zhTW" and { -- 211/214 (98%)
      "%d 分鐘前 (%s)", "%s取消", "%s在目前的結果內搜尋", "(所有套裝)", "(預設)", "(在此輸入圖示名稱或路徑)", "新增環", "加入一個新的功能", "使用後進階顯示", "所有 %s 角色",
      "所有 %s 專精", "所有設定", "所有角色", "設為快速動作", "Alt+左鍵 設定條件式綁定", "轉換動畫", "動畫", "外觀", "給所有專精使用", z,
      ...
      "安裝並啟用 %s 以便使用檔案名稱來搜尋。", "貼齊滑鼠游標", "互動", "使用後保持展開狀態", "點一下左鍵來設定按鍵綁定", "此環可用於:", "小地圖追蹤", "不用滑鼠", "環向下偏移", "環向右偏移",
      ...
      "重置為預設值", "恢復為預設值", "恢復已刪除的環", "還原...", "點右鍵取消綁定", "環按鍵綁定", "環的名稱:", "環縮放大小", z, "環: %s",
