...
V =
    C == "zhCN" and { -- 214/217 (98%)
      ...
      "旋转：", "旋转嵌套环（下）", "旋转嵌套环（上）", "搜索", "选择 %s 互动方式以启用此选项。", "选择要修改的环", "双击一个动作以加入到这个环", "选择的功能（关闭环）", "当前选择环（环保持打开）", "设置名称过滤器：",
...
K = V and {
      ...
      "You can cancel or revert to previous settings later.", "You may use extended conditionals; see %s for details.", "You must enable a %s interaction for this ring in OPie options to use quick actions.", "default", "OPie",
}
