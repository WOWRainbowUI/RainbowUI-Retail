...
V =
    C == "zhCN" and { -- 163/180 (90%)
      ...
      "全局默认", "删除当前配置", "删除环", "删除功能", "召唤恶魔", z, "显示为嵌套环", "显示为：", "您想要将所有 %s 设置重置为其默认值，还是仅重置 %s 类别中的设置？", "默认嵌入其它环",
      ...
      "安装此外观的更新版本以选择它", "安装并启用 %s 以按文件名搜索。", "点击后依然显示", "环功能置顶", "可用此环的角色：", "小地图追踪", "下移环", "右移环", z, "嵌套环：%s",
      "嵌套环", "创建新环", "新配置名称：", "没有%s专精", z, "未绑定", "未自定义", z, "OPie环", "OPie环：%s",
      "OPie环", "仅%s", "打开嵌套环", "选项：", "旋转消失", "覆盖图标", "预设环功能按键", "宠物", "变形术", "传送门与传送",
      "预选快捷功能", "按%s键保存。", "按%s搜索", "配置", "在你切换专精后相应配置文件会自动激活。", "配置文件保存设置与环快捷键。", "任务物品", "环中央使用快捷功能", z, "使用后随机切换",
      "显示时随机", "记住最近的选择", "显示时重置", "重置为默认设置", "恢复默认设置", z, "右键点击解除绑定", "环快捷键", "环名称：", "环尺寸",
      "环：%s", "旋转：", "旋转嵌套环（下）", "旋转嵌套环（上）", "滚轮敏感度", "搜索", "选择要修改的环", "双击一个动作以加入到这个环", "当前选择环（环保持打开）", "变形",
      "分享环", "按住 Shift 键单击查看环宏命令", "显示冷却数字", "显示充能数字", z, "显示给：", "显示鼠标提示", "模拟右键点击", "功能#%d", "将指针捕捉到鼠标光标",
      "快照：", "专精和旅行", "通过输入图标文件名、纹理路径、纹理图集名称或已知的技能名称来指定图标。", "获取该环的快照与他人分享。", "标记目标", "按键设置将根据该宏条件的返回值更新。", "用以下宏命令打开此环：", "这些设置", z, "此快捷键正被另一个插件使用。",
      "此快捷键当前无法使用，因为它和另一个绑定冲突。", "专业技能", "饰品", "明白了；继续编辑", "撤销变动", "需要更新", "使用默认环快捷键", "打开时使用第一个功能", "使用全局设定", "工具",
      "虚拟鼠标光标", "可见条件：", "术士战斗", "术士通用", "世界标记", "由于内存不足，魔兽世界不能加载已保存的OPie变量。请尝试禁用其他插件。现在你所做的任何改动都不会被保存。", "您可以稍后取消或恢复到之前的设置。", "你可以使用扩展的宏条件；详情见%s。", "必须为此环启用%s选项以使用快捷动作。", "默认", "快捷键", "快捷列-环形",
    }
    or C == "zhTW" and { -- 180/180 (100%)
      ...
      "請安裝此外觀的更新版本後再選擇它。", "安裝並啟用 %s 以便使用檔案名稱來搜尋。", "使用後保持展開狀態", "顯示在最前方", "此環可用於:", "小地圖追蹤", "環向下偏移", "環向右偏移", "移動類比搖桿", "環中環: %s",
      "環中環", "建立新的環...", "新的設定檔名稱:", "沒有 %s 專精", "無", "未綁定", "未自訂", "不支援所選的外觀。", "OPie 環", "OPie 環: %s",
      "OPie 環", "只供 %s", "展開環中環", "選項:", "旋轉消失", "取代圖示", "每個功能各自綁定快速鍵", "寵物", "變形術", "傳送門和傳送術",
      "預選一個功能做為快速動作", "按 %s 儲存。", "按 %s 搜尋", "設定檔", "切換專精時會自動啟用設定檔。", "設定檔儲存選項和環按鍵綁定。", "任務物品", "環中心的快速功能", "滑鼠停留時的快速動作", "使用後隨機顯示",
      "隨機顯示", "記憶上次旋轉", "重置顯示", "重置為預設值", "恢復為預設值", "還原...", "點右鍵取消綁定", "環按鍵綁定", "環的名稱:", "環縮放大小",
      "環: %s", "環旋轉:", "捲動環中環 (往下)", "捲動環中環 (往上)", "滾輪敏感度", "搜尋", "選擇要更改的環", "在技能上面點兩下便可加入環。", "選擇的功能 (保持環展開)", "變形",
      "分享環", "Shift+左鍵 檢視環的巨集指令", "顯示冷卻時間數字", "顯示充能數字", "顯示功能文字", "顯示給:", "顯示浮動提示資訊", "模擬右鍵點擊", "功能 #%d", "貼齊滑鼠游標",
      ...
      "無法使用這個按鍵綁定，因為已用於其他地方。", "專業技能", "飾品", "瞭解; 仍要繼續編輯", "復原變更", "需要更新", "使用預設的環按鍵綁定", "展開時使用第一個功能", "使用整體設定", "工具",
      "虛擬滑鼠游標", "顯示條件:", "術士戰鬥", "術士一般", "世界標記圖示", "記憶體不足! 魔獸世界無法載入 OPie 已儲存的變數，請停用其它插件。\n\n現在做的任何變更都不會被儲存。", "稍後可以取消或還原成先前的設定。", "可以使用擴充的巨集條件式；詳細內容請看 %s。", "要使用快速功能，必須在 OPie 選項中替這個環啟用 %s。", "預設", "按鍵綁定", "快捷列-環形",
    } or nil
...
K = V and {
      ...
      "Install an updated version of this appearance to select it.", "Install and enable %s to search by file name.", "Leave open after use", "Make rings top-most", "Make this ring available to:", "Minimap Tracking", "Move rings down", "Move rings right", "Movement analog stick", "Nested ring: %s",
      "Nested rings", "New Ring...", "New profile name:", "No %s specializations", "None", "Not bound", "Not customized", "Not supported by selected appearance.", "OPie Ring", "OPie ring: %s",
      "OPie rings", "Only %s", "Open nested ring", "Options:", "Outward spiral on hide", "Override Icon", "Per-slice bindings", "Pets", "Polymorphs", "Portals and Teleports",
      "Pre-select a quick action slice", "Press %s to save.", "Press %s to search", "Profile", "Profiles activate automatically when you switch character specializations.", "Profiles save options and ring bindings.", "Quest Items", "Quick action at ring center", "Quick action if mouse remains still", "Randomize rotation after use",
      "Randomize rotation on display", "Remember last rotation", "Reset rotation on display", "Restore default", "Restore default settings", "Revert...", "Right click to unbind", "Ring Bindings", "Ring name:", "Ring scale",
      ...
      "Share ring", "Shift click to view ring macro command", "Show cooldown numbers", "Show recharge numbers", "Show slice labels", "Show this slice for:", "Show tooltips", "Simulate a right-click", "Slice #%d", "Snap pointer to mouse cursor",
      ...
      "This binding is not currently active because it conflicts with another.", "Trade Skills", "Trinkets", "Understood; edit anyway", "Undo changes", "Update required", "Use default ring bindings", "Use first slice when opened", "Use global setting", "Utility",
      "Virtual mouse cursor", "Visibility conditional:", "Warlock Combat", "Warlock General", "World Markers", "World of Warcraft could not load OPie's saved variables due to a lack of memory. Try disabling other addons.\n\nAny changes you make now will not be saved.", "You can cancel or revert to previous settings later.", "You may use extended macro conditionals; see %s for details.", "You must enable the %s option for this ring in OPie options to use quick actions.", "default", "Bindings", "OPie",
}
