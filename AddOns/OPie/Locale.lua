...
V =
    C == "zhCN" and { -- 206/217 (94%)
      ...
      "安装并启用 %s 以按文件名搜索。", "互动", "点击后依然显示", z, "可用此环的角色：", "小地图追踪", "无鼠标", "下移环", "右移环", "移动模拟摇杆",
      "嵌套环：%s", "嵌套环", "创建新环", "新配置名称：", "没有%s专精", "空", "未绑定", z, "未自定义", "所选外观不支持此功能。",
      ...
      "恢复默认设置", "回复已删除的环", "还原...", "右键点击解除绑定", "环快捷键", "环名称：", "环尺寸", "环：%s", "旋转：", "旋转嵌套环（下）",
      "旋转嵌套环（上）", "搜索", "选择 %s 互动方式以启用此选项。", "选择要修改的环", "双击一个动作以加入到这个环", "选择的功能（关闭环）", "当前选择环（环保持打开）", z, "变形", "分享环",
      "按住 Shift 键单击查看环宏命令", "显示冷却数字", "显示充能数字", "显示功能标签", "显示给：", "显示鼠标提示", "模拟右键点击", "功能#%d", "将指针捕捉到鼠标光标", "快照：",
      ...
      "专业技能", z, z, "明白了；继续编辑", "撤销变动", "未移动的光标", "光标未移动，或者在环中心", "需要更新", "使用默认环快捷键", "打开时使用第一个功能",
      "使用全局设定", "使用功能", "使用功能并关闭环", "工具", "虚拟鼠标光标", "可见条件：", "术士战斗", "术士通用", "环展开时：", "世界标记",
      "由于内存不足，魔兽世界不能加载已保存的OPie变量。请尝试禁用其他插件。现在你所做的任何改动都不会被保存。", "您可以稍后取消或恢复到之前的设置。", "你可以使用扩展的宏条件；详情见%s。", "必须为此环启用%s选项，以使用快捷动作。", "默认",
    }
    or C == "zhTW" and { -- 214/217 (98%)
      ...
      "顯示為環中環", "顯示為:", z, "不做任何事", "是否要重置 %s 的所有設定，恢復成預設值，還是只要重置 %s 類別中的設定?", "預設嵌入其他環裡面", "這個環中啟用的功能", "空的環", "放大選取的圖示", "裝備設定:",
      ...
      "安裝並啟用 %s 以便使用檔案名稱來搜尋。", "互動", "使用後保持展開狀態", "點一下左鍵來設定按鍵綁定", "此環可用於:", "小地圖追蹤", "不用滑鼠", "環向下偏移", "環向右偏移", "移動類比搖桿",
      ...
      "恢復為預設值", "恢復已刪除的環", "還原...", "點右鍵取消綁定", "環按鍵綁定", "環的名稱:", "環縮放大小", "環: %s", "環旋轉:", "捲動環中環 (往下)",
      "捲動環中環 (往上)", "搜尋", "選擇 %s 互動方式以啟用此選項。", "選擇要更改的環", "在技能上面點兩下便可加入環。", "選擇的功能 (關閉環)", "選擇的功能 (保持環展開)", "套裝名稱過濾:", "變形", "分享環",
      ...
      "使用整體設定", "使用功能", "使用功能後關閉環", "工具", "虛擬滑鼠游標", "顯示條件:", "術士戰鬥", "術士一般", "環展開時:", "世界標記圖示",
      "記憶體不足! 魔獸世界無法載入 OPie 已儲存的變數，請停用其它插件。\n\n現在做的任何變更都不會被儲存。", "稍後可以取消或還原成先前的設定。", "可以使用擴充的巨集條件式；詳細內容請看 %s。", "要使用快速功能，必須在 OPie 選項中替這個環啟用 %s 互動。", "預設", "快捷列-環形",
    } or nil
...
K = V and {
      ...
      "Install and enable %s to search by file name.", "Interaction", "Leave open after use", "Left click to assign binding", "Make this ring available to:", "Minimap Tracking", "Mouse-less", "Move rings down", "Move rings right", "Movement analog stick",
      ...
      "Restore default settings", "Restore deleted ring", "Revert...", "Right click to unbind", "Ring Bindings", "Ring name:", "Ring scale", "Ring: %s", "Rotation:", "Scroll nested ring (down)",
      "Scroll nested ring (up)", "Search", "Select a %s interaction to enable this option.", "Select a ring to modify", "Select an action by double clicking.", "Selected slice (close ring)", "Selected slice (keep ring open)", "Set name filter:", "Shapeshifts", "Share ring",
      ...
      "Use global setting", "Use slice", "Use slice and close ring", "Utility", "Virtual mouse cursor", "Visibility conditional:", "Warlock Combat", "Warlock General", "While a ring is open:", "World Markers",
