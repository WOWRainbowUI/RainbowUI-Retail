...
V =
    ...
    or C == "zhCN" and { -- 43/43 (100%)
      "技能", "同时使用同名物品", "外观已锁定", "外观已解锁", "战斗宠物", "战斗宠物", "日历", "自定义宏", "驭龙术坐骑", "装备方案",
      "装备栏位", "装备套装", "可使用装备", "额外技能", "飞行坐骑", "主菜单", "地面坐骑", "界面面板", "物品", "物品",
      "宏", "宏", "杂项", "坐骑", "坐骑", "新建宏", "仅在装备时显示", "外观方案", "幻化套装", "宠物技能",
      "宠物技能", "团队标记", "世界标记", "团队标记", "不可用时仍显示（变暗）", "法术", "玩具", "玩具", "UI面板", "再次点击以允许该外观被情景外观替换。",
      "再次点击以禁止该外观被情景外观替换。", "使用已学会的最高等级技能", "区域能力",
    }
