...
L["Loop Only"] = "只循環"
L["Select the spell alert style."] = "選擇法術提醒樣式。"
L["Select which spell alert animations are enabled."] = "選擇要使用哪種提醒動畫效果。"
L["Spell Alert Animations"] = "法術提醒動畫"
L["Spell Alert Style"] = "法術提醒樣式"
...
L["Increases the font size of the text on Ace3 profile panels."] = "增加 Ace3 設定檔面板上文字的字體大小。"
L["Interface"] = "介面"
...
L["Minimap"] = "小地圖"
L["None"] = "無"
L["Profile Panel Font Fix"] = "修正設定檔面板字體"
