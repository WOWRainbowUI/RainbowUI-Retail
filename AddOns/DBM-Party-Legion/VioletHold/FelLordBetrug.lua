...
local specWarnFelSlash			= mod:NewSpecialWarningDodge(203641, nil, nil, nil, 1, 2, nil, nil, "shockwave")--warn Everyone since cone is so wide
local yellFelSlash				= mod:NewYell(203641)
local specWarnMightySmash		= mod:NewSpecialWarningSpell(202328, nil, nil, nil, 2, 2, nil, nil, "carefly")
local specWarnSeedofDestruction	= mod:NewSpecialWarningYou(210879, nil, nil, nil, 1, 2, nil, nil, "runout")
