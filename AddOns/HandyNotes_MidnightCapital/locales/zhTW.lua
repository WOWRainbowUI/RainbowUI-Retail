...
L.ADDON_NAME = "午夜 - 主城"
L.ADDON_DESCRIPTION = "適用於《魔獸世界：午夜》銀月城的 HandyNotes 外掛。"

L.FILTERS = "過濾"
L.SHOW_WORLD_MAP_BUTTON = "顯示世界地圖按鈕"
L.SHOW_WORLD_MAP_BUTTON_DESC = "在午夜主城地圖上加入一個快速選項按鈕。"
...
L.RESET_TO_DEFAULTS_DESC = "將「午夜 - 主城」的所有選項恢復為預設值。"
L.RESET_CONFIRM = "要將「午夜 - 主城」的所有選項恢復為預設值嗎？"
...
L.NODE_SILVERMOON_INN_TITLE = "銀月城旅店"
L.NODE_SILVERMOON_INN_DESC = "僅限部落：休息區與爐石綁定點。"

L.NODE_SILVERMOON_BANK_TITLE = "寶庫與銀行"
L.NODE_SILVERMOON_BANK_DESC = "僅限部落：可使用銀行與宏偉寶庫。"

L.NODE_SILVERMOON_AUCTION_HOUSE_TITLE = "拍賣場"
L.NODE_SILVERMOON_AUCTION_HOUSE_DESC = "僅限部落：可使用拍賣場。"

L.NODE_SILVERMOON_CATALYST_TITLE = "催化器"
L.NODE_SILVERMOON_CATALYST_DESC = "僅限部落：可使用催化器。"
...
L.NODE_COOKING_DESC = "學習並訓練 Midnight 烹飪。"
