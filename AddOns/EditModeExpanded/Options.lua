...
local defaults = {
    ...
    global = {
        EMEOptions = {
            ...
            bonusRoll = false,
            actionBars = false,
            groupLootContainer = false,
            auctionMultisell = false,
            chatButtons = false,
            backpack = false,
            targetFrame = false,
            focusFrame = false,
...
local options = {
    ...
    args = {
        ...
        cooldownManagerGroup = {
            ...
            args = {
                customSpellIDs = {
                    name = L["Custom Spell IDs"],
                    desc = L["Enter the Spell IDs of spells you want to add to the Cooldown Manager, separated by spaces or new lines."],
                    type = "input",
                    multiline = true,
                    width = "full",
