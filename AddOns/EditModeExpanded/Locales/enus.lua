...
L["Cooldown Manager options"] = true
L["Active Icons"] = true
...
L["Enabled"] = true
L["Focus Buffs"] = true
L["Splits the Personal Resource Display into 3 separate frames: HP, Power (mana/energy/etc), and Class (holy power, etc). That way you can move them separately, or shove one of them off screen if you want."] = true
L["Vigor Bar"] = "精力條"
L["Add the pre-11.2.7 Dragonriding Vigor bar"] = true
L["Layout Switching"] = true
L["Allow custom coordinates"] = true
L["Allows frames to be positioned using screen coordinates entered into text fields"] = true
L[" - Group Type"] = true
L["Group Size"] = true
