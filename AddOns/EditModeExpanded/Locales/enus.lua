...
L["Hide These Spells"] = true
L["Rearrange These Spells"] = true
L["Move "] = true
L[" Up"] = true
L[" Down"] = true
L["More options are available under Interface Options > AddOns > EditModeExpanded"] = true
L["Trinket 1"] = true
L["Trinket 2"] = true
L["Include Trinket 1"] = true
L["Include Trinket 2"] = true
L["Custom Spell IDs"] = true
L["Enter the Spell IDs of spells you want to add to the Cooldown Manager, separated by spaces or new lines."] = true