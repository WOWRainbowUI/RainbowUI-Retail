...
-- 自行加入
L["World Quest Tracker Options"] = "世界任務追蹤設定選項"
L["WQT Options"] = "WQT 選項"
L["Statistics"] = "統計"
L["Click to show reward statistics from world quests, timeline and quests available on your other characters."] = "點一下顯示包含你和其他角色，來自世界任務、時間線和任務的獎勵統計。"
L["Reputation"] = "聲望"
L["Racing"] = "競速"
L["Select All"] = "全選"
L["Select None"] = "取消全選"
L["Ignore New Zones"] = "忽略新地圖"
...
L["No other players nearby."] = "附近沒有其他玩家。"
L["Open Premade Groups"] = "打開預組隊伍"
L["Don't Show Popups for the Quest: "] = "此任務不要彈出視窗:"
L["Quest "] = "任務 "
L[" added to ignore list."] = " 已加入忽略清單。"
L["Ignore this quest (won't popup next time)"] = "忽略此任務 (下次不會彈出視窗)"
L["Leave Group"] = "離開隊伍"
L["World  Quest Tracker Ad-Blocker"] = "世界任務追蹤 廣告攔截器"
L["Ad-Blocker Enabled"] = "啟用阻擋廣告"
L["Don't Show Blacklisted Leaders"] = "不要顯示黑名單的隊長"
L["Won't show groups where the leader previously got caught doing an Ad."] = "不要顯示之前被抓到在打廣告的隊長的隊伍。"
L["Wipe Blacklisted Leaders"] = "清空黑名單的隊長"
L["Time Limit in Minutes"] = "時間限制 (分)"
L["Don't show groups where created time is bigger than 'X' minutes ago."] = "不要顯示建立時間超過 'X' 分鐘以上的隊伍。"
L["options"] = "阻擋廣告"
L["World quests aren't shown because you're below level 50."] = "世界任務不會顯示，因為你的等級低於 50 級。"