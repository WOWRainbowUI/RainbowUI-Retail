...
L["S_ENABLE"] = "Activer"
L["S_ENABLED"] = "Activé"
L["S_ERROR_NOTIMELEFT"] = "Il ne reste plus de temps pour cette quête."
L["S_ERROR_NOTLOADEDYET"] = "Cette quête n'est pas encore chargée, merci de patienter quelques secondes."
...
L["S_GROUPFINDER_ACTIONS_SEARCH_TOOLTIP"] = "Rejoignez un groupe qui effectue cette quête"
L["S_GROUPFINDER_ACTIONS_SEARCHING"] = "recherche..."
L["S_GROUPFINDER_ACTIONS_SEARCHMORE"] = "cliquez pour rechercher d'autres membres du groupe"
L["S_GROUPFINDER_ACTIONS_SEARCHOTHER"] = "Quitter le groupe et en rechercher un autre ?"
L["S_GROUPFINDER_ACTIONS_UNAPPLY1"] = "cliquez pour supprimer le bouton « Appliquer » afin que nous puissions créer un nouveau groupe"
L["S_GROUPFINDER_ACTIONS_UNLIST"] = "cliquez pour retirer votre groupe actuel de la liste"
L["S_GROUPFINDER_ACTIONS_UNLISTING"] = "désinscription..."
L["S_GROUPFINDER_ACTIONS_WAITING"] = "en attente..."
...
L["S_GROUPFINDER_NOPVP"] = "Évitez les serveurs JcJ"
L["S_GROUPFINDER_OT_ENABLED"] = "Afficher les boutons sur le suivi des objectifs"
L["S_GROUPFINDER_QUEUEBUSY"] = "vous êtes déjà dans une file d'attente."
...
L["S_INCREASESIZE"] = "Augmenter la taille"
L["S_MAPBAR_FILTER"] = "Filtre"
L["S_MAPBAR_FILTERMENU_FACTIONOBJECTIVES"] = "Objectifs de la faction"
...
L["S_MAPBAR_OPTIONSMENU_REFRESH"] = "Rafraîchir"
L["S_MAPBAR_OPTIONSMENU_SOUNDENABLED"] = "Activer le son"
L["S_MAPBAR_OPTIONSMENU_STATUSBAR_ONDISABLE"] = "utilisez '/wqt statusbar' ou l'option de l'addon dans les options d'interface pour restaurer la barre d'état."
L["S_MAPBAR_OPTIONSMENU_STATUSBAR_VISIBILITY"] = "Afficher la barre d'état"
L["S_MAPBAR_OPTIONSMENU_STATUSBARANCHOR"] = "Attacher en haut"
...
L["S_MAPBAR_OPTIONSMENU_UNTRACKQUESTS"] = "Désactiver le suivi de toutes les quêtes"
...
L["S_MAPBAR_SORTORDER_TIMELEFTPRIORITY_SORTBYTIME"] = "Trier par temps"
L["S_MAPBAR_SORTORDER_TIMELEFTPRIORITY_TITLE"] = "Temps restant"
L["S_MAPBAR_SUMMARYMENU_ACCOUNTWIDE"] = "Tout le compte"
L["S_OPENWORLD"] = "Monde ouvert"
L["S_OPTIONS_ACCESSIBILITY"] = "Accessibilité"
L["S_OPTIONS_ACCESSIBILITY_EXTRATRACKERMARK"] = "Marqueur de suivi supplémentaire"
L["S_OPTIONS_ACCESSIBILITY_SHOWBOUNTYRING"] = "Afficher l'anneau de récompense"
L["S_OPTIONS_ANIMATIONS"] = "Faire des animations"
L["S_OPTIONS_GF_DONT_SHOW_IFGROUP"] = "Ne pas afficher si vous êtes déjà dans un groupe"
L["S_OPTIONS_GF_SHOWOPTIONS_BUTTON"] = "Afficher le bouton des options"
L["S_OPTIONS_MAPFRAME_ALIGN"] = "Fenêtre de la carte centrée"
L["S_OPTIONS_MAPFRAME_ERROR_SCALING_DISABLED"] = "Vous devez d'abord activer l'option « Échelle de la fenêtre de la carte », aucune valeur n'a changé."
...
L["S_OPTIONS_SHOW_MINIMIZE_BUTTON"] = "Afficher le bouton réduire"
L["S_OPTIONS_SHOW_SORT_BUTTON"] = "Afficher le bouton de tri"
L["S_OPTIONS_SHOW_TIMELEFT_BUTTON"] = "Afficher le bouton temps restant"
L["S_OPTIONS_SHOW_WARBAND_REP_WARNING"] = "Afficher Bataillon sans Rep [!]"
L["S_OPTIONS_SHOW_WORLDSHORTCUT_BUTTON"] = "Afficher les raccourcis des cartes du monde"
L["S_OPTIONS_SHOWFACTIONS"] = "Afficher les factions"
L["S_OPTIONS_TALKINGHEADS"] = "Supprimer les têtes parlantes"
L["S_OPTIONS_TIMELEFT_NOPRIORITY"] = "Pas de priorité par temps restant"
L["S_OPTIONS_TRACKER_ATTACH_TO_QUESTLOG"] = "Ajouter au journal de quêtes"
...
L["S_OPTIONS_WORLDMAP_WIDGET_ALPHA"] = "Transparence"
L["S_OPTIONS_ZONE_SHOWONLYTRACKED"] = "Seulement suivies"
L["S_OPTTIONS_AUTOACCEPT_ABANDONQUEST"] = "Accepter automatiquement les quêtes abandonnées"
L["S_OPTTIONS_DRAGONRACE_MINIMAP"] = "Afficher le suivi sur mini-carte"
L["S_OPTTIONS_DRAGONRACE_TRACKCOLOR"] = "Couleur du suivi"
L["S_OPTTIONS_NUMERATE_QUEST"] = "Énumérer les quêtes"
L["S_OPTTIONS_QUESTLOCATIONSCALE_BYWORLDMAP"] = "Échelle de quête par carte du monde"
L["S_OPTTIONS_TAB_DRAGONRACE_SETTINGS"] = "Course draconique"
...
L["S_OPTTIONS_WORLDMAP_HUB_ENABLE"] = "Cartes qui affichent les quêtes"
L["S_OVERALL"] = "Total"
L["S_PARTY"] = "Groupe"
L["S_PARTY_DESC1"] = "Les quêtes marquées d'une étoile bleue signifient que tous les membres du groupe ont la quête."
L["S_PARTY_DESC2"] = "Si une étoile rouge apparaît, cela signifie que le membre du groupe n'est pas éligible pour les quêtes mondiales ou n'a pas encore installé WQT."
...
L["S_QUESTTYPE_TRADESKILL"] = "Artisanat"
L["S_RAID"] = "Raid"
L["S_RAREFINDER_ADDFROMPREMADE"] = "Ajouter les monstres rares trouvés dans les groupes prédéfinis"
...
L["S_SPEEDRUN_AUTO_COMPLETE"] = "Rendre automatiquement les quêtes"
...
L["S_TUTORIAL_AMOUNT"] = "Indique le montant à recevoir"
L["S_TUTORIAL_CLICKTOTRACK"] = "Cliquez pour suivre une quête."
L["S_TUTORIAL_PARTY"] = "Lorsque vous êtes en groupe, une étoile bleue apparaît sur les quêtes partagées par tous les membres du groupe !"
L["S_TUTORIAL_STATISTICS_BUTTON"] = "Cliquez ici pour consulter les statistiques et la liste des quêtes enregistrées pour d'autres personnages."
L["S_TUTORIAL_TIMELEFT"] = "indiquer le temps restant (+4 heures, +90 minutes, +30 minutes, moins de 30 minutes)"
L["S_TUTORIAL_WORLDBUTTONS"] = [=[Cliquez ici pour faire défiler trois types de résumés :
