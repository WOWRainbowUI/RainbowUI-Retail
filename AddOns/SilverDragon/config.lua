		...
		general = {
			...
			args = {
				...
				loot = {
					...
					order = 5,
					args = {
						about = desc("稀有怪獸與牠們的產地如何處理稀有怪掉落的戰利品的一些選項", 0),
						charloot = toggle("只有當前角色", "只顯示當前角色會掉落的戰利品。", 10),
						lootappearances = toggle("塑形外觀為主，不論物品", "如果你已經擁有相同的塑形外觀，則視為已取得，儘管是來自不同的物品。", 20),
					}
				},
			},
			plugins = {},
