...
if PetCastingBarFrame then
    ...
    -- print("|cff7aa2f7MSUF|r: |cffc0caf5/msuf|r |cff565f89to open options|r  |cff565f89|r  |cff9ece6a Beta Build 2.0 Beta 7 |cff565f89|r  |cffc0caf5 Thank you for using MSUF -|r  |cfff7768eReport bugs in the Discord.|r") -- 自行修改
 end, nil, true)
do
