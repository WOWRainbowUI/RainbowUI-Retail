...
if not _G.MSUF_SetBlizzardEditModeFromMSUF then
    -- Blizzard Edit Mode integration disabled:
    -- Blizzard's EditModeManagerFrame lifecycle has become unreliable on reload/zone transitions,
    -- which can force MSUF Edit Mode to open. MSUF now runs its own standalone Edit Mode.
