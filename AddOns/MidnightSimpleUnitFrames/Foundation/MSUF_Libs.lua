...
do
    ...
    local ALIAS_TO_PATH = {
        FRIZQT = STANDARD_TEXT_FONT , -- 修改字體
        ...
        ["Friz Quadrata TT"] = STANDARD_TEXT_FONT , -- 修改字體
        ["Friz Quadrata (default)"] = STANDARD_TEXT_FONT , -- 修改字體
    ...
    local function FontAssetAllowed(path)
		...
		if type(path) ~= "string" or path == "" then return nil end
		if path == STANDARD_TEXT_FONT then return path end   -- 修改字體
