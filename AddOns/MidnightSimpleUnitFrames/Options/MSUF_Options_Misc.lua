...
local bottomPanel = CreateFrame("Frame", nil, miscGroup, "BackdropTemplate")
  ...
  centerDivider:SetPoint("BOTTOM", bottomPanel, "BOTTOMLEFT", leftW, 12)
            ...
            if updateSlider then
                ...
                local lbl = MakeLabel(leftPanel, "單位更新頻率 (秒)", "TOPLEFT", leftPanel, 14, -78)
            ...
            if castbarUpdateSlider then
                ...
                local lbl = MakeLabel(leftPanel, "施法條更新", "TOPLEFT", rel, (rel == leftPanel and 14) or 0, (rel == leftPanel and -158) or -36)
            ...
            if ufcoreBudgetSlider then
                ...
                local lbl = MakeLabel(leftPanel, "UFCore 刷新預算", "TOPLEFT", rel, (rel == leftPanel and 14) or 0, (rel == leftPanel and -158) or -36)
                if rel ~= leftPanel then
                    lbl:ClearAllPoints()
                    lbl:SetPoint("TOPLEFT", rel, "BOTTOMLEFT", 0, -16)
                end
            ...
            if ufcoreUrgentSlider then
                ...
                local lbl = MakeLabel(leftPanel, "UFCore 緊急上限", "TOPLEFT", rel, (rel == leftPanel and 14) or 0, (rel == leftPanel and -158) or -36)
                if rel ~= leftPanel then
                    lbl:ClearAllPoints()
                    lbl:SetPoint("TOPLEFT", rel, "BOTTOMLEFT", 0, -16)
                end
