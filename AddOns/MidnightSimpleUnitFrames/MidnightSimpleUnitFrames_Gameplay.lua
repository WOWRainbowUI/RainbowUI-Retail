...
meleeInput:SetScript("OnEditFocusLost", function(self)
    ...
    local firstDanceCheck = _MSUF_Check("MSUF_Gameplay_FirstDanceCheck", "TOPLEFT", classSpecHeader, "BOTTOMLEFT", 0, -8, "盜賊：追蹤「初始之舞」(離開戰鬥後 6 秒)", "firstDanceCheck", "enableFirstDanceTimer")
