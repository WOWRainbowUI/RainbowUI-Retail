...
L["Your game account does not have Two-Factor Authentication (2FA) enabled.|n|nIf you use premade group finder to make a Mythic+ dungeon group for your own key, you may see a stop error when the game tries to set the activity title to your key level.  To clear this error, reload your UI.|n|nTo avoid seeing this error, enable Two-Factor Authentication (2FA) on your game account."] = "На вашем игровом аккаунте не включена двухфакторная аутентификация (2FA).|n|nЕсли вы используете готовый инструмент поиска групп, чтобы создать группу подземелий Mythic+ для своего собственного ключа, вы можете увидеть ошибку остановки, когда игра попытается установить название активности на ваш уровень ключа. Чтобы устранить эту ошибку, перезагрузите пользовательский интерфейс.|n|nЧтобы не видеть эту ошибку, включите двухфакторную аутентификацию (2FA) в своей игровой учетной записи."
L["Your game account does not have Two-Factor Authentication (2FA) enabled.|n|nIf you use premade group finder to make a Mythic+ dungeon group for your own key, you may see a stop error when the game tries to set the activity title to your key level. To clear this error, reload your UI.|n|nTo avoid seeing this error, enable Two-Factor Authentication (2FA) on your game account."] = "На вашей учетной записи игры не включена двухфакторная аутентификация (2FA).|n|nЕсли вы используете поиск заранее созданных групп, чтобы создать группу подземелья Mythic+ для своего ключа, вы можете столкнуться с ошибкой при попытке установить заголовок активности на уровень вашего ключа. Для устранения этой ошибки перезагрузите ваш интерфейс пользователя (UI).|n|nЧтобы избежать возникновения этой ошибки, включите двухфакторную аутентификацию (2FA) на вашей учетной записи игры."
...
L["Your game account does not have Two-Factor Authentication (2FA) enabled.|n|nIf you use premade group finder to make a Mythic+ dungeon group for your own key, you may see a stop error when the game tries to set the activity title to your key level.  To clear this error, reload your UI.|n|nTo avoid seeing this error, enable Two-Factor Authentication (2FA) on your game account."] = "게임 계정에 2단계 인증(2FA)이 활성화되어 있지 않습니다.|n|n만약 자신의 열쇠로 신화+ 던전 그룹을 만들기 위해 미리 제작된 그룹 찾기를 사용한다면, 게임이 활동 제목을 열쇠 레벨로 설정하려고 할 때 중단 오류가 발생할 수 있습니다. 이 오류를 해결하려면 UI를 다시 로드하십시오.|n|n이 오류를 보지 않으려면 게임 계정에서 2단계 인증(2FA)을 활성화하세요."
L["Your game account does not have Two-Factor Authentication (2FA) enabled.|n|nIf you use premade group finder to make a Mythic+ dungeon group for your own key, you may see a stop error when the game tries to set the activity title to your key level. To clear this error, reload your UI.|n|nTo avoid seeing this error, enable Two-Factor Authentication (2FA) on your game account."] = "게임 계정에 2단계 인증(2FA)이 활성화되어 있지 않습니다.|n|n만약 자신의 열쇠로 신화+ 던전 그룹을 만들기 위해 미리 제작된 그룹 찾기를 사용한다면, 게임이 활동 제목을 열쇠 레벨로 설정하려고 할 때 중단 오류가 발생할 수 있습니다. 이 오류를 해결하려면 UI를 다시 로드하십시오.|n|n이 오류를 보지 않으려면 게임 계정에서 2단계 인증(2FA)을 활성화하세요."
...
L["Your game account does not have Two-Factor Authentication (2FA) enabled.|n|nIf you use premade group finder to make a Mythic+ dungeon group for your own key, you may see a stop error when the game tries to set the activity title to your key level.  To clear this error, reload your UI.|n|nTo avoid seeing this error, enable Two-Factor Authentication (2FA) on your game account."] = "Ihr Spielkonto hat die Zwei-Faktor-Authentifizierung (2FA) nicht aktiviert.|n|nWenn Sie den vorbereiteten Gruppenfinder verwenden, um eine Mythisch+ Dungeon-Gruppe für Ihren eigenen Schlüssel zu erstellen, kann ein Fehler auftreten, wenn das Spiel versucht, den Aktivitätstitel auf Ihr Schlüsselniveau einzustellen. Um diesen Fehler zu beheben, laden Sie Ihre Benutzeroberfläche neu.|n|nUm zu verhindern, dass dieser Fehler angezeigt wird, aktivieren Sie die Zwei-Faktor-Authentifizierung (2FA) auf Ihrem Spielkonto."
L["Your game account does not have Two-Factor Authentication (2FA) enabled.|n|nIf you use premade group finder to make a Mythic+ dungeon group for your own key, you may see a stop error when the game tries to set the activity title to your key level. To clear this error, reload your UI.|n|nTo avoid seeing this error, enable Two-Factor Authentication (2FA) on your game account."] = "Ihr Spielkonto hat die Zwei-Faktor-Authentifizierung (2FA) nicht aktiviert.|n|nWenn Sie den vorbereiteten Gruppenfinder verwenden, um eine Mythisch+ Dungeon-Gruppe für Ihren eigenen Schlüssel zu erstellen, kann ein Fehler auftreten, wenn das Spiel versucht, den Aktivitätstitel auf Ihr Schlüsselniveau einzustellen. Um diesen Fehler zu beheben, laden Sie Ihre Benutzeroberfläche neu.|n|nUm zu verhindern, dass dieser Fehler angezeigt wird, aktivieren Sie die Zwei-Faktor-Authentifizierung (2FA) auf Ihrem Spielkonto."
...
L["A stop error has occurred but no need to worry.  It can happen from time to time.  Click the reload button to resolve it."] = "Se ha producido un error de detención, pero no hay necesidad de preocuparse. Puede ocurrir de vez en cuando. Haz clic en el botón de recarga para resolverlo."
...
L["Your game account does not have Two-Factor Authentication (2FA) enabled.|n|nIf you use premade group finder to make a Mythic+ dungeon group for your own key, you may see a stop error when the game tries to set the activity title to your key level.  To clear this error, reload your UI.|n|nTo avoid seeing this error, enable Two-Factor Authentication (2FA) on your game account."] = "Tu cuenta de juego no tiene la Autenticación de Dos Factores (2FA) activada.|n|nSi usas el buscador de grupos prearmados para crear un grupo de mazmorras Míticas+ con tu propia clave, podrías ver un error de detención cuando el juego intenta establecer el título de actividad a tu nivel de clave. Para resolver este error, recarga tu interfaz de usuario (UI).|n|nPara evitar ver este error, activa la Autenticación de Dos Factores (2FA) en tu cuenta de juego."
L["Your game account does not have Two-Factor Authentication (2FA) enabled.|n|nIf you use premade group finder to make a Mythic+ dungeon group for your own key, you may see a stop error when the game tries to set the activity title to your key level. To clear this error, reload your UI.|n|nTo avoid seeing this error, enable Two-Factor Authentication (2FA) on your game account."] = "Tu cuenta de juego no tiene habilitada la Autenticación de Dos Factores (2FA).|n|nSi usas el buscador de grupos prearmados para formar un grupo de mazmorra mítica+ con tu propia llave, es posible que veas un error al intentar establecer el título de la actividad con el nivel de tu llave. Para resolver este error, recarga tu interfaz de usuario (UI).|n|nPara evitar ver este error, habilita la Autenticación de Dos Factores (2FA) en tu cuenta de juego."
...
L["Your game account does not have Two-Factor Authentication (2FA) enabled.|n|nIf you use premade group finder to make a Mythic+ dungeon group for your own key, you may see a stop error when the game tries to set the activity title to your key level. To clear this error, reload your UI.|n|nTo avoid seeing this error, enable Two-Factor Authentication (2FA) on your game account."] = "Votre compte de jeu n'a pas activé l'authentification à deux facteurs (2FA). |n|nSi vous utilisez le chercheur de groupe préfabriqué pour créer un groupe de donjon Mythique+ pour votre propre clé, vous pouvez rencontrer une erreur d'arrêt lorsque le jeu tente de définir le titre de l'activité sur le niveau de votre clé. Pour résoudre cette erreur, rechargez votre interface utilisateur. |n|nPour éviter de voir cette erreur, activez l'authentification à deux facteurs (2FA) sur votre compte de jeu."
...
L["A stop error has occurred but no need to worry.  It can happen from time to time.  Click the reload button to resolve it."] = "Ocorreu um erro de parada, mas não há com o que se preocupar. Isso pode acontecer de vez em quando. Clique no botão recarregar para resolver."
L["Algeth'ar Academy"] = "Academia Algeth'ar"
...
L["Your game account does not have Two-Factor Authentication (2FA) enabled.|n|nIf you use premade group finder to make a Mythic+ dungeon group for your own key, you may see a stop error when the game tries to set the activity title to your key level.  To clear this error, reload your UI.|n|nTo avoid seeing this error, enable Two-Factor Authentication (2FA) on your game account."] = "Sua conta de jogo não possui Autenticação em Dois Fatores (2FA) ativada.|n|nSe você usar o localizador de grupos pré-fabricados para criar um grupo de masmorra Mítica+ com sua própria chave, você pode ver um erro de parada quando o jogo tenta definir o título da atividade para o nível da sua chave. Para corrigir esse erro, recarregue sua interface do usuário (UI).|n|nPara evitar ver esse erro, ative a Autenticação em Dois Fatores (2FA) em sua conta de jogo."
L["Your game account does not have Two-Factor Authentication (2FA) enabled.|n|nIf you use premade group finder to make a Mythic+ dungeon group for your own key, you may see a stop error when the game tries to set the activity title to your key level. To clear this error, reload your UI.|n|nTo avoid seeing this error, enable Two-Factor Authentication (2FA) on your game account."] = "Sua conta de jogo não possui Autenticação em Dois Fatores (2FA) ativada.|n|nSe você usar o localizador de grupos para criar um grupo de masmorra Mítica+ com sua própria chave, poderá ver um erro de parada quando o jogo tentar definir o título da atividade para o nível da sua chave. Para corrigir esse erro, recarregue sua interface do usuário (UI).|n|nPara evitar ver esse erro, ative a Autenticação em Dois Fatores (2FA) em sua conta de jogo."
