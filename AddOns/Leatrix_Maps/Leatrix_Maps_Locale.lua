...
L["Your UI needs to be reloaded for some of the changes to take effect.|n|nYou don't have to click the reload button immediately, but you do need to click it when you are done making changes and you want the changes to take effect."] = "Необходимо перезагрузить интерфейс пользователя (UI), чтобы изменения вступили в силу.|n|nВы не обязаны немедленно нажимать кнопку перезагрузки, но вам нужно будет сделать это, когда вы закончите внесение изменений и захотите, чтобы изменения вступили в силу."
...
L["Your UI needs to be reloaded for some of the changes to take effect.|n|nYou don't have to click the reload button immediately, but you do need to click it when you are done making changes and you want the changes to take effect."] = "변경 사항 중 일부가 적용되려면 UI를 다시 로드해야 합니다.|n|n즉시 다시로드 버튼을 클릭할 필요는 없지만 변경 사항을 완료한 후에는 클릭하여 변경 사항이 적용되도록 해야 합니다."
...
L["Your UI needs to be reloaded for some of the changes to take effect.|n|nYou don't have to click the reload button immediately, but you do need to click it when you are done making changes and you want the changes to take effect."] = "Deine Benutzeroberfläche muss neu geladen werden, damit einige Änderungen wirksam werden.|n|nDu musst den Neuladen-Button nicht sofort klicken, aber du musst darauf klicken, wenn du mit den Änderungen fertig bist und möchtest, dass sie wirksam werden."
...
L["Your UI needs to be reloaded for some of the changes to take effect.|n|nYou don't have to click the reload button immediately, but you do need to click it when you are done making changes and you want the changes to take effect."] = "Es necesario recargar tu interfaz para que algunos de los cambios surtan efecto.|n|nNo es necesario hacer clic en el botón de recarga inmediatamente, pero debes hacerlo cuando hayas terminado de realizar cambios y desees que los cambios surtan efecto."
...
L["Your UI needs to be reloaded for some of the changes to take effect.|n|nYou don't have to click the reload button immediately, but you do need to click it when you are done making changes and you want the changes to take effect."] = "Votre interface utilisateur doit être rechargée pour que certains changements prennent effet.|n|nVous n'êtes pas obligé de cliquer immédiatement sur le bouton de rechargement, mais vous devez le faire une fois que vous avez terminé de faire des modifications et que vous souhaitez que les changements prennent effet."
