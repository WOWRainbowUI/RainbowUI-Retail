...
local L = {
    ...
    TAB_TRACKERS = "Seguimientos",
    TAB_META_ACHIEVEMENTS = "Metalogros",
    TEXT_FOLIO_NODE_FMT = "Nodo %d",
    TEXT_GEAR_TITLE_FMT = "%s — %s",
    LABEL_GEAR_CRIT = "Crítico",
    LABEL_GEAR_HASTE = "Celeridad",
    LABEL_GEAR_MASTERY = "Maestría",
    LABEL_GEAR_VERS = "Versatilidad",
    TEXT_GEAR_ILVL_COLORED_FMT = "Nivel de objeto |c%s%d|r",
    ...
    LABEL_WEEKLY_COMPLETION_SUMMARY = "%d / %d completadas",
    ...
    TOOLTIP_VOIDSHARDS_TITLE = "Fragmentos del Vacío ascendentes",
    TOOLTIP_VOIDCORES_TITLE = "Núcleos del Vacío ascendentes",
...
L["LABEL_HISTORY_COUNT"] = "Número de registros del historial"
...
L["LABEL_TOKEN_AFFORDABLE"] = "Asequible"
L["LABEL_TOKEN_DELTA"] = "Diferencia"
...
L["TEXT_PROFIT_ITEM_FALLBACK_FMT"] = "Objeto %d"
L["TEXT_PROFIT_GOALS_SUBTITLE"] = "Objetivos de beneficio neto semanales y mensuales para tu banda guerrera."
L["TEXT_PROFIT_GOAL_EDITOR_HINT"] = "Introduce un objetivo en oro. Déjalo en blanco o escribe 0 para borrarlo."
...
L["TEXT_PROFIT_GRAPH_PENDING_MONTHLY"] = "El historial del gráfico mensual ya está registrándose y se completará a medida que ganes o gastes oro."
L["TEXT_PROFIT_GRAPH_PENDING_WARBAND_MONTHLY"] = "El historial mensual de la banda guerrera ya está registrándose y se completará a medida que se registren cambios de oro."
...
L["TEXT_PROFIT_MONTHLY_GRAPH_SUBTITLE"] = "Beneficio neto diario del personaje actual este mes. Los nuevos datos aparecerán a medida que se registren cambios de oro."
L["TEXT_PROFIT_MONTHLY_LEDGER_SUBTITLE"] = "Transacciones mensuales recientes del personaje actual."
L["TEXT_PROFIT_SUBTITLE"] = "Weekly and monthly profit across your tracked characters."
L["TEXT_PROFIT_WARBAND_GRAPH_SUBTITLE"] = "Beneficio diario combinado de los personajes registrados durante los últimos 7 días."
L["TEXT_PROFIT_WARBAND_LEDGER_WEEKLY_SUBTITLE"] = "Transacciones semanales combinadas recientes de los personajes registrados."
L["TEXT_PROFIT_WARBAND_MONTHLY_GRAPH_SUBTITLE"] = "Beneficio diario combinado de los personajes registrados este mes."
L["TEXT_PROFIT_SOURCE_AH_FEE"] = "Comisión de la casa de subastas"
...
L["TEXT_PROFIT_WEEKLY_GRAPH_SUBTITLE"] = "Beneficio neto diario del personaje actual durante los últimos 7 días."
L["TEXT_PROFIT_WEEKLY_LEDGER_SUBTITLE"] = "Transacciones semanales recientes del personaje actual."
L["TEXT_TRACKED_ACHIEVEMENT_ENTRIES_UNAVAILABLE_FMT"] = "Aún no se han añadido entradas registradas para %s."
L["TIME_DAYS_AGO_FMT"] = "hace %d d"
L["TIME_HOURS_AGO_FMT"] = "hace %d h"
L["TIME_JUST_NOW"] = "Just now"
L["TIME_MINUTES_AGO_FMT"] = "hace %d min"
...
L["TEXT_PROFIT_TOKENS_THIS_MONTH_FMT"] = "Fichas este mes: %d"
L["TITLE_PROFIT_WOW_TOKENS_THIS_MONTH"] = "Fichas de WoW este mes"
L["TITLE_WOW_TOKEN_HISTORY"] = "WoW Token History"
L["TOOLTIP_PROFIT_WOW_TOKENS_THIS_MONTH"] = "Cuenta las fichas de WoW compradas durante el mes natural actual. Las compras de fichas se excluyen de los beneficios totales."
...
L["Discover all of the lore objects found on the Coiled Isle."] = "Descubre todos los objetos de historia de Coiled Isle."
L["%s contains %d moth coordinates. Click a moth to place a waypoint."] = "%s contiene %d coordenadas de polillas. Haz clic en una polilla para colocar un punto de ruta."
...
L["LABEL_MAX_RENOWN"] = "Renombre máximo"
L["LABEL_PARAGON"] = "Dechado"
L["TOOLTIP_FACTION_CARD_HINT"] = "Click to switch this faction."
L["TEXT_PROFIT_WARBAND_BREAKDOWN_GAINS"] = "Dónde obtuvo más oro tu banda guerrera esta semana."
L["TEXT_PROFIT_WARBAND_BREAKDOWN_SPEND"] = "Dónde gastó más oro tu banda guerrera esta semana."
L["MSG_PROFIT_NO_INCOME"] = "Todavía no hay ingresos registrados."
L["MSG_PROFIT_NO_SPENDING"] = "Todavía no hay gastos registrados."
L["OPTION_DISABLE_RUNESTONE_MAP_PINS"] = "Desactivar los marcadores de piedras rúnicas"
L["OPTION_DISABLE_RUNESTONE_MAP_PINS_DESC"] = "Oculta los marcadores de piedras rúnicas de LiteVault en el mapa del Bosque Canción Eterna."
...
L["BUTTON_CAPTAIN_TOKKA"] = "Capitana Tokka"
...
L["LABEL_QUEST_FMT"] = "Misión: %s"
L["LABEL_QUEST_ID_FMT"] = "ID de misión: %d"
...
local phase2 = {
MSG_NO_FACTION_WEEKLY_COMPLETIONS="No hay actividades semanales completadas registradas.", TOOLTIP_QUEST_ID_FMT="ID: |cffffffff%d", CALENDAR_MONTH_YEAR_FMT="%s de %d",
LABEL_RENOWN_LEVEL_MAXIMUM_FMT="Nivel de renombre %d - Máximo", LABEL_RENOWN_LEVEL_PROGRESS_FMT="Nivel de renombre %d (%d/%d)", LABEL_RENOWN_LEVEL_FMT="Nivel de renombre %d", LABEL_RENOWN_VALUE_FMT="Renombre %d",
TEXT_CRESTS_WITH_VALUES_FMT="Blasones %s", TOOLTIP_REWARDS_FMT="Recompensas: %s", TOOLTIP_MOUNT_COLLECTED_FMT="%s (Conseguida)", TOOLTIP_MOUNT_UNCOLLECTED_FMT="%s (No conseguida)", LABEL_REWARD="Recompensa", LABEL_NOTE="Nota", STATUS_ACTIVE="Activo",
TOOLTIP_ENTRANCE_COORDINATES_FMT="Entrada: %.2f, %.2f (mapa %d)", TOOLTIP_INSCRIPTION_COORDINATES_FMT="Inscripción: %.2f, %.2f (mapa %d)", TOOLTIP_ENTRANCE_INSCRIPTION_CLICK_INSTRUCTIONS="Mayús-clic para la entrada; clic para la inscripción.", LABEL_100_RENOWN_FMT="100 de renombre: %s", TOOLTIP_ACHIEVEMENT_CREDIT_FROM_FMT="Crédito del logro de: %s",
NOTE_HARANDAR_TREASURE_REQUIREMENTS="Algunos tesoros requieren pasos u objetos adicionales para abrirlos.", NOTE_FORGOTTEN_MASK_LOCATION="En un muro de piedra derruido de la isla Gnarldor, al sur de la entrada de la profundización.", NOTE_HEAD_MASONS_TABLET_LOCATION="Dentro de la Puerta del Colmillo Oriental. Entrada: 45.72, 64.94 en el mapa 2512.", NOTE_PROFANED_PLAQUE_LOCATION="Dentro de la Puerta del Colmillo Occidental, en la sala inmediatamente a la izquierda al entrar. Entrada: 31.80, 64.91 en el mapa 2512.",
BUTTON_CANCEL="Cancelar", BUTTON_SAVE="Guardar", BUTTON_SELECT_ALL="Seleccionar todo", LABEL_COMPLETED="Completado", LABEL_NOT_COMPLETED="No completado", LABEL_DETAILS="Detalles", LABEL_DETAIL="Detalle", LABEL_INFO="Información", LABEL_MAXIMUM="Máximo", LABEL_PREVIOUS="Anterior", LABEL_RECENT_HISTORY="Historial reciente", LABEL_SOURCE="Fuente", LABEL_STATUS="Estado", TIME_JUST_NOW="Ahora mismo", TIME_YESTERDAY="Ayer",
BUTTON_BACK_TO_GROUPS="Volver a los grupos", TEXT_COORDINATE_GROUPS_NOT_AVAILABLE="Aún no se han añadido los grupos de coordenadas.", TEXT_ZONE_REWARD_NOT_AVAILABLE="La recompensa de zona aún no se ha añadido.", TEXT_META_REWARD_NOT_AVAILABLE="La recompensa del metalogro aún no se ha añadido.", TEXT_ACHIEVEMENT_REWARD_NOT_LISTED="No se indica ninguna recompensa del logro.", TOOLTIP_RUNESTONE_CHARGE_INSTRUCTION="Carga la piedra rúnica con Arcano latente para iniciar su evento de defensa.", TEXT_COORDINATES_PENDING="Coordenadas pendientes.", TOOLTIP_CLICK_OPEN_TRACKER="Haz clic para abrir este seguimiento.", TEXT_TRACKER_NOT_AVAILABLE="Seguimiento aún no añadido.",
MSG_PROFIT_GOAL_INVALID="Introduce una cantidad de oro válida.", MSG_PROFIT_GOAL_NOT_SET="No se ha establecido ningún objetivo", TEXT_PROFIT_EXPORT_HINT="Haz clic en el cuadro y pulsa Ctrl+C para copiar.", TEXT_PROFIT_EXPORT_SUBTITLE="Copia el texto CSV de abajo.", TEXT_PROFIT_SOURCE_BLACK_MARKET="Mercado Negro", TEXT_PROFIT_SOURCE_CHEST="Cofre", TEXT_PROFIT_SOURCE_CRAFT="Fabricación", TEXT_PROFIT_SOURCE_FLIGHT_PATH="Ruta de vuelo", TEXT_PROFIT_SOURCE_GUILD_BANK="Banco de hermandad", TEXT_PROFIT_SOURCE_LOOTED="Despojado", TEXT_PROFIT_SOURCE_REPAIR="Reparación", TEXT_PROFIT_SOURCE_TRAINING="Entrenamiento", TEXT_PROFIT_SOURCE_WORLD_QUEST="Misión del mundo", MSG_RAID_RESYNC_COMPLETE="Resincronización de banda completada.", MSG_RAID_RESYNC_STARTED="Resincronización de banda iniciada...", MSG_RAID_RESYNC_UNAVAILABLE="Resincronización de banda no disponible.",
TEXT_PROFIT_FALLBACK_APPEARANCE_COST="Coste de apariencia", TEXT_PROFIT_FALLBACK_AUCTION_DEPOSIT="Depósito de subasta", TEXT_PROFIT_FALLBACK_AUCTION_FEE="Comisión de subasta", TEXT_PROFIT_FALLBACK_AUCTION_PURCHASE="Compra en subasta", TEXT_PROFIT_FALLBACK_AUCTION_SALE="Venta en subasta", TEXT_PROFIT_FALLBACK_BARBER_COST="Coste de peluquería", TEXT_PROFIT_FALLBACK_BLACK_MARKET_PURCHASE="Compra en el Mercado Negro", TEXT_PROFIT_FALLBACK_CRAFTING_ORDER="Pedido de fabricación", TEXT_PROFIT_FALLBACK_GEAR_UPGRADE="Mejora de equipo", TEXT_PROFIT_FALLBACK_GOLD_RECEIVED="Oro recibido", TEXT_PROFIT_FALLBACK_GOLD_REWARD="Recompensa de oro", TEXT_PROFIT_FALLBACK_GOLD_SENT="Oro enviado", TEXT_PROFIT_FALLBACK_GUILD_DEPOSIT="Depósito de hermandad", TEXT_PROFIT_FALLBACK_GUILD_WITHDRAWAL="Retirada de hermandad", TEXT_PROFIT_FALLBACK_RAW_GOLD="Oro directo", TEXT_PROFIT_FALLBACK_SERVICE_COST="Coste de servicio", TEXT_PROFIT_FALLBACK_TRADE_GAIN="Ganancia de comercio", TEXT_PROFIT_FALLBACK_TRADE_PAYMENT="Pago de comercio", TEXT_PROFIT_FALLBACK_TRAINING_COST="Coste de entrenamiento", TEXT_PROFIT_FALLBACK_TRAVEL_COST="Coste de viaje", TEXT_PROFIT_GRAPH_EMPTY_MONTHLY="Aún no hay historial mensual de beneficios.", TEXT_PROFIT_GRAPH_EMPTY_WARBAND="Aún no hay historial de beneficios de la banda guerrera.", TEXT_PROFIT_GRAPH_EMPTY_WARBAND_MONTHLY="Aún no hay historial mensual de beneficios de la banda guerrera.", TEXT_PROFIT_GRAPH_EMPTY_WEEKLY="Aún no hay historial semanal de beneficios.", TEXT_PROFIT_LEDGER_EMPTY_MONTHLY="Aún no hay transacciones mensuales en el registro.", TEXT_PROFIT_LEDGER_EMPTY_WARBAND="Aún no hay transacciones de la banda guerrera en el registro.", TEXT_PROFIT_LEDGER_EMPTY_WEEKLY="Aún no hay transacciones semanales en el registro.", TEXT_PROFIT_SUBTITLE="Beneficios semanales y mensuales de tus personajes registrados.",
BUTTON_BREAKDOWN="Desglose", BUTTON_FILTER="Filtrar", BUTTON_SET="Establecer", BUTTON_RAIDS="Bandas", BUTTON_WARBAND_BANK_HISTORY="Historial del banco de la banda guerrera", TITLE_TREASURES_OF_THE_DAMNED="Tesoros de los condenados", TOOLTIP_TOKKA_TREASURE_HINT="Pesca este artefacto en Coiled Isle y devuélveselo a Second Mate Sluggs en Tokka's Folly.", WARNING_TOKKA_ONE_TIME_ARTIFACTS="Aviso: estas misiones de artefacto son entregas únicas de la banda guerrera. No se reinician diaria ni semanalmente y solo otorgan reputación una vez.", MSG_RAID_HISTORY_PRESERVED="Se ha conservado el historial de bandas; el reinicio destructivo de temporada está desactivado.", TOOLTIP_RAID_BOSS_DIFFICULTY_FMT="%s — %s", TITLE_MINI_OMNIUM_FOLIO="Folio de Omnium", TOOLTIP_HIDE_MINI_FOLIO="Ocultar minifolio", TOOLTIP_LOCK_MINI_FOLIO="Bloquear minifolio", TOOLTIP_UNLOCK_MINI_FOLIO="Desbloquear minifolio", TAB_GLYPHS="Glifos", TITLE_GLYPH_HUNTER="Cazador de glifos", TOOLTIP_RUNESTONE_SET_WAYPOINT="Haz clic para establecer un punto de ruta.", LABEL_CHARACTER_TIME="Tiempo del personaje", LABEL_LAST_UPDATED="Última actualización", LABEL_VAULT_OVERALL_PROGRESS="Progreso total: %d/%d", LABEL_VAULT_ROW_DUNGEONS="Mazmorras", TITLE_CHARACTER_GREAT_VAULT_FMT="Gran Cámara de %s: %s", TITLE_CHARACTER_WEEKLY_PLANNER_FMT="Planificador semanal de %s: %s", LABEL_NEXT_WEEK_FMT="Próxima semana: %s",
BUTTON_EDIT_MONTHLY_GOAL="Editar objetivo mensual", BUTTON_EDIT_WEEKLY_GOAL="Editar objetivo semanal", BUTTON_EXPORT_CSV="Exportar CSV", BUTTON_MONTHLY_PROFIT_EXPORT="Beneficio mensual en CSV", BUTTON_WARBAND_PROFIT_BREAKDOWN="Desglose de la banda guerrera", BUTTON_WARBAND_PROFIT_EXPORT="Beneficio semanal de la banda guerrera en CSV", BUTTON_WEEKLY_PROFIT_EXPORT="Beneficio semanal en CSV", LABEL_GOAL_AMOUNT="Cantidad del objetivo (oro)", LABEL_GOLD="Oro", LABEL_NET="Neto", LABEL_SHARE="Compartir", LABEL_ZONE="Zona", LABEL_WARBAND_WEEKLY_PROFIT="Beneficio semanal de la banda guerrera", MSG_NIT_TIMEPLAYED_WARNING="Se ha detectado NovaInstanceTracker. NIT puede ocultar el mensaje /played aunque la opción de LiteVault esté desactivada.", MSG_TIMEPLAYED_RESTORED="Se han restaurado los mensajes de tiempo jugado.", MSG_TIMEPLAYED_SUPPRESSED="Se ocultarán los mensajes de tiempo jugado.", MSG_WOW_TOKEN_API_UNAVAILABLE="La API de la Ficha de WoW no está disponible en este cliente.", MSG_WOW_TOKEN_DATA_UNAVAILABLE="Los datos de la Ficha de WoW no están disponibles.", MSG_WOW_TOKEN_VISIT_AH="Visita la casa de subastas para actualizar el precio de la Ficha de WoW.", OPTION_ENABLE_CALENDAR_PROFIT_HIGHLIGHTS_DESC="Muestra marcas verdes y rojas para los días con beneficios o pérdidas en el calendario.",
TITLE_ACHIEVEMENTS="Logros", LABEL_ACHIEVEMENT_GROUPS="Grupos", LABEL_GLOWING_MOTHS="Polillas", LABEL_SHARED_LOOT="Botín compartido", LABEL_KNOWLEDGE_CATCHUP="Recuperación", STATUS_ASSAULT_WAVE_1_COMPLETE="Oleada 1 completada", STATUS_ASSAULT_WAVE_2_COMPLETE="Oleada 2 completada", STATUS_ASSAULT_WAVE_3_COMPLETE="Oleada 3 completada", TEXT_MIDNIGHT_RARES_TRACKER_DESCRIPTION="Sigue los logros de criaturas poco comunes de Midnight, sus recompensas y el botín compartido.", TEXT_MIDNIGHT_TREASURES_TRACKER_DESCRIPTION="Sigue los logros de tesoros de Midnight y sus recompensas.", TEXT_HARANIR_JOURNAL_INSTRUCTION="Recupera las entradas del diario haranir indicadas abajo.", TEXT_HARANIR_LEGEND_DEFENSE_INSTRUCTION="Defiende cada ubicación de leyenda haranir indicada abajo.", TEXT_BLESSING_EFFECT_INSTRUCTION="Activa cada efecto de bendición indicado para obtener crédito.", TOOLTIP_CAVE_RUN_CREDIT_INSTRUCTION="Completa el recorrido de esta cueva para obtener crédito.", TEXT_TELESCOPE_ZONE_REQUIREMENT="Completa los cinco telescopios de esta zona.",
TEXT_MIDNIGHT_DELVER_META_INSTRUCTION="Completa los cuatro logros de profundidades auxiliares de Midnight para terminar este metalogro.", TEXT_COILED_ISLE_META_INSTRUCTION="Completa los logros de Coiled Isle.", TEXT_MIDNIGHT_ZONE_META_REWARD_REQUIREMENT="Completa los cuatro metalogros de zona de Midnight y consigue la montura como recompensa.", TEXT_CLAW_ENFORCEMENT_REQUIREMENT="Completa la misión del mundo de Harandar 'Claw Enforcement' con al menos 15 acumulaciones de Predator's Pursuit.", TEXT_ATALUTEK_META_INSTRUCTION="Completa los logros de Vaults of Atal'Utek.", TEXT_COILED_ISLE_LORE_INSTRUCTION="Descubre los objetos de historia de Coiled Isle.", TEXT_HUNGERING_PRESENCE_REQUIREMENT="Evita las garras de Hungering Presence en Voidstorm durante al menos 60 segundos.", TEXT_CRADLE_FLIGHT_REQUIREMENT="Vuela hasta The Cradle, muy por encima de Harandar, para completar este logro.", TEXT_EVERSONG_META_TRACKER_DESCRIPTION="Sigue el metalogro de Eversong Woods y accede a sus seguimientos secundarios.", TEXT_MIDNIGHT_PEAKS_TRACKER_DESCRIPTION="Sigue los cuatro logros de zona de Midnight, the Highest Peaks.", TEXT_HARANDAR_META_TRACKER_DESCRIPTION="Sigue el metalogro de Harandar y accede a sus seguimientos secundarios.", TEXT_VOIDSTORM_META_TRACKER_DESCRIPTION="Sigue el metalogro de Voidstorm y accede a sus seguimientos secundarios.", TEXT_ZULAMAN_META_TRACKER_DESCRIPTION="Sigue el metalogro de Zul'Aman y accede a sus seguimientos secundarios.", TEXT_CRADLE_FLIGHT_ATTEMPT="Intenta volar hasta The Cradle, muy por encima de Harandar.", NOTE_MOTH_ROUTE_RENOWN_REQUIREMENT="La ruta de LiteVault presupone que ya has desbloqueado Hara'ti Renown 11.",
TEXT_HARATI_META_PROGRESS_INSTRUCTION="Ayuda a los Hara'ti completando los logros de abajo. x/y completados.", TEXT_VOIDSTORM_META_PROGRESS_INSTRUCTION="Completa todos los logros de Voidstorm indicados abajo. x/y completados.", TEXT_ZULAMAN_META_PROGRESS_INSTRUCTION="Completa todos los logros de Zul'Aman indicados abajo. x/y completados.", TEXT_STORMARION_ASSAULT_PROGRESS_INSTRUCTION="Completa las tres oleadas de Stormarion Assault. x/y marcadas.", TEXT_ABUNDANT_HARVEST_PROGRESS_INSTRUCTION="Completa un recorrido de cueva de Abundant Harvest en cada ubicación. x/y marcados.", TEXT_EVERSONG_META_PROGRESS_INSTRUCTION="Completa los logros de Eversong Woods indicados abajo. x/y completados.", TEXT_GLOWING_MOTH_PROGRESS="Encuentra todas las Glowing Moths ocultas en Harandar. x/y encontradas.", TEXT_HARANIR_LEGEND_PROGRESS="Protege cada ubicación de leyenda haranir indicada abajo. x/y marcadas.", TEXT_XALATATH_META_PROGRESS="Reúne tus fuerzas contra Xal'atath completando los logros de abajo. x/y completados.", TEXT_HARANIR_JOURNAL_PROGRESS="Recupera las entradas del diario haranir indicadas abajo. x/y marcadas.", TEXT_BLESSING_EFFECT_PROGRESS="Activa cada efecto de bendición indicado. x/y marcados.", TEXT_FACTION_INVITE_PROGRESS="Sigue las cuatro invitaciones de facción de The Party Must Go On. x/y marcadas.", TEXT_EVER_PAINTING_PROGRESS="Sigue los lienzos conocidos de Ever-Painting. x/y marcados.", TEXT_RUNESTONE_RUSH_PROGRESS="Sigue las entradas conocidas de Runestone Rush. x/y marcadas.",
TEXT_DELVER_MOUNT_REWARD_REQUIREMENT="Completa Glory of the Midnight Delver para conseguir esta montura.", NOTE_MOTH_GROUP_1_RENOWN="Las polillas 1-40 aparecen con Hara'ti Renown 1 y su seguimiento con Renown 2.", NOTE_MOTH_GROUP_2_RENOWN="Las polillas 41-80 aparecen con Hara'ti Renown 4 y su seguimiento con Renown 6.", NOTE_MOTH_GROUP_3_RENOWN="Las polillas 81-120 aparecen con Hara'ti Renown 9 y su seguimiento con Renown 11.", NOTE_HARANIR_JOURNAL_AVAILABILITY="Estos diarios solo están disponibles durante la misión semanal ligada a la cuenta 'Legends of the Haranir'. Durante una visión, busca el icono de lupa en el minimapa.", NOTE_CLAW_ENFORCEMENT_NO_COORDINATES="Este logro no necesita seguimiento de coordenadas en LiteVault. Completa la misión del mundo de Harandar 'Claw Enforcement' con al menos 15 acumulaciones de Predator's Pursuit.", NOTE_HUNGERING_PRESENCE_NO_COORDINATES="Este logro no necesita seguimiento de coordenadas en LiteVault. Sobrevive al evento Hungering Presence en Voidstorm durante al menos 60 segundos.", NOTE_HARANIR_LEGENDS_WEEKLY_ESTIMATE="Esto está vinculado a la misión semanal ligada a la cuenta 'Legends of the Haranir'. Si aún no tienes progreso, se calcula que tardarás unas 7 semanas.", NOTE_MOTH_TRACKER_GROUPING="Este seguimiento se divide en 3 grupos de 40 coordenadas para que las rutas de polillas sean manejables.", TEXT_EVER_PAINTING_TRACKER_PLACEHOLDER="Sigue el progreso de Ever-Painting. Los detalles se pueden añadir más adelante.", TEXT_EXPLORE_EVERSONG_TRACKER_PLACEHOLDER="Sigue el progreso de Explore Eversong Woods. Los detalles se pueden añadir más adelante.", TEXT_RUNESTONE_RUSH_TRACKER_PLACEHOLDER="Sigue el progreso de Runestone Rush. Los detalles se pueden añadir más adelante.", TEXT_PARTY_TRACKER_PLACEHOLDER="Sigue el progreso de The Party Must Go On. Los detalles se pueden añadir más adelante.", TOOLTIP_ABUNDANT_HARVEST_CREDIT_REQUIREMENT="Debes completar un recorrido de cueva de Abundant Harvest en cada ubicación. No basta con visitar la cueva.",
TEXT_EXPLORE_EVERSONG_PROGRESS="Sigue el progreso de Explore Eversong Woods. x/y marcados.", TEXT_EXPLORE_HARANDAR_PROGRESS="Sigue el progreso de Explore Harandar. x/y marcados.", TEXT_EXPLORE_VOIDSTORM_PROGRESS="Sigue el progreso de Explore Voidstorm. x/y marcados.", TEXT_EXPLORE_ZULAMAN_PROGRESS="Sigue el progreso de Explore Zul'Aman. x/y marcados.",
}
