...
local L = {
    ...
    WARNING_WEEKLY_AMANI_CHOICE = "Warning! Once you choose an Amani Tribe quest, it's locked to your account.",
    WARNING_WEEKLY_HARATI_CHOICE = "Warning! Once you choose a Legends of the Haranir quest, it's locked to your account.",
    WARNING_WEEKLY_SINGULARITY_CHOICE = "Warning! Once you choose a The Singularity quest, it's locked to your account.",
    ...
    TITLE_RAID_PROGRESSION = "Raid Progression",
