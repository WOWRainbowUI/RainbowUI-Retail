...
local L = {
    ...
    TAB_META_ACHIEVEMENTS = "Meta Achievements",
    TEXT_FOLIO_NODE_FMT = "Node %d",
    TEXT_GEAR_TITLE_FMT = "%s's %s",
    LABEL_GEAR_CRIT = "Crit",
    LABEL_GEAR_HASTE = "Haste",
    LABEL_GEAR_MASTERY = "Mastery",
    LABEL_GEAR_VERS = "Vers",
    TEXT_GEAR_ILVL_COLORED_FMT = "iLvl |c%s%d|r",
    STATUS_LIVE = "[LIVE]",
    ...
    LABEL_WEEKLY_COMPLETION_SUMMARY = "%d / %d Complete",
...
L["TEXT_TRACKED_ACHIEVEMENT_ENTRIES_UNAVAILABLE_FMT"] = "Tracked entries for %s have not been added yet."
...
L.MSG_NO_FACTION_WEEKLY_COMPLETIONS = "No weekly completions tracked."
L.TOOLTIP_QUEST_ID_FMT = "ID: |cffffffff%d"
L.CALENDAR_MONTH_YEAR_FMT = "%s %d"
L.LABEL_RENOWN_LEVEL_MAXIMUM_FMT = "Renown Level %d - Maximum"
L.LABEL_RENOWN_LEVEL_PROGRESS_FMT = "Renown Level %d (%d/%d)"
L.LABEL_RENOWN_LEVEL_FMT = "Renown Level %d"
L.LABEL_RENOWN_VALUE_FMT = "Renown %d"
L.TEXT_CRESTS_WITH_VALUES_FMT = "Crests %s"
L.TOOLTIP_REWARDS_FMT = "Rewards: %s"
L.TOOLTIP_MOUNT_COLLECTED_FMT = "%s (Collected)"
L.TOOLTIP_MOUNT_UNCOLLECTED_FMT = "%s (Not Collected)"
L.LABEL_NOTE = "Note"
L.STATUS_ACTIVE = "Active"
L.BUTTON_BACK_TO_GROUPS = "Back to Groups"
L.TEXT_COORDINATE_GROUPS_NOT_AVAILABLE = "Coordinate groups have not been added yet."
L.TEXT_ZONE_REWARD_NOT_AVAILABLE = "Zone reward not added yet."
L.TEXT_META_REWARD_NOT_AVAILABLE = "Meta reward not added yet."
L.TEXT_ACHIEVEMENT_REWARD_NOT_LISTED = "No achievement reward listed."
L.TOOLTIP_RUNESTONE_CHARGE_INSTRUCTION = "Charge the runestone with Latent Arcana to start its defense event."
L.TEXT_COORDINATES_PENDING = "Coordinates pending."
L.TOOLTIP_CLICK_OPEN_TRACKER = "Click to open this tracker."
L.TEXT_TRACKER_NOT_AVAILABLE = "Tracker not added yet."
L.LABEL_ACHIEVEMENT_GROUPS = "Groups"
L.LABEL_GLOWING_MOTHS = "Moths"
L.LABEL_SHARED_LOOT = "Shared Loot"
L.LABEL_KNOWLEDGE_CATCHUP = "Catch-up"
L.STATUS_ASSAULT_WAVE_1_COMPLETE = "Wave 1 Complete"
L.STATUS_ASSAULT_WAVE_2_COMPLETE = "Wave 2 Complete"
L.STATUS_ASSAULT_WAVE_3_COMPLETE = "Wave 3 Complete"
L.TEXT_MIDNIGHT_RARES_TRACKER_DESCRIPTION = "Track Midnight rare achievements, rewards, and shared drops."
L.TEXT_MIDNIGHT_TREASURES_TRACKER_DESCRIPTION = "Track Midnight treasure achievements and their rewards."
L.TEXT_HARANIR_JOURNAL_INSTRUCTION = "Recover the Haranir journal entries listed below."
L.TEXT_HARANIR_LEGEND_DEFENSE_INSTRUCTION = "Defend each Haranir legend location listed below."
L.TEXT_BLESSING_EFFECT_INSTRUCTION = "Trigger each listed blessing effect for credit."
L.TOOLTIP_CAVE_RUN_CREDIT_INSTRUCTION = "Complete the cave run here for credit."
L.TEXT_TELESCOPE_ZONE_REQUIREMENT = "Complete the five telescopes in this zone."
L.TEXT_MIDNIGHT_DELVER_META_INSTRUCTION = "Complete all four supporting Midnight delver achievements to finish this meta achievement."
L.TEXT_COILED_ISLE_META_INSTRUCTION = "Complete the Coiled Isle achievements."
L.TEXT_MIDNIGHT_ZONE_META_REWARD_REQUIREMENT = "Complete the four Midnight zone meta-achievements and earn the mount reward."
L.TEXT_CLAW_ENFORCEMENT_REQUIREMENT = "Complete the Harandar world quest 'Claw Enforcement' while having 15 or more stacks of Predator's Pursuit."
L.TEXT_ATALUTEK_META_INSTRUCTION = "Complete the Vaults of Atal'Utek achievements."
L.TEXT_COILED_ISLE_LORE_INSTRUCTION = "Discover the lore objects of the Coiled Isle."
L.TEXT_HUNGERING_PRESENCE_REQUIREMENT = "Evade the Hungering Presence's grasp in Voidstorm for at least 60 seconds."
L.TEXT_CRADLE_FLIGHT_REQUIREMENT = "Fly into The Cradle high in the sky above Harandar to complete this achievement."
L.TEXT_EVERSONG_META_TRACKER_DESCRIPTION = "Track the Eversong Woods meta-achievement and jump into its child trackers."
L.TEXT_MIDNIGHT_PEAKS_TRACKER_DESCRIPTION = "Track the four zone achievements for Midnight, the Highest Peaks."
L.TEXT_HARANDAR_META_TRACKER_DESCRIPTION = "Track the Harandar meta-achievement and jump into its child trackers."
L.TEXT_VOIDSTORM_META_TRACKER_DESCRIPTION = "Track the Voidstorm meta-achievement and jump into its child trackers."
L.TEXT_ZULAMAN_META_TRACKER_DESCRIPTION = "Track the Zul'Aman meta-achievement and jump into its child trackers."
L.TEXT_CRADLE_FLIGHT_ATTEMPT = "Attempt to fly to The Cradle high in the sky above Harandar."
L.NOTE_MOTH_ROUTE_RENOWN_REQUIREMENT = "LiteVault routing assumes you already have Hara'ti Renown 11 unlocked."
L.TEXT_HARATI_META_PROGRESS_INSTRUCTION = "Aid the Hara'ti by completing the achievements below. x/y done."
L.TEXT_VOIDSTORM_META_PROGRESS_INSTRUCTION = "Complete all of the Voidstorm achievements listed below. x/y done."
L.TEXT_ZULAMAN_META_PROGRESS_INSTRUCTION = "Complete all of the Zul'Aman achievements listed below. x/y done."
L.TEXT_STORMARION_ASSAULT_PROGRESS_INSTRUCTION = "Complete all three waves of the Stormarion Assault. x/y marked."
L.TEXT_ABUNDANT_HARVEST_PROGRESS_INSTRUCTION = "Complete an Abundant Harvest cave run in each location. x/y marked."
L.TEXT_EVERSONG_META_PROGRESS_INSTRUCTION = "Complete the Eversong Woods achievements listed below. x/y done."
L.TEXT_GLOWING_MOTH_PROGRESS = "Find all of the Glowing Moths hiding in Harandar. x/y found."
L.TEXT_HARANIR_LEGEND_PROGRESS = "Protect each Haranir legend location listed below. x/y marked."
L.TEXT_XALATATH_META_PROGRESS = "Rally your forces against Xal'atath by completing the achievements below. x/y done."
L.TEXT_HARANIR_JOURNAL_PROGRESS = "Recover the Haranir journal entries listed below. x/y marked."
L.TEXT_BLESSING_EFFECT_PROGRESS = "Trigger each listed blessing effect. x/y marked."
L.TEXT_FACTION_INVITE_PROGRESS = "Track the four faction invites for The Party Must Go On. x/y marked."
L.TEXT_EVER_PAINTING_PROGRESS = "Track the known Ever-Painting canvases. x/y marked."
L.TEXT_RUNESTONE_RUSH_PROGRESS = "Track the known Runestone Rush entries. x/y marked."
L.TEXT_DELVER_MOUNT_REWARD_REQUIREMENT = "Complete Glory of the Midnight Delver to earn this mount."
L.NOTE_MOTH_GROUP_1_RENOWN = "Moths 1-40 appear at Hara'ti Renown 1, tracking at Renown 2."
L.NOTE_MOTH_GROUP_2_RENOWN = "Moths 41-80 appear at Hara'ti Renown 4, tracking at Renown 6."
L.NOTE_MOTH_GROUP_3_RENOWN = "Moths 81-120 appear at Hara'ti Renown 9, tracking at Renown 11."
L.NOTE_HARANIR_JOURNAL_AVAILABILITY = "These journals are only available during the account-bound weekly quest 'Legends of the Haranir'. While in a vision, look for the magnifying glass icon on your minimap."
L.NOTE_CLAW_ENFORCEMENT_NO_COORDINATES = "This achievement does not need coordinate tracking in LiteVault. Complete the Harandar world quest 'Claw Enforcement' while holding 15 or more stacks of Predator's Pursuit."
L.NOTE_HUNGERING_PRESENCE_NO_COORDINATES = "This achievement does not need coordinate tracking in LiteVault. Survive the Hungering Presence event in Voidstorm for at least 60 seconds."
L.NOTE_HARANIR_LEGENDS_WEEKLY_ESTIMATE = "This is tied to the account-bound weekly quest 'Legends of the Haranir'. If you have no progress yet, it is estimated to take about 7 weeks to complete."
L.NOTE_MOTH_TRACKER_GROUPING = "This tracker is split into 3 groups of 40 coordinates so the moth routes stay manageable."
L.TEXT_EVER_PAINTING_TRACKER_PLACEHOLDER = "Track Ever-Painting progress. Entry details can be filled in later."
L.TEXT_EXPLORE_EVERSONG_TRACKER_PLACEHOLDER = "Track Explore Eversong Woods progress. Entry details can be filled in later."
L.TEXT_RUNESTONE_RUSH_TRACKER_PLACEHOLDER = "Track Runestone Rush progress. Entry details can be filled in later."
L.TEXT_PARTY_TRACKER_PLACEHOLDER = "Track The Party Must Go On progress. Entry details can be filled in later."
L.TOOLTIP_ABUNDANT_HARVEST_CREDIT_REQUIREMENT = "You need to complete an Abundant Harvest cave run in each location for credit. Just visiting the cave is not enough."
L.TEXT_EXPLORE_EVERSONG_PROGRESS = "Track Explore Eversong Woods progress. x/y marked."
L.TEXT_EXPLORE_HARANDAR_PROGRESS = "Track Explore Harandar progress. x/y marked."
L.TEXT_EXPLORE_VOIDSTORM_PROGRESS = "Track Explore Voidstorm progress. x/y marked."
L.TEXT_EXPLORE_ZULAMAN_PROGRESS = "Track Explore Zul'Aman progress. x/y marked."
L.TOOLTIP_ENTRANCE_COORDINATES_FMT = "Entrance: %.2f, %.2f (map %d)"
L.TOOLTIP_INSCRIPTION_COORDINATES_FMT = "Inscription: %.2f, %.2f (map %d)"
L.TOOLTIP_ENTRANCE_INSCRIPTION_CLICK_INSTRUCTIONS = "Shift-click for entrance; click for inscription."
L.LABEL_100_RENOWN_FMT = "100 Renown: %s"
L.TOOLTIP_ACHIEVEMENT_CREDIT_FROM_FMT = "Achievement credit from: %s"
L.NOTE_HARANDAR_TREASURE_REQUIREMENTS = "Some treasures require extra steps or items to open."
L.NOTE_FORGOTTEN_MASK_LOCATION = "On a broken stone wall on Gnarldor Isle, south of the delve entrance."
L.NOTE_HEAD_MASONS_TABLET_LOCATION = "Inside the Gate of the Eastern Fang. Entrance: 45.72, 64.94 on map 2512."
L.NOTE_PROFANED_PLAQUE_LOCATION = "Inside the Gate of the Western Fang, in the room immediately left after entering. Entrance: 31.80, 64.91 on map 2512."
