...
["Surplus Bag of Party Favors"] = "多出的一袋派對小禮物",
    ...
    ["This achievement does not need coordinate tracking in LiteVault. Survive the Hungering Presence event in Voidstorm for at least 60 seconds."] = "這個成就不需要在 LiteVault 中追蹤座標。在虛無風暴中撐過飢渴存在事件至少 60 秒。",
    ...
    ["This achievement does not need coordinate tracking in LiteVault. Complete the Harandar world quest 'Claw Enforcement' while holding 15 or more stacks of Predator's Pursuit."] = "這個成就不需要在 LiteVault 中追蹤座標。在擁有 15 層或以上「掠食者追擊」時完成哈朗達世界任務「捕獵者追擊」。",
    ...
    ["LiteVault routing assumes you already have Hara'ti Renown 11 unlocked."] = "LiteVault 路線預設你已經解鎖哈拉提聲望 11。",
