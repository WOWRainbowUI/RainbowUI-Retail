...
local L = {
    ...
    ["Twilight's Blade Insignia"] = "暮刃徽記",
    ["Voidlight Marl"] = "虛光泥灰",
    ...
    ["Hidey-Hole"] = "藏身處",
    ["Victorious Stormarion Pinnacle Cache"] = "凱旋的風暴阿瑞恩之巔寶匣",
...
["Surplus Bag of Party Favors"] = "多出的一袋派對小禮物",
    ...
    ["Valorstones"] = "英勇石",
    ["Weathered Ethereal Crest"] = "風化虛無紋章",
    ["Carved Ethereal Crest"] = "雕琢虛無紋章",
    ["Runed Ethereal Crest"] = "符刻虛無紋章",
    ["Gilded Ethereal Crest"] = "鍍金虛無紋章",
    ...
    ["Theater Troupe"] = "劇場巡演",
    ["Awakening Machine"] = "覺醒機器",
    ["Seeking History"] = "追尋歷史",
    ["Worldwide Research"] = "全球研究",
    ["Urge to Surge"] = "激湧衝動",
    ["Spreading Light"] = "散播聖光",
    -- Midnight Weekly Quests
    ["Community Engagement"] = "社群參與",
    WARNING_ACCOUNT_BOUND = "帳號綁定",
    ["Midnight: Prey"] = "午夜：獵物",
    ["Saltheril's Soiree"] = "薩瑟里爾晚宴",
    ["Abundance Event"] = "豐饒活動",
    ["Legends of the Haranir"] = "哈拉尼爾傳說",
    ["Stormarion Assault"] = "風暴亞里昂突襲",
    ["Darkness Unmade"] = "破滅黑暗",
    ["Harvesting the Void"] = "收割虛無",
    ["Midnight: Saltheril's Soiree"] = "午夜：薩瑟里爾晚宴",
    ["Fortify the Runestones: Blood Knights"] = "強化符文石：血騎士",
    ["Fortify the Runestones: Shades of the Row"] = "強化符文石：街巷魅影",
    ["Fortify the Runestones: Magisters"] = "強化符文石：博學者",
    ["Fortify the Runestones: Farstriders"] = "強化符文石：遠行者",
    ...
    ["Treasures of Midnight"] = "午夜寶藏",
    ["Track the four Midnight treasure achievements and their rewards."] = "追蹤午夜的四個寶藏成就與其獎勵。",
    ["Glory of the Midnight Delver"] = "午夜探究者的榮耀",
    ["Complete Glory of the Midnight Delver to earn this mount."] = "完成「午夜探究者的榮耀」以獲得這隻坐騎。",
    ["Track the four Midnight rare achievements and zone rare rewards."] = "追蹤午夜的四個稀有成就與區域稀有獎勵。",
    ["Track the four Midnight rare achievements."] = "追蹤午夜的四個稀有成就。",
    ["Complete the five telescopes in this zone."] = "完成此區域的五個望遠鏡。",
    ["Complete all four supporting Midnight delver achievements to finish this meta achievement."] = "完成全部四個午夜探究者支援成就，以完成這個綜合成就。",
    ...
    ["Charge the runestone with Latent Arcana to start its defense event."] = "使用潛伏祕法為符文石充能，以啟動它的防禦事件。",
    ["Achievement credit from:"] = "成就進度來源：",
    ["Stormarion Assault"] = "風暴艾里昂突襲",
    ["Ever-Painting"] = "永恆繪景",
    ...
    ["Runestone Rush"] = "符文石衝刺",
    ["Track the known Runestone Rush entries. x/y marked."] = "追蹤已知的 Runestone Rush 條目。x/y 已標記。",
    ["Tracked entries for Runestone Rush have not been added yet."] = "尚未加入 Runestone Rush 的追蹤條目。",
    ["The Party Must Go On"] = "派對必須繼續",
    ["Track the four faction invites for The Party Must Go On. x/y marked."] = "追蹤「派對必須繼續」的四個陣營邀請。x/y 已標記。",
    ["Tracked entries for The Party Must Go On have not been added yet."] = "尚未加入「派對必須繼續」的追蹤條目。",
    ["Explore trackers"] = "探索追蹤器",
    ["Track Explore Eversong Woods progress. x/y marked."] = "追蹤 Explore Eversong Woods 的進度。x/y 已標記。",
    ["Tracked entries for Explore Eversong Woods have not been added yet."] = "尚未加入 Explore Eversong Woods 的追蹤條目。",
    ["Track Explore Voidstorm progress. x/y marked."] = "追蹤 Explore Voidstorm 的進度。x/y 已標記。",
    ["Tracked entries for Explore Voidstorm have not been added yet."] = "尚未加入 Explore Voidstorm 的追蹤條目。",
    ["Track Explore Zul'Aman progress. x/y marked."] = "追蹤 Explore Zul'Aman 的進度。x/y 已標記。",
    ["Tracked entries for Explore Zul'Aman have not been added yet."] = "尚未加入 Explore Zul'Aman 的追蹤條目。",
    ["Track Explore Harandar progress. x/y marked."] = "追蹤 Explore Harandar 的進度。x/y 已標記。",
    ["Tracked entries for Explore Harandar have not been added yet."] = "尚未加入 Explore Harandar 的追蹤條目。",
    ["Thrill of the Chase"] = "追逐的刺激",
    ["Evade the Hungering Presence's grasp in Voidstorm for at least 60 seconds."] = "在 Voidstorm 中躲避飢渴存在的追捕至少 60 秒。",
    ["This achievement does not need coordinate tracking in LiteVault. Survive the Hungering Presence event in Voidstorm for at least 60 seconds."] = "這個成就不需要在 LiteVault 中追蹤座標。在 Voidstorm 中撐過飢渴存在事件至少 60 秒。",
    ["Tracked entries for Thrill of the Chase have not been added yet."] = "尚未加入「追逐的刺激」的追蹤條目。",
    ["No Time to Paws"] = "沒時間磨爪",
    ["Complete the Harandar world quest 'Claw Enforcement' while having 15 or more stacks of Predator's Pursuit."] = "在擁有 15 層或以上「掠食者追擊」時完成 Harandar 世界任務「利爪執法」。",
    ["This achievement does not need coordinate tracking in LiteVault. Complete the Harandar world quest 'Claw Enforcement' while holding 15 or more stacks of Predator's Pursuit."] = "這個成就不需要在 LiteVault 中追蹤座標。在擁有 15 層或以上「掠食者追擊」時完成 Harandar 世界任務「利爪執法」。",
    ["Tracked entries for No Time to Paws have not been added yet."] = "尚未加入「沒時間磨爪」的追蹤條目。",
    ["From The Cradle to the Grave"] = "從搖籃到墳墓",
    ["Attempt to fly to The Cradle high in the sky above Harandar."] = "嘗試飛往 Harandar 上空高處的 The Cradle。",
    ["Fly into The Cradle high in the sky above Harandar to complete this achievement."] = "飛入 Harandar 上空高處的 The Cradle 以完成這個成就。",
    ["Chronicler of the Haranir"] = "哈拉尼爾編年史家",
    ...
    ["Dust 'Em Off"] = "把牠們拍乾淨",
    ["Find all of the Glowing Moths hiding in Harandar. x/y found."] = "找出所有藏在 Harandar 的發光飛蛾。x/y 已找到。",
    ...
    ["Moths 1-40 appear at Hara'ti Renown 1, tracking at Renown 2."] = "飛蛾 1-40 會在 Hara'ti 聲望 1 出現，並於聲望 2 可追蹤。",
    ["Moths 41-80 appear at Hara'ti Renown 4, tracking at Renown 6."] = "飛蛾 41-80 會在 Hara'ti 聲望 4 出現，並於聲望 6 可追蹤。",
    ["Moths 81-120 appear at Hara'ti Renown 9, tracking at Renown 11."] = "飛蛾 81-120 會在 Hara'ti 聲望 9 出現，並於聲望 11 可追蹤。",
    ["LiteVault routing assumes you already have Hara'ti Renown 11 unlocked."] = "LiteVault 路線預設你已經解鎖 Hara'ti 聲望 11。",
    ["%s contains %d moth coordinates. Click a moth to place a waypoint."] = "%s 包含 %d 個飛蛾座標。點擊飛蛾以放置路徑點。",
    ["Group 1"] = "第 1 組",
    ["Group 2"] = "第 2 組",
    ["Group 3"] = "第 3 組",
    ["Moths"] = "飛蛾",
    ["A Singular Problem"] = "一個奇點問題",
    ["Complete all three waves of the Stormarion Assault. x/y marked."] = "完成 Stormarion Assault 的三波攻勢。x/y 已標記。",
    ["Tracked entries for A Singular Problem have not been added yet."] = "尚未加入「一個奇點問題」的追蹤條目。",
    ["Abundance: Prosperous Plentitude!"] = "豐饒：繁盛滿盈！",
    ["Complete an Abundant Harvest cave run in each location. x/y marked."] = "在每個地點完成一次豐饒收穫洞穴流程。x/y 已標記。",
    ["You need to complete an Abundant Harvest cave run in each location for credit. Just visiting the cave is not enough."] = "你必須在每個地點完成一次豐饒收穫洞穴流程才能獲得進度。只拜訪洞穴是不夠的。",
    ["Tracked entries for Abundance: Prosperous Plentitude! have not been added yet."] = "尚未加入「豐饒：繁盛滿盈！」的追蹤條目。",
    ...
    ["Complete all of the Voidstorm achievements listed below. x/y done."] = "完成下方列出的所有 Voidstorm 成就。x/y 已完成。",
    ["Complete all of the Zul'Aman achievements listed below. x/y done."] = "完成下方列出的所有 Zul'Aman 成就。x/y 已完成。",
    ["Aid the Hara'ti by completing the achievements below. x/y done."] = "透過完成下方成就來協助 Hara'ti。x/y 已完成。",
    ["Rally your forces against Xal'atath by completing the achievements below. x/y done."] = "透過完成下方成就來集結你的力量對抗 Xal'atath。x/y 已完成。",
    ["Tracked entries for Making an Amani Out of You have not been added yet."] = "尚未加入 Making an Amani Out of You 的追蹤條目。",
    ["Tracked entries for That's Aln, Folks! have not been added yet."] = "尚未加入 That's Aln, Folks! 的追蹤條目。",
    ["Tracked entries for Forever Song have not been added yet."] = "尚未加入 Forever Song 的追蹤條目。",
    ["Tracked entries for Yelling into the Voidstorm have not been added yet."] = "尚未加入 Yelling into the Voidstorm 的追蹤條目。",
    ["Tracked entries for Light Up the Night have not been added yet."] = "尚未加入 Light Up the Night 的追蹤條目。",
    ["Mount: Brilliant Petalwing"] = "坐騎：璀璨花翼",
    ["Housing Decor: On'ohia's Call"] = "家園裝飾：On'ohia 的呼喚",
    ["Title: \"Dustlord\""] = "頭銜：「塵領主」",
    ["Title: \"Chronicler of the Haranir\""] = "頭銜：「哈拉尼爾編年史家」",
    ["home reward labels:"] = "家園獎勵標籤：",
}

L["Raid resync unavailable."] = "團隊副本重新同步無法使用。"
L["Time played messages will be suppressed."] = "遊玩時間訊息將被隱藏。"
L["Time played messages restored."] = "遊玩時間訊息已恢復。"
L["%dm %02ds"] = "%d分%02d秒"
L["Crests:"] = "紋章："
L["Mount Drops"] = "坐騎掉落"
L["(Collected)"] = "（已收藏）"
