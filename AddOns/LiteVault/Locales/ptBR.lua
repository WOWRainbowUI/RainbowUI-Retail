...
local L = {
    ...
    TAB_META_ACHIEVEMENTS = "Meta-conquistas",
    TEXT_FOLIO_NODE_FMT = "Nó %d",
    TEXT_GEAR_TITLE_FMT = "%s — %s",
    LABEL_GEAR_CRIT = "Crítico",
    LABEL_GEAR_HASTE = "Aceleração",
    LABEL_GEAR_MASTERY = "Maestria",
    LABEL_GEAR_VERS = "Versatilidade",
    TEXT_GEAR_ILVL_COLORED_FMT = "Nível do item |c%s%d|r",
    STATUS_LIVE = "[AO VIVO]",
    STATUS_CACHED = "[EM CACHE]",
    STATUS_STALE = "[DESATUALIZADO]",
    ...
    LABEL_WEEKLY_COMPLETION_SUMMARY = "%d / %d concluídas",
    ...
    TOOLTIP_VOIDSHARDS_TITLE = "Fragmentos do Caos Ascendentes",
    TOOLTIP_VOIDCORES_TITLE = "Núcleos do Caos Ascendentes",
...
L["LABEL_HISTORY_COUNT"] = "Quantidade no histórico"
...
L["LABEL_TOKEN_AFFORDABLE"] = "Acessível"
L["LABEL_TOKEN_DELTA"] = "Diferença"
...
L["TEXT_PROFIT_FALLBACK_WOW_TOKEN_PURCHASE"] = "Compra de Ficha de WoW"
L["TEXT_PROFIT_ITEM_FALLBACK_FMT"] = "Item %d"
L["TEXT_PROFIT_GOALS_SUBTITLE"] = "Metas semanais e mensais de lucro líquido para o seu Bando de Guerra."
L["TEXT_PROFIT_GOAL_EDITOR_HINT"] = "Insira uma meta em ouro. Deixe em branco ou digite 0 para removê-la."
...
L["TEXT_PROFIT_GRAPH_PENDING_MONTHLY"] = "O histórico do gráfico mensal agora está sendo acompanhado e será preenchido conforme você ganhar ou gastar ouro."
L["TEXT_PROFIT_GRAPH_PENDING_WARBAND_MONTHLY"] = "O histórico mensal do Bando de Guerra agora está sendo acompanhado e será preenchido conforme as alterações de ouro forem registradas."
...
L["TEXT_PROFIT_MONTHLY_GRAPH_SUBTITLE"] = "Lucro líquido diário do personagem atual neste mês. Novos dados aparecerão conforme as alterações de ouro forem registradas."
L["TEXT_PROFIT_MONTHLY_LEDGER_SUBTITLE"] = "Transações mensais recentes do personagem atual."
L["TEXT_PROFIT_SUBTITLE"] = "Weekly and monthly profit across your tracked characters."
L["TEXT_PROFIT_WARBAND_GRAPH_SUBTITLE"] = "Lucro diário combinado dos personagens acompanhados nos últimos 7 dias."
L["TEXT_PROFIT_WARBAND_LEDGER_WEEKLY_SUBTITLE"] = "Transações semanais combinadas recentes dos personagens acompanhados."
L["TEXT_PROFIT_WARBAND_MONTHLY_GRAPH_SUBTITLE"] = "Lucro diário combinado dos personagens acompanhados neste mês."
L["TEXT_PROFIT_SOURCE_AH_FEE"] = "Taxa da Casa de Leilões"
...
L["TEXT_PROFIT_WEEKLY_GRAPH_SUBTITLE"] = "Lucro líquido diário do personagem atual nos últimos 7 dias."
L["TEXT_PROFIT_WEEKLY_LEDGER_SUBTITLE"] = "Transações semanais recentes do personagem atual."
L["TEXT_TRACKED_ACHIEVEMENT_ENTRIES_UNAVAILABLE_FMT"] = "Ainda não foram adicionadas entradas acompanhadas para %s."
L["TIME_DAYS_AGO_FMT"] = "há %d d"
L["TIME_HOURS_AGO_FMT"] = "há %d h"
L["TIME_JUST_NOW"] = "Just now"
L["TIME_MINUTES_AGO_FMT"] = "há %d min"
...
L["TEXT_PROFIT_TOKENS_THIS_MONTH_FMT"] = "Fichas neste mês: %d"
L["TITLE_PROFIT_WOW_TOKENS_THIS_MONTH"] = "Fichas de WoW neste mês"
L["TITLE_WOW_TOKEN_HISTORY"] = "WoW Token History"
L["TOOLTIP_PROFIT_WOW_TOKENS_THIS_MONTH"] = "Conta as Fichas de WoW compradas durante o mês atual. As compras de fichas são excluídas dos lucros totais."
...
L["Discover all of the lore objects found on the Coiled Isle."] = "Descubra todos os objetos de história de Coiled Isle."
L["%s contains %d moth coordinates. Click a moth to place a waypoint."] = "%s contém %d coordenadas de mariposas. Clique em uma mariposa para colocar um ponto de referência."
...
L["LABEL_MAX_RENOWN"] = "Renome máximo"
L["TOOLTIP_FACTION_CARD_HINT"] = "Click to switch this faction."
L["TEXT_PROFIT_WARBAND_BREAKDOWN_SUBTITLE"] = "Distribuição das fontes de renda e gastos semanais do seu Bando de Guerra."
L["MSG_NO_GOLD_WORLD_QUESTS"] = "No active gold world quests found."
L["LEDGER_WORLD_QUESTS"] = "World Quests"
L["OPTION_DISABLE_RUNESTONE_MAP_PINS"] = "Desativar marcadores de Pedras Rúnicas"
L["OPTION_DISABLE_RUNESTONE_MAP_PINS_DESC"] = "Oculta os marcadores de Pedras Rúnicas do LiteVault no mapa da Floresta do Canto Eterno."
L["OPTION_ENABLE_CALENDAR_PROFIT_HIGHLIGHTS"] = "Ativar destaques de lucro no calendário"
...
L["LABEL_FIRST_KILL"] = "Primeira vitória:"
L["LABEL_EARLIEST_RECORDED_KILL"] = "Primeira vitória registrada:"
L["TEXT_HISTORICAL_DATA_UNAVAILABLE"] = "Dados históricos indisponíveis"
L["LABEL_KNOWN_KILLS"] = "Vitórias conhecidas:"
L["LABEL_ALSO_KILLED_BY"] = "Também derrotado por:"
L["TEXT_KILL_DATE_UNAVAILABLE"] = "Data da vitória indisponível"

L["BUTTON_ZULJARRA_FORCES"] = "Zul'jarra's Forces"
L["BUTTON_CAPTAIN_TOKKA"] = "Capitã Tokka"
...
L["LABEL_QUEST_FMT"] = "Missão: %s"
L["LABEL_QUEST_ID_FMT"] = "ID da missão: %d"
...
L.LABEL_CURRENT_CHARACTER = L.LABEL_CURRENT_CHARACTER or "Personagem atual"
L.LABEL_WARBAND_THIS_WEEK = L.LABEL_WARBAND_THIS_WEEK or "Bando nesta semana"
L.LABEL_RUNS = L.LABEL_RUNS or "Corridas"
L.STATUS_TIMED = L.STATUS_TIMED or "No tempo"
L.STATUS_DEPLETED = L.STATUS_DEPLETED or "Esgotada"
L.LABEL_BEST_TIMED = L.LABEL_BEST_TIMED or "Melhor no tempo"
L.FILTER_THIS_WEEK = L.FILTER_THIS_WEEK or "Nesta semana"
L.FILTER_SEASON = L.FILTER_SEASON or "Temporada"
L.FILTER_ALL_HISTORY = L.FILTER_ALL_HISTORY or "Todo o histórico"
L.SECTION_SEASON_BESTS = L.SECTION_SEASON_BESTS or "Melhores da temporada"
L.LABEL_BEST = L.LABEL_BEST or "Melhor"
L.LABEL_SCORE = L.LABEL_SCORE or "Pontuação"
L.LABEL_NO_RUN = L.LABEL_NO_RUN or "Sem corrida"
L.LABEL_LOWEST_SCORE = L.LABEL_LOWEST_SCORE or "Menor pontuação"
L.LABEL_NO_MPLUS_KEY = L.LABEL_NO_MPLUS_KEY or "Sem chave M+"
L.LABEL_DUNGEON = L.LABEL_DUNGEON or "Masmorra"
L.LABEL_KEY = L.LABEL_KEY or "Chave"
L.LABEL_RESULT = L.LABEL_RESULT or "Resultado"
L.LABEL_TIME = L.LABEL_TIME or "Tempo"
L.LABEL_DATE = L.LABEL_DATE or "Data"
L.LABEL_REWARDS = L.LABEL_REWARDS or "Recompensas"
L.LABEL_MAP_RECORD = L.LABEL_MAP_RECORD or "Recorde do mapa"
L.LABEL_AFFIX_RECORD = L.LABEL_AFFIX_RECORD or "Recorde de afixos"
L.LABEL_MPLUS_SCORE_PLAIN = L.LABEL_MPLUS_SCORE_PLAIN or "Pontuação M+"
L.LABEL_TIMER = L.LABEL_TIMER or "Cronômetro"
L.LABEL_TIME_REMAINING = L.LABEL_TIME_REMAINING or "Tempo restante"
L.LABEL_OVER_TIMER = L.LABEL_OVER_TIMER or "Acima do tempo"
L.LABEL_RECORDED_DURATION = L.LABEL_RECORDED_DURATION or "Duração registrada"
L.LABEL_NOT_AVAILABLE = L.LABEL_NOT_AVAILABLE or "--"
L.SECTION_MPLUS_HISTORY = L.SECTION_MPLUS_HISTORY or "Histórico de Mítica+"
L.TEXT_NO_MPLUS_RUNS_THIS_WEEK = L.TEXT_NO_MPLUS_RUNS_THIS_WEEK or "Nenhuma Mítica+ concluída nesta semana."
L.TEXT_NO_MPLUS_RUNS_THIS_SEASON = L.TEXT_NO_MPLUS_RUNS_THIS_SEASON or "Nenhuma Mítica+ concluída nesta temporada."
L.TEXT_NO_MPLUS_RUNS_RECORDED = L.TEXT_NO_MPLUS_RUNS_RECORDED or "Nenhuma Mítica+ registrada."
L.BUTTON_PLAN_RATING = L.BUTTON_PLAN_RATING or "Planejar pontuação"
L.TITLE_MPLUS_RATING_PLANNER = L.TITLE_MPLUS_RATING_PLANNER or "Planejador de pontuação M+"
L.BUTTON_BACK_TO_DASHBOARD = L.BUTTON_BACK_TO_DASHBOARD or "Voltar ao painel"
L.LABEL_CURRENT_RATING = L.LABEL_CURRENT_RATING or "Pontuação atual"
L.LABEL_TARGET_RATING = L.LABEL_TARGET_RATING or "Pontuação alvo"
L.LABEL_MINIMUM_KEY = L.LABEL_MINIMUM_KEY or "Chave mínima"
L.LABEL_MAXIMUM_KEY = L.LABEL_MAXIMUM_KEY or "Chave máxima"
L.LABEL_AVOID_DUNGEONS = L.LABEL_AVOID_DUNGEONS or "Evitar masmorras"
L.BUTTON_CALCULATE_PLAN = L.BUTTON_CALCULATE_PLAN or "Calcular plano"
L.LABEL_MAXIMUM_PROJECTED_RATING = L.LABEL_MAXIMUM_PROJECTED_RATING or "Pontuação máxima projetada"
L.LABEL_PROJECTED_RATING = L.LABEL_PROJECTED_RATING or "Pontuação projetada"
L.LABEL_CURRENT = L.LABEL_CURRENT or "Atual"
L.LABEL_PLAN = L.LABEL_PLAN or "Plano"
L.LABEL_GAIN = L.LABEL_GAIN or "Ganho"
L.TEXT_PLANNER_ALREADY_REACHED = L.TEXT_PLANNER_ALREADY_REACHED or "Você já alcançou esta pontuação."
L.TEXT_PLANNER_UNREACHABLE = L.TEXT_PLANNER_UNREACHABLE or "O alvo não pode ser alcançado com os limites atuais."
L.TEXT_PLANNER_INVALID_MINIMUM = L.TEXT_PLANNER_INVALID_MINIMUM or "A chave mínima deve ser um inteiro igual ou maior que 2."
L.TEXT_PLANNER_INVALID_MAXIMUM = L.TEXT_PLANNER_INVALID_MAXIMUM or "A chave máxima deve ser no mínimo a chave mínima e no máximo 20."
L.TEXT_PLANNER_INVALID_TARGET = L.TEXT_PLANNER_INVALID_TARGET or "Insira uma pontuação alvo inteira válida."
L.TEXT_PLANNER_TIMED_ASSUMPTION = L.TEXT_PLANNER_TIMED_ASSUMPTION or "A projeção pressupõe que cada chave sugerida seja concluída no tempo."
L.PLANNER_FASTEST = L.PLANNER_FASTEST or "MAIS RÁPIDO"
L.PLANNER_BALANCED = L.PLANNER_BALANCED or "EQUILIBRADO"
L.PLANNER_EASIEST = L.PLANNER_EASIEST or "MAIS FÁCIL"
local phase2 = {
MSG_NO_FACTION_WEEKLY_COMPLETIONS="Nenhuma conclusão semanal registrada.", TOOLTIP_QUEST_ID_FMT="ID: |cffffffff%d", CALENDAR_MONTH_YEAR_FMT="%s de %d",
LABEL_RENOWN_LEVEL_MAXIMUM_FMT="Nível de Renome %d - Máximo", LABEL_RENOWN_LEVEL_PROGRESS_FMT="Nível de Renome %d (%d/%d)", LABEL_RENOWN_LEVEL_FMT="Nível de Renome %d", LABEL_RENOWN_VALUE_FMT="Renome %d",
TEXT_CRESTS_WITH_VALUES_FMT="Brasões %s", TOOLTIP_REWARDS_FMT="Recompensas: %s", TOOLTIP_MOUNT_COLLECTED_FMT="%s (Coletada)", TOOLTIP_MOUNT_UNCOLLECTED_FMT="%s (Não coletada)", LABEL_REWARD="Recompensa", LABEL_NOTE="Observação", STATUS_ACTIVE="Ativo",
TOOLTIP_ENTRANCE_COORDINATES_FMT="Entrada: %.2f, %.2f (mapa %d)", TOOLTIP_INSCRIPTION_COORDINATES_FMT="Inscrição: %.2f, %.2f (mapa %d)", TOOLTIP_ENTRANCE_INSCRIPTION_CLICK_INSTRUCTIONS="Shift-clique para a entrada; clique para a inscrição.", LABEL_100_RENOWN_FMT="100 de Renome: %s", TOOLTIP_ACHIEVEMENT_CREDIT_FROM_FMT="Crédito da conquista concedido por: %s",
NOTE_HARANDAR_TREASURE_REQUIREMENTS="Alguns tesouros exigem etapas ou itens adicionais para serem abertos.", NOTE_FORGOTTEN_MASK_LOCATION="Em uma parede de pedra quebrada na Ilha Gnarldor, ao sul da entrada da imersão.", NOTE_HEAD_MASONS_TABLET_LOCATION="Dentro do Portão da Presa Oriental. Entrada: 45.72, 64.94 no mapa 2512.", NOTE_PROFANED_PLAQUE_LOCATION="Dentro do Portão da Presa Ocidental, na sala imediatamente à esquerda após entrar. Entrada: 31.80, 64.91 no mapa 2512.",
BUTTON_CANCEL="Cancelar", BUTTON_SAVE="Salvar", BUTTON_SELECT_ALL="Selecionar tudo", LABEL_COMPLETED="Concluído", LABEL_NOT_COMPLETED="Não concluído", LABEL_DETAILS="Detalhes", LABEL_DETAIL="Detalhe", LABEL_INFO="Informações", LABEL_MAXIMUM="Máximo", LABEL_PREVIOUS="Anterior", LABEL_RECENT_HISTORY="Histórico recente", LABEL_SOURCE="Origem", LABEL_STATUS="Status", TIME_JUST_NOW="Agora mesmo", TIME_YESTERDAY="Ontem",
BUTTON_BACK_TO_GROUPS="Voltar aos grupos", TEXT_COORDINATE_GROUPS_NOT_AVAILABLE="Os grupos de coordenadas ainda não foram adicionados.", TEXT_ZONE_REWARD_NOT_AVAILABLE="A recompensa da zona ainda não foi adicionada.", TEXT_META_REWARD_NOT_AVAILABLE="A recompensa da meta-conquista ainda não foi adicionada.", TEXT_ACHIEVEMENT_REWARD_NOT_LISTED="Nenhuma recompensa de conquista informada.", TOOLTIP_RUNESTONE_CHARGE_INSTRUCTION="Carregue a pedra rúnica com Arcano Latente para iniciar o evento de defesa.", TEXT_COORDINATES_PENDING="Coordenadas pendentes.", TOOLTIP_CLICK_OPEN_TRACKER="Clique para abrir este rastreador.", TEXT_TRACKER_NOT_AVAILABLE="Rastreador ainda não adicionado.",
MSG_PROFIT_GOAL_INVALID="Insira uma quantidade válida de ouro.", MSG_PROFIT_GOAL_NOT_SET="Nenhuma meta definida", TEXT_PROFIT_EXPORT_HINT="Clique na caixa e pressione Ctrl+C para copiar.", TEXT_PROFIT_EXPORT_SUBTITLE="Copie o texto CSV abaixo.", TEXT_PROFIT_SOURCE_BLACK_MARKET="Mercado Negro", TEXT_PROFIT_SOURCE_CHEST="Baú", TEXT_PROFIT_SOURCE_CRAFT="Criação", TEXT_PROFIT_SOURCE_FLIGHT_PATH="Rota de voo", TEXT_PROFIT_SOURCE_GUILD_BANK="Banco da guilda", TEXT_PROFIT_SOURCE_LOOTED="Saqueado", TEXT_PROFIT_SOURCE_REPAIR="Reparo", TEXT_PROFIT_SOURCE_TRAINING="Treinamento", TEXT_PROFIT_SOURCE_WORLD_QUEST="Missão mundial", MSG_RAID_RESYNC_COMPLETE="Ressincronização de raide concluída.", MSG_RAID_RESYNC_STARTED="Ressincronização de raide iniciada...", MSG_RAID_RESYNC_UNAVAILABLE="Ressincronização de raide indisponível.",
TEXT_PROFIT_FALLBACK_APPEARANCE_COST="Custo de aparência", TEXT_PROFIT_FALLBACK_AUCTION_DEPOSIT="Depósito de leilão", TEXT_PROFIT_FALLBACK_AUCTION_FEE="Taxa de leilão", TEXT_PROFIT_FALLBACK_AUCTION_PURCHASE="Compra em leilão", TEXT_PROFIT_FALLBACK_AUCTION_SALE="Venda em leilão", TEXT_PROFIT_FALLBACK_BARBER_COST="Custo de barbearia", TEXT_PROFIT_FALLBACK_BLACK_MARKET_PURCHASE="Compra no Mercado Negro", TEXT_PROFIT_FALLBACK_CRAFTING_ORDER="Ordem de serviço", TEXT_PROFIT_FALLBACK_GEAR_UPGRADE="Aprimoramento de equipamento", TEXT_PROFIT_FALLBACK_GOLD_RECEIVED="Ouro recebido", TEXT_PROFIT_FALLBACK_GOLD_REWARD="Recompensa em ouro", TEXT_PROFIT_FALLBACK_GOLD_SENT="Ouro enviado", TEXT_PROFIT_FALLBACK_GUILD_DEPOSIT="Depósito da guilda", TEXT_PROFIT_FALLBACK_GUILD_WITHDRAWAL="Saque da guilda", TEXT_PROFIT_FALLBACK_RAW_GOLD="Ouro direto", TEXT_PROFIT_FALLBACK_SERVICE_COST="Custo de serviço", TEXT_PROFIT_FALLBACK_TRADE_GAIN="Ganho de troca", TEXT_PROFIT_FALLBACK_TRADE_PAYMENT="Pagamento de troca", TEXT_PROFIT_FALLBACK_TRAINING_COST="Custo de treinamento", TEXT_PROFIT_FALLBACK_TRAVEL_COST="Custo de viagem", TEXT_PROFIT_GRAPH_EMPTY_MONTHLY="Ainda não há histórico mensal de lucro.", TEXT_PROFIT_GRAPH_EMPTY_WARBAND="Ainda não há histórico de lucro do Bando de Guerra.", TEXT_PROFIT_GRAPH_EMPTY_WARBAND_MONTHLY="Ainda não há histórico mensal de lucro do Bando de Guerra.", TEXT_PROFIT_GRAPH_EMPTY_WEEKLY="Ainda não há histórico semanal de lucro.", TEXT_PROFIT_LEDGER_EMPTY_MONTHLY="Ainda não há transações mensais registradas.", TEXT_PROFIT_LEDGER_EMPTY_WARBAND="Ainda não há transações do Bando de Guerra registradas.", TEXT_PROFIT_LEDGER_EMPTY_WEEKLY="Ainda não há transações semanais registradas.", TEXT_PROFIT_SUBTITLE="Lucro semanal e mensal dos seus personagens rastreados.",
BUTTON_BREAKDOWN="Detalhamento", BUTTON_FILTER="Filtrar", BUTTON_SET="Definir", BUTTON_RAIDS="Raides", BUTTON_WARBAND_BANK_HISTORY="Histórico do banco do Bando de Guerra", TITLE_TREASURES_OF_THE_DAMNED="Tesouros dos Condenados", TOOLTIP_TOKKA_TREASURE_HINT="Pesque este artefato em Coiled Isle e devolva-o a Second Mate Sluggs em Tokka's Folly.", WARNING_TOKKA_ONE_TIME_ARTIFACTS="Aviso: estas missões de artefato são entregas únicas do Bando de Guerra. Elas não reiniciam diária nem semanalmente e só concedem reputação uma vez.", MSG_RAID_HISTORY_PRESERVED="O histórico de raides foi preservado; a redefinição destrutiva da temporada está desativada.", TOOLTIP_RAID_BOSS_DIFFICULTY_FMT="%s — %s", TITLE_MINI_OMNIUM_FOLIO="Fólio de Omnium", TOOLTIP_HIDE_MINI_FOLIO="Ocultar Mini Fólio", TOOLTIP_LOCK_MINI_FOLIO="Bloquear Mini Fólio", TOOLTIP_UNLOCK_MINI_FOLIO="Desbloquear Mini Fólio", TAB_GLYPHS="Glifos", TITLE_GLYPH_HUNTER="Caçador de Glifos", TOOLTIP_RUNESTONE_SET_WAYPOINT="Clique para definir um ponto de referência.", LABEL_CHARACTER_TIME="Tempo do personagem", LABEL_LAST_UPDATED="Última atualização", LABEL_VAULT_OVERALL_PROGRESS="Progresso geral: %d/%d", LABEL_VAULT_ROW_DUNGEONS="Masmorras", TITLE_CHARACTER_GREAT_VAULT_FMT="Grande Cofre de %s: %s", TITLE_CHARACTER_WEEKLY_PLANNER_FMT="Planejador semanal de %s: %s", LABEL_NEXT_WEEK_FMT="Próxima semana: %s",
BUTTON_EDIT_MONTHLY_GOAL="Editar meta mensal", BUTTON_EDIT_WEEKLY_GOAL="Editar meta semanal", BUTTON_EXPORT_CSV="Exportar CSV", BUTTON_MONTHLY_PROFIT_EXPORT="Lucro mensal em CSV", BUTTON_WARBAND_PROFIT_BREAKDOWN="Detalhamento do Bando de Guerra", BUTTON_WARBAND_PROFIT_EXPORT="Lucro semanal do Bando de Guerra em CSV", BUTTON_WEEKLY_PROFIT_EXPORT="Lucro semanal em CSV", LABEL_GOAL_AMOUNT="Valor da meta (ouro)", LABEL_GOLD="Ouro", LABEL_NET="Líquido", LABEL_SHARE="Compartilhar", LABEL_ZONE="Zona", LABEL_WARBAND_WEEKLY_PROFIT="Lucro semanal do Bando de Guerra", MSG_NIT_TIMEPLAYED_WARNING="NovaInstanceTracker detectado. O NIT pode ocultar a mensagem /played mesmo quando a opção do LiteVault está desativada.", MSG_TIMEPLAYED_RESTORED="Mensagens de tempo de jogo restauradas.", MSG_TIMEPLAYED_SUPPRESSED="As mensagens de tempo de jogo serão ocultadas.", MSG_WOW_TOKEN_API_UNAVAILABLE="A API da Ficha de WoW não está disponível neste cliente.", MSG_WOW_TOKEN_DATA_UNAVAILABLE="Dados da Ficha de WoW indisponíveis.", MSG_WOW_TOKEN_VISIT_AH="Visite a Casa de Leilões para atualizar o preço da Ficha de WoW.", OPTION_ENABLE_CALENDAR_PROFIT_HIGHLIGHTS_DESC="Mostra destaques verdes e vermelhos nos dias de lucro ou prejuízo do calendário.",
TITLE_ACHIEVEMENTS="Conquistas", LABEL_ACHIEVEMENT_GROUPS="Grupos", LABEL_GLOWING_MOTHS="Mariposas", LABEL_SHARED_LOOT="Saque compartilhado", LABEL_KNOWLEDGE_CATCHUP="Recuperação", STATUS_ASSAULT_WAVE_1_COMPLETE="Onda 1 concluída", STATUS_ASSAULT_WAVE_2_COMPLETE="Onda 2 concluída", STATUS_ASSAULT_WAVE_3_COMPLETE="Onda 3 concluída", TEXT_MIDNIGHT_RARES_TRACKER_DESCRIPTION="Rastreie conquistas de raros de Midnight, recompensas e saques compartilhados.", TEXT_MIDNIGHT_TREASURES_TRACKER_DESCRIPTION="Rastreie as conquistas de tesouros de Midnight e suas recompensas.", TEXT_HARANIR_JOURNAL_INSTRUCTION="Recupere as entradas do diário haranir listadas abaixo.", TEXT_HARANIR_LEGEND_DEFENSE_INSTRUCTION="Defenda cada local de lenda haranir listado abaixo.", TEXT_BLESSING_EFFECT_INSTRUCTION="Ative cada efeito de bênção listado para obter crédito.", TOOLTIP_CAVE_RUN_CREDIT_INSTRUCTION="Conclua a exploração desta caverna para obter crédito.", TEXT_TELESCOPE_ZONE_REQUIREMENT="Conclua os cinco telescópios desta zona.",
TEXT_MIDNIGHT_DELVER_META_INSTRUCTION="Conclua as quatro conquistas auxiliares de imersões de Midnight para finalizar esta meta-conquista.", TEXT_COILED_ISLE_META_INSTRUCTION="Conclua as conquistas de Coiled Isle.", TEXT_MIDNIGHT_ZONE_META_REWARD_REQUIREMENT="Conclua as quatro meta-conquistas de zona de Midnight e receba a montaria como recompensa.", TEXT_CLAW_ENFORCEMENT_REQUIREMENT="Conclua a missão mundial de Harandar 'Claw Enforcement' com pelo menos 15 aplicações de Predator's Pursuit.", TEXT_ATALUTEK_META_INSTRUCTION="Conclua as conquistas de Vaults of Atal'Utek.", TEXT_COILED_ISLE_LORE_INSTRUCTION="Descubra os objetos de história de Coiled Isle.", TEXT_HUNGERING_PRESENCE_REQUIREMENT="Escape das garras de Hungering Presence em Voidstorm por pelo menos 60 segundos.", TEXT_CRADLE_FLIGHT_REQUIREMENT="Voe até The Cradle, bem acima de Harandar, para concluir esta conquista.", TEXT_EVERSONG_META_TRACKER_DESCRIPTION="Rastreie a meta-conquista de Eversong Woods e acesse seus rastreadores secundários.", TEXT_MIDNIGHT_PEAKS_TRACKER_DESCRIPTION="Rastreie as quatro conquistas de zona de Midnight, the Highest Peaks.", TEXT_HARANDAR_META_TRACKER_DESCRIPTION="Rastreie a meta-conquista de Harandar e acesse seus rastreadores secundários.", TEXT_VOIDSTORM_META_TRACKER_DESCRIPTION="Rastreie a meta-conquista de Voidstorm e acesse seus rastreadores secundários.", TEXT_ZULAMAN_META_TRACKER_DESCRIPTION="Rastreie a meta-conquista de Zul'Aman e acesse seus rastreadores secundários.", TEXT_CRADLE_FLIGHT_ATTEMPT="Tente voar até The Cradle, bem acima de Harandar.", NOTE_MOTH_ROUTE_RENOWN_REQUIREMENT="A rota do LiteVault pressupõe que Hara'ti Renown 11 já esteja desbloqueado.",
TEXT_HARATI_META_PROGRESS_INSTRUCTION="Ajude os Hara'ti concluindo as conquistas abaixo. x/y concluídas.", TEXT_VOIDSTORM_META_PROGRESS_INSTRUCTION="Conclua todas as conquistas de Voidstorm listadas abaixo. x/y concluídas.", TEXT_ZULAMAN_META_PROGRESS_INSTRUCTION="Conclua todas as conquistas de Zul'Aman listadas abaixo. x/y concluídas.", TEXT_STORMARION_ASSAULT_PROGRESS_INSTRUCTION="Conclua as três ondas de Stormarion Assault. x/y marcadas.", TEXT_ABUNDANT_HARVEST_PROGRESS_INSTRUCTION="Conclua uma exploração de caverna de Abundant Harvest em cada local. x/y marcadas.", TEXT_EVERSONG_META_PROGRESS_INSTRUCTION="Conclua as conquistas de Eversong Woods listadas abaixo. x/y concluídas.", TEXT_GLOWING_MOTH_PROGRESS="Encontre todas as Glowing Moths escondidas em Harandar. x/y encontradas.", TEXT_HARANIR_LEGEND_PROGRESS="Proteja cada local de lenda haranir listado abaixo. x/y marcados.", TEXT_XALATATH_META_PROGRESS="Reúna suas forças contra Xal'atath concluindo as conquistas abaixo. x/y concluídas.", TEXT_HARANIR_JOURNAL_PROGRESS="Recupere as entradas do diário haranir listadas abaixo. x/y marcadas.", TEXT_BLESSING_EFFECT_PROGRESS="Ative cada efeito de bênção listado. x/y marcados.", TEXT_FACTION_INVITE_PROGRESS="Rastreie os quatro convites de facção de The Party Must Go On. x/y marcados.", TEXT_EVER_PAINTING_PROGRESS="Rastreie as telas conhecidas de Ever-Painting. x/y marcadas.", TEXT_RUNESTONE_RUSH_PROGRESS="Rastreie as entradas conhecidas de Runestone Rush. x/y marcadas.",
TEXT_DELVER_MOUNT_REWARD_REQUIREMENT="Conclua Glory of the Midnight Delver para obter esta montaria.", NOTE_MOTH_GROUP_1_RENOWN="As mariposas 1–40 aparecem em Hara'ti Renown 1, e o rastreamento em Renown 2.", NOTE_MOTH_GROUP_2_RENOWN="As mariposas 41–80 aparecem em Hara'ti Renown 4, e o rastreamento em Renown 6.", NOTE_MOTH_GROUP_3_RENOWN="As mariposas 81–120 aparecem em Hara'ti Renown 9, e o rastreamento em Renown 11.", NOTE_HARANIR_JOURNAL_AVAILABILITY="Estes diários só ficam disponíveis durante a missão semanal vinculada à conta 'Legends of the Haranir'. Durante uma visão, procure o ícone de lupa no minimapa.", NOTE_CLAW_ENFORCEMENT_NO_COORDINATES="Esta conquista não precisa de rastreamento de coordenadas no LiteVault. Conclua a missão mundial de Harandar 'Claw Enforcement' com pelo menos 15 aplicações de Predator's Pursuit.", NOTE_HUNGERING_PRESENCE_NO_COORDINATES="Esta conquista não precisa de rastreamento de coordenadas no LiteVault. Sobreviva ao evento Hungering Presence em Voidstorm por pelo menos 60 segundos.", NOTE_HARANIR_LEGENDS_WEEKLY_ESTIMATE="Isto está vinculado à missão semanal da conta 'Legends of the Haranir'. Se você ainda não tem progresso, a conclusão deve levar cerca de 7 semanas.", NOTE_MOTH_TRACKER_GROUPING="Este rastreador é dividido em 3 grupos de 40 coordenadas para manter as rotas de mariposas organizadas.", TEXT_EVER_PAINTING_TRACKER_PLACEHOLDER="Rastreie o progresso de Ever-Painting. Os detalhes podem ser adicionados mais tarde.", TEXT_EXPLORE_EVERSONG_TRACKER_PLACEHOLDER="Rastreie o progresso de Explore Eversong Woods. Os detalhes podem ser adicionados mais tarde.", TEXT_RUNESTONE_RUSH_TRACKER_PLACEHOLDER="Rastreie o progresso de Runestone Rush. Os detalhes podem ser adicionados mais tarde.", TEXT_PARTY_TRACKER_PLACEHOLDER="Rastreie o progresso de The Party Must Go On. Os detalhes podem ser adicionados mais tarde.", TOOLTIP_ABUNDANT_HARVEST_CREDIT_REQUIREMENT="Você precisa concluir uma exploração de caverna de Abundant Harvest em cada local. Apenas visitar a caverna não basta.",
TEXT_EXPLORE_EVERSONG_PROGRESS="Rastreie o progresso de Explore Eversong Woods. x/y marcados.", TEXT_EXPLORE_HARANDAR_PROGRESS="Rastreie o progresso de Explore Harandar. x/y marcados.", TEXT_EXPLORE_VOIDSTORM_PROGRESS="Rastreie o progresso de Explore Voidstorm. x/y marcados.", TEXT_EXPLORE_ZULAMAN_PROGRESS="Rastreie o progresso de Explore Zul'Aman. x/y marcados.",
}
