...
-- Subtitle (week info)
LVLedgerWindow.subtitle = LVLedgerWindow:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
...
local function GetHistoryRow(index)
    if not historyRows[index] then
        ...
        f.amount = f:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
