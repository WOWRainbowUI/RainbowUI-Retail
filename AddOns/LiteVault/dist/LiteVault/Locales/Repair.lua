...
for locale, data in pairs(lv.LocaleData or {}) do
    ...
    data['Title: "Dustlord"'] = data['Title: "Dustlord"'] or 'Title: "Dustlord"'
    data['Title: "Chronicler of the Haranir"'] = data['Title: "Chronicler of the Haranir"'] or 'Title: "Chronicler of the Haranir"'
