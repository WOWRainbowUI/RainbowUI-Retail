...
lv.EnsureBorderStyle(LVProfessionWindow, "panelMedium")
...
C_Timer.After(0, function()
    if lv.RegisterThemedElement then
        ...
        lv.ApplyBorderStyle(LVProfessionWindow, "panel", t)
    end
end)
...
function lv.ShowProfessionWindow(charKey, forceRefresh)
    ...
    if currentProfTab == "glyphs" then
        for idx, zoneData in ipairs(MIDNIGHT_GLYPH_ZONES) do
            ...
            if panel then
                ...
                for buttonIndex, btn in ipairs(panel.buttons) do
                    ...
                    if glyph then
                        local glyphDone = IsGlyphDone(zoneData, glyph)
        ...
        LVProfessionWindow:SetHeight(#MIDNIGHT_GLYPH_ZONES > 4 and 487 or 345)
