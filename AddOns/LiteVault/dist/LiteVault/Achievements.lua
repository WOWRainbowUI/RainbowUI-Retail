...
local COILED_ISLE_TREASURES = {
    ...
    treasures = {
        ...
        { mapID = 2512, x = 64.92, y = 79.00, name = "Forgotten Mask", note = "On a broken stone wall on Gnarldor Isle, south of the delve entrance." },
...
ACH.STUDENT_OF_HISSSTORY_CONFIG = {
    ...
    objects = {
        { mapID = 2512, x = 42.5, y = 65.0, name = "Head Mason's Tablet", note = "Inside the Gate of the Eastern Fang. Entrance: 45.72, 64.94 on map 2512.", rep = "250 Zul'jarra's Forces rep" },
        ...
        { mapID = 2512, x = 32.5, y = 63.7, name = "Profaned Plaque", note = "Inside the Gate of the Western Fang, in the room immediately left after entering. Entrance: 31.80, 64.91 on map 2512.", rep = "250 Zul'jarra's Forces rep" },
    },
}
...
ACH.META_12_1 = {
    ...
    parents = {
        ...
        },
        {
            ...
            children = {
                { id = 63598, name = "Roll the Patrol", note = "Six of the twelve Temple Patrol variants are available each week.", criteria = { "Broken Bonds", "Slay Children of Ula'tek", "Scavenged Weapons", "Congealed Venom", "Vengeance for the Dead", "Calming the Dead", "Slay the Restless", "Siphon Venom", "Breath and Bile", "Dragged Below", "Ash to Ash", "Laid to Rest" }, details = {
                ...
                { id = 63600, name = "Spike the Strike", note = "Three of the six Temple Strike variants are active each week.", criteria = { "Purifying Earth and Sky", "The Underbelly", "Overflowing Venom", "Ruuk'jar's Clutch", "Profane Pyres", "Cursed Depths" }, details = {
                ...
                { id = 63601, name = "Oppose the Foes", note = "An Ancient Foe appears after a successful Temple Incursion. One Ancient Foe is available each week.", criteria = { "Congealed Malice", "Susarikk", "Khu'tulak" } },
...
home.treasureLaunchNote:SetText("|cffb8b8b8" .. UIText("Track Midnight treasure achievements and their rewards.") .. "|r")
...
home.raresLaunchNote = CreateAchievementLaunchNote(
    home.trackersContent,
    home.raresLaunchBtn,
    "|cffb8b8b8" .. UIText("Track Midnight rare achievements, rewards, and shared drops.") .. "|r"
)
...
home.loreLaunchNote = CreateAchievementLaunchNote(
    home.trackersContent,
    home.loreLaunchBtn,
    "|cffb8b8b8" .. UIText("Discover the lore objects of the Coiled Isle.") .. "|r"
)
...
home.ulatekLaunchNote = CreateAchievementLaunchNote(home.metaContent, home.ulatekLaunchBtn, "|cffb8b8b8" .. UIText("Complete the Coiled Isle achievements.") .. "|r")
...
home.assaultVaultLaunchNote = CreateAchievementLaunchNote(home.trackersContent, home.assaultVaultLaunchBtn, "|cffb8b8b8" .. UIText("Complete the Vaults of Atal'Utek achievements.") .. "|r")
...
rares.summary:SetText(UIText("Track Midnight rare achievements, rewards, and shared drops."))
    ...
    btn:SetScript("OnEnter", function(self)
        ...
        if info.mapID and info.x and info.y then
            ...
            if info.steps and #info.steps > 1 then
                ...
                GameTooltip:AddLine(string.format("Entrance: %.2f, %.2f (map %d)", entrance.x, entrance.y, entrance.mapID), 0.85, 0.85, 0.85)
                GameTooltip:AddLine(string.format("Inscription: %.2f, %.2f (map %d)", destination.x, destination.y, destination.mapID), 0.85, 0.85, 0.85)
                GameTooltip:AddLine("Shift-click for entrance; click for inscription.", 0.8, 0.8, 0.8)
            end
...
local function RenderTreasureAchievementsView()
    ...
    treasureSummary:SetText(UIText("Track Midnight treasure achievements and their rewards."))
        ...
        if treasure then
            ...
            btn:SetScript("OnEnter", function(self)
                ...
                if currentTreasure.note then
                    GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
                    GameTooltip:SetText(currentTreasure.name, 1, 0.82, 0)
                    GameTooltip:AddLine(currentTreasure.note, 1, 1, 1, true)
                    GameTooltip:Show()
                end
            end)
            btn:SetScript("OnLeave", function(self)
...
local function RenderMeta121View()
    ...
    if child then
        ...
        SetItemRewardDisplay(meta121.rewardIcon, meta121.rewardLabel, meta121.rewardButton, nil, child.rewardText and ("|cffb8b8b8" .. child.rewardText .. "|r") or ("|cff999999" .. UIText("No achievement reward listed.") .. "|r"))
    else
        completedCount = 0
        ...
        SetItemRewardDisplay(meta121.rewardIcon, meta121.rewardLabel, meta121.rewardButton, parent.reward, runtimeReward or ("|cff999999" .. UIText("No achievement reward listed.") .. "|r"))
    end
