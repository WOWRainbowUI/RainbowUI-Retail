...
local Type, Version = "LBAAnchorButtons", 2
...
local function Constructor()
  local name = "LBAAnchorButtons" .. AceGUI:GetNextWidgetNum(Type)
  ...
  background:SetBackdrop({
     bgFile = "Interface\\AddOns\\LiteButtonAuras\\Textures\\Square_FullWhite.tga",
     edgeFile = "Interface\\AddOns\\LiteButtonAuras\\Textures\\Square_FullWhite.tga",
     tile = true,
     tileEdge = true,
     --tileSize = 8,
     edgeSize = 2
  ...
  for _, direction in ipairs(directions) do
    ...
    buttonTex:SetTexture("Interface\\AddOns\\LiteButtonAuras\\Textures\\Square_FullWhite.tga")
