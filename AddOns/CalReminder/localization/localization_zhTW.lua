...
L["CALREMINDER_DDAY_REMINDER"] = "親愛的%s，你尚未回覆今天的活動邀請: %s。"
L["CALREMINDER_LDAY_REMINDER"] = "親愛的%s，你尚未回覆明天的活動邀請: %s。"
L["CALREMINDER_ACHIV_REMINDER"] = "待回覆的邀請"

L["CALREMINDER_OPTIONS_NPC"] = "%s NPC"
L["CALREMINDER_OPTIONS_NPC_DESC"] = "選擇提醒你即將到來活動的%s NPC。"

L["CALREMINDER_OPTIONS_QUOTES"] = "啟用語錄"
L["CALREMINDER_OPTIONS_QUOTES_DESC"] = "啟用/停用 NPC 語錄"

L["CALREMINDER_OPTIONS_DELAY"] = "檢查行事曆的天數"
...
L["CALREMINDER_TENTATIVE_REASON7"] = "需要玩家澄清"
