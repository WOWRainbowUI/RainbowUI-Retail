...
L["settings.rioRatingColors.title"] = "使用 Raider.IO 顏色評分"
L["settings.rioRatingColors.tooltip"] = "如果已載入 Raider.IO 插件，則使用 Raider.IO 的顏色方案進行 M+ 評分。"
