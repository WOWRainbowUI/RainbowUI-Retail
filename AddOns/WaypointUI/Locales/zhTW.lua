...
-- Config
L["Config - General"] = "一般"
L["Config - General - Title"] = "一般"
L["Config - General - Title - Subtext"] = "自訂整體設定。"
...
L["Config - WaypointSystem"] = "路徑點"
L["Config - WaypointSystem - Title"] = "路徑點"
L["Config - WaypointSystem - Title - Subtext"] = "管理路徑點系統行為。"
...
L["Config - Appearance - Title - Subtext"] = "自訂用戶界面的外觀。"
...
L["Config - ExtraFeature - TomTomSupport - Enable"] = "追蹤 TomTom 路徑點"
L["Config - ExtraFeature - TomTomSupport - Enable - Description"] = "啟用 Waypoint UI 支援 TomTom 路徑點追蹤。您可以在世界地圖上右鍵點擊任何 TomTom 路徑點，並從選單中選擇「設為箭頭路徑點」來追蹤。"
L["Config - ExtraFeature - TomTomSupport - AutoReplaceWaypoint"] = "自動替換路徑點"
L["Config - ExtraFeature - TomTomSupport - AutoReplaceWaypoint - Description"] = "自動以 Waypoint UI 追蹤 TomTom 路徑點。"
L["Config - ExtraFeature - DugisSupport"] = "Dugi 任務助手"
L["Config - ExtraFeature - DugisSupport - Enable"] = "追蹤 Dugi 路徑點"
L["Config - ExtraFeature - DugisSupport - Enable - Description"] = "啟用 Waypoint UI 支援 Dugi 任務助手路徑點追蹤。"
L["Config - ExtraFeature - DugisSupport - AutoReplaceWaypoint"] = "自動替換路徑點"
L["Config - ExtraFeature - DugisSupport - AutoReplaceWaypoint - Description"] = "自動以 Waypoint UI 追蹤目前的 Dugi 路徑點。"
