...
XIVBar.defaults = {
    profile = {
        general = {
            ...
            moduleSpacing = 30,
            barFullscreen = false,
            barWidth = (WOW_PROJECT_ID == WOW_PROJECT_MAINLINE and math.floor(GetScreenWidth())-550 or math.floor(GetScreenWidth())),
            barHoriz = 'CENTER',
			barCombatHide = false,
            barFlightHide = false,
            useElvUI = true,
...
function XIVBar:OnInitialize()
    ...
    self.optionsFrame = LibStub("AceConfigDialog-3.0"):AddToBlizOptions(AddOnName, L["XIV Bar Continued"], nil, "general")

    --options.args.modules = LibStub("AceDBOptions-3.0"):GetOptionsTable(self.db)
    self.modulesOptionFrame = LibStub("AceConfigDialog-3.0"):AddToBlizOptions(AddOnName, L['Modules'], L["XIV Bar Continued"], "modules")

    options.args.profiles = LibStub("AceDBOptions-3.0"):GetOptionsTable(self.db)
    self.profilesOptionFrame = LibStub("AceConfigDialog-3.0"):AddToBlizOptions(AddOnName, L['Profiles'], L["XIV Bar Continued"], "profiles")
