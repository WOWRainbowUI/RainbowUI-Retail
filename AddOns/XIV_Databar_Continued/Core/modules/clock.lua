...
function ClockModule:Refresh()
    ...
    self.clockFrame:SetPoint('CENTER', 0, clockFrameOffsetY) -- 自行修改
...
function ClockModule:RegisterFrameEvents()
    ...
    self.clockTextFrame:SetScript('OnEnter', function()
        ...
        GameTooltip:AddLine(" ")
        if (ToggleCalendar and type(ToggleCalendar) == "function") or C_AddOns.IsAddOnLoaded("ClassicCalendar") then -- 支援 ClassicCalendar
    ...
    self.clockTextFrame:SetScript('OnClick', function(_, button)
        ...
        if button == 'LeftButton' then
            if ToggleCalendar and type(ToggleCalendar) == "function" then
                ToggleCalendar()
            elseif C_AddOns.IsAddOnLoaded("ClassicCalendar") then -- 支援 ClassicCalendar
            	Calendar_Toggle()
            end
