...
L["SET_EQUIPMENT_SET"] = "套用裝備組合"
L["NO_EQUIPMENT_SETS"] = "沒有裝備組合"
L["CURRENT_EQUIPMENT_SET"] = "目前套用的組合"

-- Master Volume
L["MASTER_VOLUME"] = "主音量"
L["VOLUME_STEP"] = "每點一下調整的值"
L["ENABLE_MOUSE_WHEEL"] = "啟用滑鼠滾輪"
L["CURRENT_AUDIO_OUTPUT"] = "目前的音訊輸出"
L["SET_AUDIO_OUTPUT"] = "設定音訊輸出"
L["NO_AUDIO_OUTPUT_DEVICES"] = "沒有音訊輸出裝置"

-- DataBrokers
L["DATABROKERS"] = "DataBrokers"
L["DATABROKERS_PLUGINS"] = "DataBroker 插件"
L["DATABROKERS_NONE_AVAILABLE"] = "未偵測到 DataBroker 插件。請啟用支援 LibDataBroker 的插件，即可顯示在此清單中。"
L["DATABROKERS_SHOW_ICON"] = "顯示圖示"
L["DATABROKERS_ICON_SIZE"] = "圖示大小"
L["DATABROKERS_SHOW_TEXT"] = "顯示文字"
L["DATABROKERS_SHOW_DATA_SOURCES"] = "顯示資料來源"
L["DATABROKERS_SHOW_LAUNCHERS"] = "顯示啟動器"
L["DATABROKERS_OTHER"] = "其他"
...
L["CLOCK_SHOW_LOCKOUTS"] = "在提示視窗中顯示重置鎖定"
L["CLOCK_SHOW_BOSSES_KILLED"] = "顯示已擊敗首領"
L["CLOCK_LOCKOUTS_HEADER"] = "重置鎖定"
L["REST_ICON"] = "休息圖示"
...
L["HIDE_REST_ICON_MAX_LEVEL"] = "滿等時隱藏"
L["TEXTURE_SIZE"] = "材質大小"
L["POSITION"] = "位置"
...
L["ONLY_SHOW_CURRENT_SEASON"] = "僅顯示目前賽季"
L["MYTHIC_PLUS_TELEPORTS"] = "M+ 傳送"
L["HIDE_M_PLUS_TELEPORTS_TEXT"] = "隱藏 M+ 傳送文字"
L["SHOW_SEASON_DATES"] = "顯示賽季日期"
L["SEASON_DATE_RANGE"] = "%s 到 %s"
L["SEASON_DATE_FROM"] = "%s"
L["SHOW_MYTHIC_PLUS_TELEPORTS"] = "顯示 M+ 傳送"
L["MYTHIC_TELEPORT_SHARED_CD"] = "共用 8 小時冷卻時間（完成一個 M+ 地城後重置）"
L["SHOW_MYTHIC_TELEPORT_POPUP"] = "顯示傳送彈出視窗"
...
L["PROFILE_SETUP_HEADER"] = "功能資訊列"
L["PROFILE_SETUP_TEXT"] = "設定檔系統已更新：此角色目前仍在使用舊版的共用 Default 設定檔。\n\n請選擇此角色接下來的處理方式：\n- |cffffd100保留目前設定檔：|r 繼續使用共用的 Default 設定檔（建議）\n- |cffffd100複製共用設定檔：|r 以目前的共用設定為基礎，建立個人設定檔\n- |cffffd100建立空白設定檔：|r 建立使用預設值的個人設定檔（此角色的設定將重置）\n\n你之後也可以在「設定檔」設定中管理設定檔。"
L["PROFILE_SETUP_CURRENT"] = "目前設定檔：%s"
L["PROFILE_SETUP_NEW_BLANK"] = "建立空白設定檔"
L["PROFILE_SETUP_NEW_FROM_SHARED"] = "複製共用設定檔"
L["PROFILE_SETUP_KEEP_CURRENT"] = "保留目前設定檔"
L["PROFILE_NEWCHAR_TEXT"] = "此角色將以空白的個人設定檔開始。\n\n- |cffffd100保留目前設定檔：|r 保留此角色的空白個人設定檔\n- |cffffd100使用共用設定檔：|r 加入共用的 Default 設定檔（設定會同步）\n\n你之後可以在「設定檔」設定中變更此選擇。"
L["PROFILE_NEWCHAR_USE_SHARED"] = "使用共用設定檔"
L["DISABLE_LOGIN_MESSAGE"] = "停用登入訊息"
L["ADDON_LOADED_MSG"] = "已載入，輸入 /xivc 開啟設定。"
L["UPDATE_ANNOUNCE"] = "已更新至 %s，"
L["OPEN_CHANGELOG"] = "開啟更新日誌"
L["CHANGELOG_AFTER_COMBAT"] = "更新日誌將在戰鬥結束後開啟"
