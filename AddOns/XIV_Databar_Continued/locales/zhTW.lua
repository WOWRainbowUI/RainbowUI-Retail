...
-- Vault Module
L["GREAT_VAULT_DISABLED"] = "偉大的寶庫目前已停用，將於下賽季開始時恢復。"
L["MAX_LEVEL_DISCLAIMER"] = "此模組僅會在達到最高等級時顯示。"
L["VAULT_ALERT_COLOR"] = "提示顏色"
L["VAULT_ENABLE_REWARD_ALERT"] = "啟用可領取獎勵提示"
L["VAULT_FLASH_ALERT"] = "閃爍待領取獎勵"
L["VAULT_FLASH_INTERVAL"] = "閃爍間隔"
L["VAULT_REWARD_ALERTS"] = "獎勵提示"
L["VAULT_SNOOZE_CHAT"] = "顯示延後提醒聊天訊息"
