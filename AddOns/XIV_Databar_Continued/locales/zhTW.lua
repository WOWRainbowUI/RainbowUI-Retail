...
L['Show Accessibility Tooltips'] = "顯示協助工具提示";
L['Blizzard Micromenu'] = "遊戲內建微型選單";
L['Disable Blizzard Micromenu'] = "停用遊戲內建微型選單";
L["Keep Queue Status Icon"] = "保留佇列狀態圖示";
L['Blizzard Micromenu Disclaimer'] = '如果你使用其他介面插件 (例如 ElvUI)，請在該插件的設定中隱藏它的微型列。';
L['Blizzard Bags Bar'] = "遊戲內建背包列";
L['Disable Blizzard Bags Bar'] = "停用遊戲內建背包列";
L['Blizzard Bags Bar Disclaimer'] = '如果你使用其他介面插件 (例如 ElvUI)，請在該插件的設定中隱藏它的背包列。';
...
L['Show Housing Button'] = "顯示房屋按鈕"; -- TODO: translate
L['No Info'] = "沒有資訊";
L['Classic'] = "經典版";
L['Alliance'] = "聯盟";
L['Horde'] = "部落";
...
L['Show Button Text'] = "顯示按鈕文字"; -- Needs Translation 
...
L['Hide M+ Teleports text'] = "隱藏 M+ 傳送門文字";
...
L["Show on mouseover"] = "滑鼠指向時顯示"; -- Needs translation 
L["Show the bar only when you mouseover it"] = "只有滑鼠指向時才顯示資訊列"; -- Needs translation
L["Classic"] = "《經典版》"
