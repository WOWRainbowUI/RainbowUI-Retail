...
local data = {
    ...
    [103] = {
        {"Agility > Mastery > Critical Strike > Haste > Versatility", "單目標"},
		{"Agility > Mastery > Critical Strike > Versatility > Haste", "多目標"},
    },
    ...
    [270] = {
        ...
        {"Intellect > Haste > Mastery > Versatility > Critical Strike", "M+"},
    },

    -- 65 - Paladin: Holy -- https://www.icy-veins.com/wow/holy-paladin-pve-healing-stat-priority
    [65] = {
        {"Intellect > Critical Strike > Mastery = Haste > Versatility", "團隊"},
        {"Intellect > Critical Strike > Haste > Versatility > Mastery", "M+"},
    },
    ...
    [261] = {
        {"Critical Strike > Versatility > Mastery > Haste", "單目標"},
        {"Critical Strike > Mastery > Versatility > Haste", "多目標"},
    },

    -- 262 - Shaman: Elemental -- https://www.icy-veins.com/wow/elemental-shaman-pve-dps-stat-priority
    [262] = {
        {"Intellect > Mastery > Haste > Versatility > Critical Strike", "單目標: 火"},
        {"Intellect > Haste > Critical Strike > Versatility > Mastery", "單目標: 電"},
        {"Intellect > Haste > Critical Strike > Versatility > Mastery", "多目標: 火"},
    },
    -- 263 - Shaman: Enhancement -- https://www.icy-veins.com/wow/enhancement-shaman-pve-dps-stat-priority
    [263] = {
         {"Agility > Mastery > Haste > Critical Strike > Versatility", "元素師"},
		 {"Agility > Haste > Mastery > Critical Strike > Versatility", "風暴"},
    },
