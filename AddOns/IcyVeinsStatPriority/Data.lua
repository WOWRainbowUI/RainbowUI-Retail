...
local data = {
    ...
    [103] = {
        ...
        {"Mastery > Agility > Critical Strike > Haste > Versatility", "多目標 (利爪)"},
    },
    ...
    [1473] = {
        ...
        {"Intellect > Haste (20%) > Mastery > Critical Strike = Haste > Versatility", "龍隊指揮官"},
    },

    -- 253 - Hunter: Beast Mastery -- https://www.icy-veins.com/wow/beast-mastery-hunter-pve-dps-stat-priority
    [253] = {
        {"Critical Strike > Haste > Mastery > Versatility", "獸群領袖"},
        {"Haste > Critical Strike > Mastery > Versatility", "黑暗遊俠"},
    },
    ...
    [65] = {
        {"Intellect > Haste > Mastery > Versatility", "團隊"},
    ...
    [263] = {
        ...
        {"Haste = Mastery > Agility > Versatility > Critical Strike", "圖騰使者"},
    },
