...
|cFFFF0000%c|r - 自訂 - 允許自訂 Lua 函數傳回要顯示的文字字串。]=]
	...
	L["Enter static or relative values with %"] = "輸入帶 % 的靜態或相對值"
...
只有符合這一個值的時候會被載入]=]
	...
	L["Note: This progress source does not provide a total value/duration. A total value/duration must be set via \"Set Maximum Progress\""] = "注意：此進度來源不提供總數值/持續時間。必須透過「設定最大進度」設定總數值/持續時間"
	L["Npc ID"] = "NPC ID"
