...
L["Dispels"] = "驅散"
L["Display a gradient texture when the unit receives a heal from your certain healing spells."] = "當單位受到你的特定群體治療法術的治療時，顯示漸層材質。"
...
-- 自行加入
L["Hide in Combat"] = "戰鬥中隱藏"
L["Show ReBuff Checks"] = "顯示補放增益檢查"
L["Check if your group members need some raid buffs"] = "檢查隊友是否需要團隊增益"
L["Enable Auras Tooltips"] = "啟用光環的浮動提示資訊"
L["Bar Animation"] = "血條動畫效果"
L["Flash"] = "快閃"
L["Smooth"] = "平順"
L["Use Custom Textures"] = "使用自訂材質圖案"
L["Status Icon"] = "狀態圖示"
L["Target Counter"] = "目標數量"
L["Always Targeting"] = "總是選為目標"
L["Only available for Spells"] = "只對法術有效"
L["Disabled"] = "停用"
L["Left Spell"] = "左鍵法術"
L["Any Spells"] = "所有法術"
L["Enable Nicknames"] = "啟用暱稱"
L["Non-integer scaling may result in abnormal display of options UI"] = "非整數縮放可能會導致選項介面顯示不正常"