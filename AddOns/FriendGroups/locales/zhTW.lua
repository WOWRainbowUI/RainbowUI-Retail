...
L["MSG_RESET"] = "|cFF33FF99FriendGroups|r: 設定已重置。"
L["MSG_BUG_WARNING"] = "|cFF33FF99FriendGroups|r: 檢測到 Bnet API 錯誤。您的好友列表為空是遊戲客戶端 Bug 導致的。請嘗試重啟遊戲。"
...
L["RELOAD_TOOLTIP_DESC"]  = "重載介面以恢復 FriendGroups 插件。"

L["SHIELD_MSG"]           = "|cffFF0000FriendGroups 已啟用|r\n\n由於暴雪安全框架限制，\n您必須重載介面才能查看房屋。"
L["SHIELD_BTN_TEXT"]      = "重載以查看房屋"
L["SAFE_MODE_WARNING"]    = "|cffFF0000查看房屋:|r FriendGroups 已禁用以查看房屋。重載以啟用。"