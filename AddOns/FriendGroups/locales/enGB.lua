...
L["SET_FACTION_COLOR"] = "Use Faction Row Colour"
...
L["MENU_CLEAR_FONT_COLOR"] = "Clear Font Colour"
...
L["MENU_SET_FONT_COLOR"] = "Set Font Colour"
...
L["TOOLTIP_EXPORT_2"] = "Includes appearance, behaviour, group order, banner colours, nicknames and selected mains."
L["TOOLTIP_EXPORT_3"] = "|cFF00FF00Cross-flavour:|r import this code on any of your other WoW clients (Retail or Classic) to carry your whole setup across - groups, nicknames, banner colours, plus the alt cache that powers class colours and pre-filled Known Alts panels everywhere."
...
L["TOOLTIP_IMPORT_3"] = "|cFF00FF00Tip:|r a code exported on Retail is the richest source - importing it on a Classic client carries over groups, nicknames, banner colours and the alt cache (class colours for Retail-only classes, pre-filled Known Alts)."
