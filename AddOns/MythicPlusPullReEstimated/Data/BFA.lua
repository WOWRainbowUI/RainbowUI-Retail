...
function data:GetNPCData()
    ...
    return {
        ...
        [130485] = { name = "Mechanized Peacekeeper", count = 8 },
        ...
        [130661] = { name = "Venture Co. Earthshaper", count = 6 },
        ...
        [134012] = { name = "Taskmaster Askari", count = 20 },
        ...
        [136139] = { name = "Mechanized Peacekeeper", count = 8 },
        ...
        [144293] = { name = "Waste Processing Unit", count = 10 },
        [144294] = { name = "Mechagon Tinkerer", count = 6 },
        [144295] = { name = "Mechagon Mechanic", count = 4 },
        [144296] = { name = "Spider Tank", count = 12 },
        [144298] = { name = "Defense Bot Mk III", count = 10 },
        [144299] = { name = "Workshop Defender", count = 4 },
        [144301] = { name = "Living Waste", count = 1 },
        [144303] = { name = "G.U.A.R.D.", count = 5 },
        ...
        [151476] = { name = "Blastatron X-80", count = 20 },
        [151649] = { name = "Defense Bot Mk I", count = 5 },
        [151657] = { name = "Bomb Tonk", count = 4 },
        [151658] = { name = "Strider Tonk", count = 4 },
        [151659] = { name = "Rocket Tonk", count = 4 },
        [151773] = { name = "Junkyard D.0.G.", count = 7 },
        [152009] = { name = "Malfunctioning Scrapbot", count = 5 },
        [152435] = { name = "Bomb Tonk", count = 4 },
        [152442] = { name = "Strider Tonk", count = 4 },
        [152443] = { name = "Rocket Tonk", count = 4 },
        ...
        [236033] = { name = "Metal Gunk", count = 7 },
    }
end
...
function data:GetDebugData()
    return {
        [245] = { -- Freehold
            ...
            [50192] = { npcID = nil, count = 40 },
        },
        [249] = { -- Kings' Rest
            [42238] = { npcID = 138489, count = 8 },
        },
        [250] = { -- Temple of Sethraliss
            [40421] = { npcID = 135336, count = 12 },
            [42224] = { npcID = nil, count = 4 },
        },
        [251] = { -- The Underrot
        ...
        [369] = { -- Operation: Mechagon - Junkyard
            [50191] = { npcID = nil, count = 4 },
            [50192] = { npcID = nil, count = 34 },
            [53732] = { npcID = 190128, count = 21 },
            [54607] = { npcID = 189878, count = 7 },
        },
        [370] = { -- Operation: Mechagon - Workshop
            [50191] = { npcID = nil, count = 4 },
            [50192] = { npcID = nil, count = 38 },
            [53732] = { npcID = 190128, count = 9 },
            [54607] = { npcID = 189878, count = 3 },
        }
    }
end
