...
L["Color of the text on the enemy nameplates"] = "敵方名條上的進度文本顏色"
...
L["Enable Nameplate Text"] = "啟用名條文本"
...
L["Horizontal offset of the nameplate text"] = "名條文本的水平偏移"
...
L["Mythic Plus Progress"] = "Mythic Plus Progress 傳奇鑰匙進度"
L["Mythic Plus Progress tracker"] = "傳奇鑰匙進度追蹤"
L["Nameplate"] = "名條"
L["Nameplate Text Color"] = "名條文本顏色"
L["No Progress."] = "沒有進度。"
L["No record."] = "沒有記錄。"
...
L["Vertical offset of the nameplate text"] = "名條文本的垂直偏移"
