...
function SQP:CreateAboutSection(content)
    ...
    descText:SetText("Simple Quest Plates 會在敵人的血條上顯示任務進度圖示。讓你一眼就能看出需要擊敗的敵人、所需的物品掉落，以及整體任務進度。")
    ...
    versionText:SetText("版本: |cff58be81" .. (SQP.VERSION or "1.0.0") .. "|r")
    ...
    authorText:SetText("作者: |cff58be81DonnieDice|r")
    ...
    emailText:SetText("聯繫: |cff58be81donniedice@protonmail.com|r")
