...
function SQP:InitializeObjectiveTabs(parentPanel)
    ...
    local orderedTabs = {}
    local tabInfo = {
        {id = "kill", text = self.L["Kill"], preview = "kill"},
        {id = "loot", text = self.L["Loot"], preview = "loot"},
        {id = "percent", text = self.L["Quest %"], preview = "percent"},
    }
...
function SQP:InitializeTabs(container, previewContainer)
    ...
    local tabInfo = {
        ...
        {id = "objectives", text = self.L["Objectives"]},
