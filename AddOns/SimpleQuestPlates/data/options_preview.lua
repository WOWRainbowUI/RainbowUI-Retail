...
function SQP:CreatePreviewSection(parent)
    ...
    previewTitle:SetText("|cff58be81即時預覽|r")
    ...
    killButton = self:CreateStyledButton(previewFrame, self.L["OPTIONS_COLOR_KILL"], 80, 25)
    killButton:SetPoint("BOTTOM", previewFrame, "BOTTOM", -105, 5)
    ...
    lootButton = self:CreateStyledButton(previewFrame, self.L["OPTIONS_COLOR_ITEM"], 120, 25)
    ...
    percentButton = self:CreateStyledButton(previewFrame, self.L["OPTIONS_COLOR_PERCENT"], 100, 25)
    percentButton:SetPoint("BOTTOM", previewFrame, "BOTTOM", 115, 5)
