...
function SQP:CreateIconOptions(content)
    ...
    local xResetBtn = self:CreateStyledButton(leftColumn, self.L["Reset"] or "Reset", 50, 20)
    ...
    local yResetBtn = self:CreateStyledButton(leftColumn, self.L["Reset"] or "Reset", 50, 20)
    ...
    -- Create buttons
    local leftButton = self:CreateStyledButton(leftColumn, self.L["Left Side"] or "Left Side", 90, 25)
    leftButton:SetPoint("TOPLEFT", 20, yOffset)
    
    local rightButton = self:CreateStyledButton(leftColumn, self.L["Right Side"] or "Right Side", 90, 25)
    ...
    local iconResetBtn = self:CreateStyledButton(rightColumn, self.L["Reset"] or "Reset", 50, 20)
    ...
    local resetAllBtn = self:CreateStyledButton(rightColumn, self.L["OPTIONS_RESET"], 180, 30)
