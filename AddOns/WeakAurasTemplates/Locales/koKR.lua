...
-- WeakAuras/Templates
	...
	L["Always show the aura, turns grey if on cooldown."] = "이 위크오라를 항상 표시하며, 재사용 대기 중이면 회색으로 바뀝니다."
	...
	L["Always shows the aura, turns grey if on cooldown."] = "이 위크오라를 항상 표시하며, 재사용 대기 중이면 회색으로 바뀝니다."
	...
	L["Only show the aura when the item is on cooldown."] = "아이템이 재사용 대기 중일 때만 이 위크오라를 표시합니다."
	...
	L["Only shows the aura when the ability is on cooldown."] = "스킬이 재사용 대기중일 때만 이 위크오라를 표시합니다."
	L["Only shows the aura when the ability is ready to use."] = "스킬을 사용할 수 있을 때만 이 위크오라를 표시합니다."
	L["Other cooldown"] = "다른 재사용 대기시간"
	L["Pet alive"] = "소환수 생존"
	...
	L["Show Cooldown and Action Queued"] = "재사용 대기시간과 동작 대기 상태 표시"
	L["Show Cooldown and Buff"] = "재사용 대기시간과 버프 표시"
	L["Show Cooldown and Buff and Check for Target"] = "재사용 대기시간과 버프 표시 및 대상 확인"
	L["Show Cooldown and Buff and Check Usable"] = "재사용 대기시간과 버프 표시 및 사용 가능 검사"
	L["Show Cooldown and Check for Target"] = "재사용 대기시간 표시 및 대상 확인"
	L["Show Cooldown and Check for Target & Proc Tracking"] = "재사용 대기시간 표시와 대상 검사 및 발동 추적"
	L["Show Cooldown and Check Usable"] = "재사용 대기시간 표시 및 사용 가능 확인"
	L["Show Cooldown and Check Usable & Target"] = "재사용 대기시간 표시와 사용 가능 상태 및 대상 검사"
	L["Show Cooldown and Check Usable, Proc Tracking"] = "재사용 대기시간 표시와 사용 가능 상태 검사, 발동 추적"
	L["Show Cooldown and Check Usable, Target & Proc Tracking"] = "재사용 대기시간 표시와 사용 가능 상태, 대상 검사 및 발동 추적"
	L["Show Cooldown and Debuff"] = "재사용 대기시간과 디버프 표시"
	L["Show Cooldown and Debuff and Check for Target"] = "재사용 대기시간과 디버프 표시 및 대상 검사"
	L["Show Cooldown and Duration"] = "재사용 대기시간 및 지속시간 표시"
	L["Show Cooldown and Duration and Check for Target"] = "재사용 대기시간과 지속시간 표시 및 대상 검사"
	L["Show Cooldown and Duration and Check Usable"] = "재사용 대기시간과 지속시간 표시 및 사용 가능 상태 검사"
	L["Show Cooldown and Proc Tracking"] = "재사용 대기시간 표시와 발동 추적"
	...
	L["Warrior cooldown"] = "전사 재사용 대기시간"
