...
-- ============================================================================
-- Raid
L["Buff.ArcaneIntellect"] = "奧術智慧"
L["Buff.BattleShout"] = "戰鬥怒吼"
L["Buff.BlessingOfTheBronze"] = "銅龍祝福"
L["Buff.MarkOfTheWild"] = "野性印記"
L["Buff.PowerWordFortitude"] = "真言術：韌"
L["Buff.Skyfury"] = "天空之怒"

-- Presence
L["Buff.AtrophicNumbingPoison"] = "萎縮/麻木毒藥"
L["Buff.DevotionAura"] = "虔誠光環"
L["Buff.Soulstone"] = "靈魂石"

-- Targeted
L["Buff.BeaconOfFaith"] = "信仰烽火"
L["Buff.BeaconOfLight"] = "聖光烽火"
L["Buff.BlisteringScales"] = "灼熱鱗片"
L["Buff.EarthShield"] = "大地之盾"
L["Buff.SourceOfMagic"] = "魔法之源"
L["Buff.SymbioticRelationship"] = "共生關係"

-- Self
L["Buff.ArcaneFamiliar"] = "奧術魔寵"
L["Buff.Attunement"] = "調諧"
L["Buff.CreateSoulwell"] = "創造靈魂之泉"
L["Buff.GrimoireOfSacrifice"] = "獻祭魔典"
L["Buff.BurningRush"] = "燃燒衝鋒"
L["Buff.RiteOfAdjuration"] = "懇求儀式"
L["Buff.RiteOfSanctification"] = "神聖化儀式"
L["Buff.RoguePoisons"] = "盜賊毒藥"
L["Buff.RuneforgeMH"] = "符文鍛造 (主手)"
L["Buff.RuneforgeOH"] = "符文鍛造 (副手)"
L["Buff.Shadowform"] = "暗影形態"
L["Buff.EarthlivingWeapon"] = "大地生命武器"
L["Buff.FlametongueWeapon"] = "火焰之舌武器"
L["Buff.TidecallersGuard"] = "潮汐召喚者護盾"
L["Buff.WindfuryWeapon"] = "風怒武器"
L["Buff.EarthShieldSelf"] = "大地之盾 (自身)"
L["Buff.WaterLightningShield"] = "水之盾/閃電之盾"
L["Buff.ShieldNoTalent"] = "盾 (無天賦)"

-- Pet
L["Buff.PetPassive"] = "寵物被動"
L["Buff.HunterPet"] = "獵人寵物"
L["Buff.UnholyGhoul"] = "邪惡食屍鬼"
L["Buff.WarlockDemon"] = "術士惡魔"
L["Buff.WaterElemental"] = "水元素"
L["Buff.WrongDemon"] = "錯誤惡魔"

-- Consumable
L["Buff.AugmentRune"] = "強化符文"
L["Buff.Flask"] = "魔瓶"
L["Buff.DelveFood"] = "探索食物"
L["Buff.Food"] = "食物"
L["Buff.Healthstone"] = "生命石"
L["Buff.Weapon"] = "武器 (主手)"
L["Buff.WeaponOH"] = "武器 (副手)"
...
-- ============================================================================
L["Options.Sound.NoAlerts"] = "尚未設定任何音效提示。"
L["Options.Sound.AddAlert"] = "新增音效提示"
L["Options.Sound.Title"] = "新增音效提示"
L["Options.Sound.EditTitle"] = "編輯音效提示"
L["Options.Sound.SelectBuff"] = "選擇增益效果"
L["Options.Sound.SelectSound"] = "選擇音效"
L["Options.Sound.Preview"] = "預覽"
L["Options.Sound.Save"] = "儲存"
L["Options.Sound.NoBuffs"] = "所有增益效果均已設定音效。"
...
L["Options.DelveFoodSettings"] = "探索食物設定"
L["Options.DelveFoodSettings.Note"] = "設定探索食物提示的顯示行為。"
L["Options.DelveFoodTimer"] = "30 秒後自動隱藏"
L["Options.DelveFoodTimer.Desc"] =
    "啟用時，探索食物提示僅在進入探索後顯示 30 秒，之後自動隱藏。停用時，只要身處探索中且缺少該增益效果，提示將持續顯示。"
...
L["Options.HideWhen.Leveling"] = "練等期間"
L["Options.HideWhen.Leveling.Title"] = "練等期間隱藏"
L["Options.HideWhen.Leveling.Desc"] = "未達等級上限時隱藏所有增益效果提示"
...
-- Mover labels
L["Mover.AnchorGrowth"] = "對齊點 - 延伸方向 %s"
L["Mover.AnchorGrowthFrame"] = "對齊點 - 延伸方向 %s - > %s"
-- Pet labels
