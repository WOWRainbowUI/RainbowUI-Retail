...
SlashCmdList["PRDPOWER"] = function(msg)
    ...
    if msg == "show" then
        ...
        print("|cff00ff00PRD Power Bar shown and will stay after reload for this profile.|r")
    elseif msg == "hide" then
        setHidden(true)
        UpdatePowerBarVisibility()
        print("|cffff0000PRD Power Bar hidden and will stay after reload for this profile.|r")
    else
