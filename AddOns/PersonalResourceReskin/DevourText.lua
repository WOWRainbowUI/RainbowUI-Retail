...
local options = {
    ...
    args = {
        devourFont = {
            ...
            get = function() return db and db.profile and db.profile.devourFont or "Friz Quadrata TT" end,
            set = function(_, val)
        ...
        devourFontSize = {
            ...
            max = 48,
            step = 1,
            get = function() return db and db.profile and db.profile.devourFontSize or 20 end,
            set = function(_, val)
                if db and db.profile then
