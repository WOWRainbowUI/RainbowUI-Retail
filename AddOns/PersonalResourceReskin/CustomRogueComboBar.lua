...
local function ApplyComboBarSettings()
    ...
    if anchorFrame then
        if CustomRogueComboBarDB.anchorPosition == "ABOVE" then
            dprint("Anchoring ABOVE PRD with offset", CustomRogueComboBarDB.anchorOffset or 10)
            comboPointBar:SetPoint("BOTTOM", anchorFrame, "TOP", 0, CustomRogueComboBarDB.anchorOffset or 10)
        else
            dprint("Anchoring BELOW PRD with offset", CustomRogueComboBarDB.anchorOffset or 10)
            comboPointBar:SetPoint("TOP", anchorFrame, "BOTTOM", 0, -(CustomRogueComboBarDB.anchorOffset or 10))
        end
    else
        dprint("Center position x=", CustomRogueComboBarDB.x or 0, "y=", CustomRogueComboBarDB.y or 0)
