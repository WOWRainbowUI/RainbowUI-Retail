...
if not AceAddon or not AceDB or not AceConfig or not AceConfigDialog or not LSM then
    print("|cffff0000[" .. ADDON_NAME .. "]|r Missing Ace3 or LibSharedMedia libraries. Please install them.")
    return
end
    ...
    args = {
        ...
        tracked = {
            ...
            args = {
                ...
                list = {
                    name = "Spell ID List",
                    desc = "Comma separated spell IDs to track (e.g. 1225789,1217607)",
                    type = "input",
                    get = function()
                        local t = GetProfile().trackedSpells or {}
...
SlashCmdList["PRR"] = function(msg)
    ...
    print("[" .. ADDON_NAME .. "] Interface options are not available right now. Try /reload or open Interface Options manually.")
end
