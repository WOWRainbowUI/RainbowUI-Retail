        ...
        args = {
            ...
            phtCommands = {
                ...
                args = {
                    ...
                    phtStyle = {
                        name = "設定樣式",
                        desc = "設定血量文字樣式：百分比、當前數值，或 當前數值 / 百分比。",
                        type = "select",
                        values = { percent = "百分比", current = "當前數值", both = "當前數值 / 百分比" },
                        get = function()
                            local db = _G.PlayerHealthTextDB or {}
            ...
            playerPowerTextOptions = {
                name = "玩家能量文字樣式",
                desc = "設定玩家能量文字樣式：當前數值、當前數值 / 最大值，或 當前數值 / 百分比。",
                type = "select",
