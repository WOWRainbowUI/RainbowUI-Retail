...
local NewSpenderTrackerOptions = {
	type = "group",
	name = "AldrachiReaverTrackers",
	order = 950,
	args = {
		header = {
			order = 0,
			type = "header",
			name = "Aldrachi Reaver Tracker Options",
		},
		iconSize = {
			order = 1,
			type = "range",
		...
		xOffset = {
			...
			set = function(_, val) setDB("xOffset", val); frame:SetPoint("CENTER", UIParent, "CENTER", val, getDB("yOffset", 0)); UpdateSpenderIcons() end,
		},
		yOffset = {
			order = 4,
			type = "range",
			...
			set = function(_, val) setDB("yOffset", val); frame:SetPoint("CENTER", UIParent, "CENTER", getDB("xOffset", 0), val); UpdateSpenderIcons() end,
		},
		lock = {
			order = 5,
			type = "toggle",
			name = "Lock Icons",
			desc = "Lock/unlock the icon frame for dragging.",
		...
		showGlow = {
			order = 6,
			type = "toggle",
			name = "Show Pixel Glow",
			desc = "Show/hide the pixel glow effect on the icons.",
