...
local function ApplyArcaneOrbBarSettings()
    ...
    if anchorFrame then
        if CustomMageArcaneOrbDB.anchorPosition == "ABOVE" then
            dprint("Anchoring ABOVE PRD with offset", CustomMageArcaneOrbDB.anchorOffset or 10)
            arcaneOrbBar:SetPoint("BOTTOM", anchorFrame, "TOP", 0, CustomMageArcaneOrbDB.anchorOffset or 10)
        else
            dprint("Anchoring BELOW PRD with offset", CustomMageArcaneOrbDB.anchorOffset or 10)
            arcaneOrbBar:SetPoint("TOP", anchorFrame, "BOTTOM", 0, -(CustomMageArcaneOrbDB.anchorOffset or 10))
        end
    else
        dprint("Center position x=", CustomMageArcaneOrbDB.x or 0, "y=", CustomMageArcaneOrbDB.y or 0)
