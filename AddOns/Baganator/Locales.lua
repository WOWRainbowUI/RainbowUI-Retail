...
L["GUILD_WITHDRAW_DEPOSIT_X_X"] = "物品 - 提取： %s | 存入： %s"
L["HELP"] = "帮助"
L["HELP_COLON_SEARCH"] = "帮忙：搜索"
L["HELP_SEARCH_ITEM_LEVEL"] = "物品等级"
L["HELP_SEARCH_ITEM_LEVEL_LINE_1"] = "123 （准确等级），<123 （低于等级）， >123 （高于等级） 123-234 （介于之间等级）"
...
L["HELP_SEARCH_OPERATORS_LINE_1"] = "& （和）， | （或）， ! （不是）， # （精准关键字）"
L["HELP_SEARCH_OPERATORS_LINE_2"] = "运算符的优先级顺序如下：! （不是），& （和）， 和  | （或）。"
L["HELP_SEARCH_OPERATORS_LINE_3"] = "例如：!A & B | C 被求值为 ((!A) & B) | C。"
L["HERBALISM"] = "草药"
L["HIDDEN"] = "隐藏"
...
L["SORT"] = "整理"
L["SORT_METHOD_2"] = "排序方式"
L["SORT_METHOD_RESET_FOR_CATEGORIES"] = "排序方法重置，与分类一起使用"
