...
L["NO_PASTE_MESSAGE"] = "Vous avez installé l'add-on Paste, cela entraînera des problèmes de recherche et d'affichage avec Baganator. Utilisez PasteNG à la place."
...
L["NO_PASTE_MESSAGE"] = "У вас установлен аддон Paste, который вызывает проблемы с поиском и визуальным отображением в Baganator. Вместо этого используйте PasteNG."
...
L["NO_PASTE_MESSAGE"] = "Você tem o addon Paste instalado, isso causará problemas de procura e visuais com o Baganator. Use o PasteNG em vez disso."
...
L["NO_PASTE_MESSAGE"] = "Tienes instalado el addon Paste, esto causará problemas de búsqueda y visualización con Baganator. Usa PasteNG en su lugar."
