...
L["BUY_CHARACTER_BANK_TAB"] = "是否要購買角色銀行分頁？"
L["BUY_GUILD_BANK_TAB"] = "是否要購買公會銀行分頁?"
...
L["CANNOT_MOVE_ITEMS_AS_NO_SPACE_LEFT"] = "空間不足無法移動物品"
L["CANNOT_WITHDRAW_ANY_MORE_ITEMS_FROM_THE_GUILD_BANK"] = "無法從公會銀行提取更多物品"
L["CANNOT_YOU_ARE_IN_COMBAT"] = "無法操作: 你正在戰鬥中"
L["CATALYST"] = "浩劫與重生"
L["CATEGORIES"] = "分類"
...
L["CHOOSE"] = "選擇"
L["CHOOSE_A_LABEL_FOR_THIS_SEARCH"] = "輸入這次搜尋要儲存成的名稱"
L["CLICK_TO_CLEAR_RECENT"] = "<點一下清空新物品>"
L["COMBINE_STACKS_ONLY"] = "只合併整組"
L["CONFIRM_DELETE_PROFILE_X"] = "是否確定要刪除設定檔 \"%s\"?"
...
L["FADE_ITEMS_NOT_MATCHING_SITUATION"] = "淡出物品不符合情況的物品"
L["FISHING"] = "釣魚"
...
L["HELP_SEARCH_OPERATORS_LINE_1_V2"] = "& (和)、| (或)、! (非)、# (精確關鍵字)、( ) (群組)"
L["HELP_SEARCH_OPERATORS_LINE_2_V2"] = "運算符依下列優先順序求值： ( ) (群組)、! (非)、& (和)，以及 | (或)。"
...
L["RECENT_INCLUDE_OWNED"] = "包括擁有的"
L["RECENT_TIMER"] = "最近計時器"
L["REDUCE_UI_SPACING"] = "減少介面空隙"
L["RELOAD_REQUIRED"] = "需要重新載入"
...
L["RIGHT_CLICK_FOR_SETTINGS"] = "<點右鍵設定>"
L["RIGHT_CLICK_TO_REMOVE"] = "<點右鍵移除>"
L["RIGHT_CLICK_TO_RESET"] = "<點右鍵重置>"
L["RIGHT_CLICK_TO_TRANSFER"] = "<點右鍵轉移>"
L["RIGHT_CLICK_TO_VENDOR_6"] = "<點右鍵賣出 (最多6件)>"
L["SAVE_SEARCH"] = "儲存搜尋"
L["SAVED_SEARCHES"] = "已儲存的搜尋"
L["SCRAP"] = "廢料"
...
L["SHIFT_CLICK_TO_VENDOR_ALL"] = "<按住 Shift 無上限>"
...
L["SLASH_CATEGORIES"] = "categories"
L["SLASH_CATEGORIES_HELP"] = "在浮動提示資訊中顯示符合或不符合物品的類別。"
L["SLASH_HELP"] = "打開多角色背包的設定。"
L["SLASH_KEYWORDS"] = "keywords"
L["SLASH_KEYWORDS_HELP"] = "在背包物品的浮動提示資訊中顯示符合的關鍵字。"
L["SLASH_REMOVEUNUSEDCATEGORIES"] = "removeunusedcategories"
L["SLASH_REMOVEUNUSEDCATEGORIES_HELP"] = "移除所有未使用的分類。"
L["SLASH_RESET"] = "重置"
L["SLASH_RESET_HELP"] = "重置多角色背包的所有設定，然後重新載入介面。"
L["SLASH_RESETCATEGORIES"] = "resetcategories"
L["SLASH_RESETCATEGORIES_HELP"] = "將分類設定重置為預設值，然後重新載入介面。"
L["SLASH_SEARCH"] = "search"
L["SLASH_SEARCH_EXTENDED"] = "search [文字]"
L["SLASH_SEARCH_HELP"] = "打開並搜尋背包。"
L["SLASH_SWAP"] = "swap"
L["SLASH_SWAP_HELP"] = "從分類背包切換成單一大背包，或反過來。"
...
L["TIPS_THEMES"] = "讓 Baganator 搭配你的遊戲介面，自動使用 ElvUI, GW2 或簡單的深色主題。"
...
L["TRANSFER_MAIN_VIEW_VENDOR_TOOLTIP_TEXT"] = "將搜尋到的物品出售給商店；\n最多 6 件，按住 Shift 則不受限制。"
L["TRANSPARENCY"] = "透明度"
L["TYPE"] = "類型"
L["UNLIMITED"] = "無限制"
...
L["USE_EXPRESSWAY_FONT_ON_ITEMS"] = "物品字體使用 EXPRESSWAY"
L["USING_X"] = "使用 %s"
L["VENDOR"] = "商店"
