...
L["CANNOT_EDIT_GUILD_BANK_TAB_ERROR"] = "你沒有權限編輯此標籤頁面"
...
L["SEARCH_EVERYWHERE_TOOLTIP_TEXT_1"] = "搜尋所有背包，包括非目前角色的背包，並將搜尋結果發送到你的聊天中。這是一項正在開發的功能，並計劃在未來提供完整的介面。歡迎就版面安排提出建議。"
...
L["SORTBAGS"] = "排序背包"
L["SORTING"] = "排序"
L["SYNDICATOR_ENABLE_MESSAGE"] = "使用 Baganator 時需要|cffd1b219Syndicator|r。"
L["SYNDICATOR_INSTALL_MESSAGE"] = "使用你的插件網站/客戶端安裝 |cffd1b219Syndicator|r 以使用 Baganator。"
L["TAB_INFO"] = "標籤頁訊息"
L["TAB_LOGS"] = "標籤頁記錄"
