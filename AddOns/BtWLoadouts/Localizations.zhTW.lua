...
L["Create different pvp talent layouts for the type of content you wish to do."] = "針對您想要做的內容類型創建不同的 PvP 天賦配置。"
L["Create different talent layouts for the type of content you wish to do. Leave rows blank to skip the tier."] = "為您想要的內容類型創建不同的天賦配置。將行留空以跳過此層。"
L["Create different talent layouts for the type of content you wish to do."] = "為您想要的內容類型創建不同的天賦配置。"
