...
L["Use Level In Strong Vs Filter"] = "在 \"強大於\" 過濾方式中使用等級"
...
L["Show Strongest Vs Stat"] = "顯示最強抗性"
L["On the pet card display the top three pet types the pet is strongest against, based on its abilities."] = "在寵物卡上顯示寵物基於其技能對前三種寵物類型的最強抗性。"
