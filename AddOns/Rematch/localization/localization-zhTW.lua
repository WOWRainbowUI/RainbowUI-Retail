...
L["When using a Load Random Pets button for random pets to counter a target, prefer pets with more Strong attacks over pets that are Tough vs opponent attacks."] = "當使用 \"載入隨機寵物\" 按鈕來隨機選擇寵物以對抗對手時，相較於在對手攻擊中強韌的寵物，優先選擇具有更多強力攻擊的寵物。"
