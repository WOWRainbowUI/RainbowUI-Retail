----------------------------------------------------------------------
-- 	Leatrix Plus 1.15.145 (15th July 2026)
----------------------------------------------------------------------
	...
	function LeaPlusLC:Player()
			...
			local function SetChainStyle()
				...
				if chain == 1 then -- Rare
					if C_AddOns.IsAddOnLoaded("EasyFrames") then
						PlayerFrameTexture:SetTexture("Interface\\AddOns\\Leatrix_Plus\\vanilla\\Leatrix_Plus.blp")
		...
		if LeaPlusLC["EnhanceTrainers"] == "On" then
			...
			EventUtil.ContinueOnAddOnLoaded("Blizzard_TrainerUI",function()
				...
				regions[2]:SetTexture("Interface\\AddOns\\Leatrix_Plus\\vanilla\\Leatrix_Plus")
				...
				regions[3]:SetTexture("Interface\\AddOns\\Leatrix_Plus\\vanilla\\Leatrix_Plus")
		...
		if LeaPlusLC["EnhanceQuestLog"] == "On" then
			...
			if LeaPlusLC["EnhanceQuestTaller"] == "On" then
				...
				regions[3]:SetTexture("Interface\\AddOns\\Leatrix_Plus\\vanilla\\Leatrix_Plus.blp")
				...
				regions[4]:SetTexture("Interface\\AddOns\\Leatrix_Plus\\vanilla\\Leatrix_Plus.blp")
...
----------------------------------------------------------------------
	...
	function LeaPlusLC:CreateButton(name, frame, label, anchor, x, y, width, height, reskin, tip, naked)
		...
		if reskin then
			...
			if not naked then
				mbtn:SetNormalTexture("Interface\\AddOns\\Leatrix_Plus\\vanilla\\Leatrix_Plus.blp")
				mbtn:GetNormalTexture():SetTexCoord(0.125, 0.25, 0.21875, 0.25)
			end
			mbtn:SetHighlightTexture("Interface\\AddOns\\Leatrix_Plus\\vanilla\\Leatrix_Plus.blp")
