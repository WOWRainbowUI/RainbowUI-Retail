...
L["Hide the day and night indicator"] = "隱藏日夜指示器"
...
L["If checked, the day and night indicator will be hidden."] = "勾選後，日夜指示器會被隱藏。"
...
L["If checked, the Reflecting Prism transform will be removed when applied."] = "勾選後，反射棱鏡的變換在套用時會被移除。"
