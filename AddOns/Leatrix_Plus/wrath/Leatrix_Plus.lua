----------------------------------------------------------------------
-- 	Leatrix Plus 3.80.07 (15th July 2026)
----------------------------------------------------------------------
...
----------------------------------------------------------------------
-- 	Leatrix Plus (based on BCA core)
----------------------------------------------------------------------
	...
	do
		...
		if gametocversion and gametocversion > 39999 then
			-- Game client is not Titan Reforged Classic
...
----------------------------------------------------------------------
	...
	function LeaPlusLC:Player()
		...
		if LeaPlusLC["ShowWowheadLinks"] == "On" then
			...
			local wowheadLoc
			if GameLocale == "deDE" then wowheadLoc = "de.wotlk.wowhead.com"
			elseif GameLocale == "esMX" then wowheadLoc = "mx.wotlk.wowhead.com"
			elseif GameLocale == "esES" then wowheadLoc = "es.wotlk.wowhead.com"
			elseif GameLocale == "frFR" then wowheadLoc = "fr.wotlk.wowhead.com"
			elseif GameLocale == "itIT" then wowheadLoc = "it.wotlk.wowhead.com"
			elseif GameLocale == "ptBR" then wowheadLoc = "pt.wotlk.wowhead.com"
			elseif GameLocale == "ruRU" then wowheadLoc = "ru.wotlk.wowhead.com"
			elseif GameLocale == "koKR" then wowheadLoc = "ko.wotlk.wowhead.com"
			elseif GameLocale == "zhCN" then wowheadLoc = "cn.wotlk.wowhead.com"
			elseif GameLocale == "zhTW" then wowheadLoc = "tw.wotlk.wowhead.com"
			else							 wowheadLoc = "wotlk.wowhead.com"
			end
		...
		do
			...
			local npcTable = {
				...
				-- Stable masters (https://www.wowhead.com/wotlk/npcs?filter=27%3B1%3B0)
				28690, 16185, 16824, 9982, 9988, 23392, 28047, 15131, 9977, 18250, 26504, 26944, 29740, 26044, 22469, 13616, 21336, 24905, 17666, 10054, 17485, 11069, 10045, 19476, 10052, 10055, 25037, 9986, 10062, 13617, 10057, 10053, 11119, 6749, 26721, 10049, 23733, 14741, 30008, 21518, 16665, 10051, 9987, 18984, 11105, 10056, 16764, 27010, 29658, 16094, 10058, 10060, 29906, 10085, 17896, 9983, 10061, 9985, 9989, 24974, 10063, 24350, 9979, 16656, 9980, 9981, 35290, 9976, 9978, 19018, 29959, 10059, 11117, 10046, 19368, 28790, 10048, 16586, 21517, 18244, 19019, 10047, 22468, 10050, 11104, 15722, 26597, 9984,

				-- Banker (https://www.wowhead.com/wotlk/npcs?filter=19;1;0)
				2459, 35642, 2625, 31420, 16615, 17773, 30604, 8357, 17633, 2460, 19246, 2457, 3318, 28343, 4550, 16616, 2458, 30605, 28678, 5060, 17631, 8356, 3496, 4155, 3309, 31421, 19338, 29283, 8123, 28675, 38921, 2461, 29530, 16617, 17632, 36284, 13917, 21733, 16710, 19034, 2456, 30608, 30606, 31422, 3320, 28676, 28679, 28677, 2996, 4549, 8119, 21734, 38920, 4209, 7799, 19318, 18350, 4208, 21732, 2455, 29282, 8124, 36351, 5099, 28680, 30607, 36352, 38919,

				-- Flightmaster (https://www.wowhead.com/wotlk/npcs?filter=21;1;0)
				19910, 19908, 22015, 907, 29533, 15008, 29676, 21235, 29669, 20274, 16696, 15103, 29668, 35002, 34991, 14990, 10360, 34989, 30566, 32333, 20273, 29674, 19923, 29670, 20499, 347, 16695, 14942, 2804, 14991, 35008, 30567, 34998, 29673, 14981, 15106, 19907, 20271, 34973, 16694, 25991, 32330, 32332, 15102, 29671, 19906, 30610, 15105, 29667, 19858, 29568, 2302, 40413, 20388, 20385, 19911, 3890, 5118, 34983, 34997, 15006, 857, 20383, 22013, 20497, 12197, 34987, 20362, 20118, 34999, 20381, 20374, 34988, 35007, 20119, 19925, 34985, 30231, 34976, 35001, 19855, 7427, 19905, 20120, 20276, 20384, 19912, 18895, 29675, 34955, 20272, 14982, 20386, 12198, 19859, 19915, 35000, 20269, 34978, 19909, 15007, 7410, 29672,
			...
			local function SetChainStyle()
				...
				if chain == 1 then -- Rare
					if C_AddOns.IsAddOnLoaded("EasyFrames") then
						PlayerFrameTexture:SetTexture("Interface\\AddOns\\Leatrix_Plus\\wrath\\Leatrix_Plus.blp")
		...
		if LeaPlusLC["ShowFlightTimes"] == "On" then
			...
			local gameTitle = L["Titan Reforged Classic"]
		...
		if LeaPlusLC["MinimapModder"] == "On" and not LeaLockList["MinimapModder"] then
			...
			LeaPlusLC:MakeCB(SideMinimap, "HideMiniZoneText", "Hide the zone text bar", 16, -132, true, "If checked, the zone text bar will be hidden.")
		...
		if LeaPlusLC["EnhanceDressup"] == "On" then
			...
			----------------------------------------------------------------------
			-- Wardrobe (used by the wardrobe mount)
			----------------------------------------------------------------------

			-- Debug to load the wardrobe frame at startup
			local DebugWardrobeFrame = nil
			if DebugWardrobeFrame then
				CharacterFrame:Show(); CharacterFrame:Hide()
				C_Timer.After(1, function() C_AddOns.LoadAddOn("Blizzard_Collections"); WardrobeFrame:Show() end)
			end
			...
			EventUtil.ContinueOnAddOnLoaded("Blizzard_Collections",function()
				...
				do
					...
					LeaPlusLC:MakeSL(WardrobeTransmogFrame, "TransmogAnim", "", 1, #animTable - 1, 1, 356, -92, "%.0f")
					LeaPlusCB["TransmogAnim"]:ClearAllPoints()
					LeaPlusCB["TransmogAnim"]:SetPoint("BOTTOM", -12, 12)
					LeaPlusCB["TransmogAnim"]:SetWidth(226)
					...
					LeaPlusCB["TransmogAnim"]:HookScript("OnValueChanged", function(self, setting)
						...
						if playerActor and setting ~= lastSetting then
							lastSetting = setting
							WardrobeTransmogFrame.Model:SetAnimation(animTable[setting], 0, 1, 1)
							-- print(animTable[setting]) -- Debug
						end
					end)
		...
		if LeaPlusLC["EnhanceTrainers"] == "On" then
			...
			EventUtil.ContinueOnAddOnLoaded("Blizzard_TrainerUI",function()
				...
				regions[2]:SetTexture("Interface\\AddOns\\Leatrix_Plus\\wrath\\Leatrix_Plus")
				...
				regions[3]:SetTexture("Interface\\AddOns\\Leatrix_Plus\\wrath\\Leatrix_Plus")
		...
		if LeaPlusLC["EnhanceProfessions"] == "On" and not LeaLockList["EnhanceProfessions"] then
			...
			EventUtil.ContinueOnAddOnLoaded("Blizzard_TradeSkillUI",function()
				...
				-- Set top left texture
				regions[3]:SetTexture("Interface\\AddOns\\Leatrix_Plus\\wrath\\Leatrix_Plus.blp")
				...
				regions[4]:SetTexture("Interface\\AddOns\\Leatrix_Plus\\wrath\\Leatrix_Plus.blp")
				...
				TradeSkillInvSlotDropdown:SetPoint("TOPLEFT", TradeSkillFrame, "TOPLEFT", 550, -40)
		...
		do
			...
			local expTitle = LeaPlusLC:MakeTx(interPanel, L["Titan Reforged Classic"], 0, 0)
		...
		function LeaPlusLC:MediaFunc()
			...
			local function PlayTrack()
				-- Play tracks
				if musicHandle then StopSound(musicHandle) end
				local file, trackTime, soundID
				if strfind(playlist[tracknumber], ".mp3") or strfind(playlist[tracknumber], ".ogg") then
				...
				for index = 1, numButtons do
					...
					if item then
						if strfind(item, ".mp3") or strfind(item, ".ogg") then
		...
		if event == "ADDON_LOADED" then
			if arg1 == "Leatrix_Plus" then
				...
				do
					...
					-- Disable items that currently are not compatible with Titan Reforged Classic
					-- Lock("FilterChatMessages", L["This option is not currently available in Titan Reforged Classic"])
...
----------------------------------------------------------------------
	...
	function LeaPlusLC:CreateButton(name, frame, label, anchor, x, y, width, height, reskin, tip, naked)
		...
		if reskin then
			...
			if not naked then
				mbtn:SetNormalTexture("Interface\\AddOns\\Leatrix_Plus\\wrath\\Leatrix_Plus.blp")
				mbtn:GetNormalTexture():SetTexCoord(0.125, 0.25, 0.21875, 0.25)
			end
			mbtn:SetHighlightTexture("Interface\\AddOns\\Leatrix_Plus\\wrath\\Leatrix_Plus.blp")
...
----------------------------------------------------------------------
	...
	function LeaPlusLC:CreateMainPanel()
		...
		PageF.v:SetNonSpaceWrap(true); PageF.v:SetText(L["TRC"] .. " " .. LeaPlusLC["AddonVer"])
			...
			elseif str == "id" then
				...
				if not LeaPlusLC.WowheadLock then
					-- Set Wowhead link prefix
						if GameLocale == "deDE" then LeaPlusLC.WowheadLock = "de.wotlk.wowhead.com"
					elseif GameLocale == "esMX" then LeaPlusLC.WowheadLock = "mx.wotlk.wowhead.com"
					elseif GameLocale == "esES" then LeaPlusLC.WowheadLock = "es.wotlk.wowhead.com"
					elseif GameLocale == "frFR" then LeaPlusLC.WowheadLock = "fr.wotlk.wowhead.com"
					elseif GameLocale == "itIT" then LeaPlusLC.WowheadLock = "it.wotlk.wowhead.com"
					elseif GameLocale == "ptBR" then LeaPlusLC.WowheadLock = "pt.wotlk.wowhead.com"
					elseif GameLocale == "ruRU" then LeaPlusLC.WowheadLock = "ru.wotlk.wowhead.com"
					elseif GameLocale == "koKR" then LeaPlusLC.WowheadLock = "ko.wotlk.wowhead.com"
					elseif GameLocale == "zhCN" then LeaPlusLC.WowheadLock = "cn.wotlk.wowhead.com"
					elseif GameLocale == "zhTW" then LeaPlusLC.WowheadLock = "tw.wotlk.wowhead.com"
					else							 LeaPlusLC.WowheadLock = "wotlk.wowhead.com"
					end
				end
							...
							if b.tracks then
								for k, v in pairs(b.tracks) do
									...
									if not strfind(v, "|c") then
										if not strfind(v, ".mp3") and not strfind(v, ".ogg") then
