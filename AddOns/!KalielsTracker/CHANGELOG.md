...
- FIXED - taint errors
  - Clicking on entries in the tracker is only available out of combat.
  - Clicking on a quest opens the map, but not the quest details panel.
  - The small “Eye” button is no longer available.
