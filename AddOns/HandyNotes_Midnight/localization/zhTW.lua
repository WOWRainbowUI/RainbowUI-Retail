...
L['void_shielded_tomb_note'] = '喝下附近桌上的 {object:分離藥水}，然後跑到對面的建築物，拾取 {item:251519} 並使用它來解鎖寶箱。\n\n' .. ns.color.Red('需要等級 90')
...
L['exaliburn_note'] = '喝下附近的 {object:無可置疑之力藥水}，然後拔出 Exaliburn。'
L['voidhoarders_corpse'] = '虛空囤積者的屍體'
L['blackcore_note'] = '在標記區域內擊殺 {npc:248462} 或 {npc:248483} 以取得 3 個 {item:248680}，然後與 {object:奇點透鏡}互動以召喚稀有怪。'
...
L['options_icons_put_a_pin_in_it_desc'] = '顯示 {achievement:62199} 成就的位置。'
L['kalika_note'] = '與 {npc:258884} 對話，然後與附近 {object:翠玉雕像} 後方的 {object:遺忘的鈕扣} 互動。'
L['songseeker_ikaja_note'] = '位於神殿頂端。'
...
L['gulf_of_memory_chest_note'] = '沿著樹根往上走，就能到達寶藏。'
