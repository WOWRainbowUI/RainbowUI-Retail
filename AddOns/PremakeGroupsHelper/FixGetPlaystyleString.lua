...
real_LFGListEntryCreation_SetTitleFromActivityInfo = LFGListEntryCreation_SetTitleFromActivityInfo;
...
LFGListEntryCreation_SetTitleFromActivityInfo = function(self)
	...
	if((activityInfo and activityInfo.isMythicPlusActivity) or not C_LFGList.IsPlayerAuthenticatedForLFG(self.selectedActivity)) then 
		C_LFGList.SetEntryTitle(self.selectedActivity, self.selectedGroup, 0);
	end
end		
