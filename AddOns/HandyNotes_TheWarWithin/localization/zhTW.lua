...
L['10_surprisingly_pristine_celebration_crate'] = '1. 從 {location:卡林多} 的 {location:安其拉} 洞穴中收集 {item:228772}。\n\n2. 將 {item:228772} 放置在 {location:破碎群島} 的 {location:風暴峽灣} 的 {object:無標記的墳墓} 處。'
L['11_ghostly_celebration_crate'] = '位於 {location:兵主之座} 頂部傳送門右側。'
...
L['options_icons_ratts_revenge_desc'] = '顯示 {achievement:40967} 成就中秘密的位置。'

-- INERT PECULIAR KEY
L['inert_peculiar_key_note'] = '藏在巨大的中空樹干裡板條箱後面。\n\n{note:下一個位置：}\n如果 {bug:*沒有*} {item:228938}，請前往 {location:卡茲阿加} 的 {location:多恩諾加爾}。\n\n如果 |cFF00FF00*有*|r {item:228938}，請前往 {location:東部王國} 的 {location:逆風小徑}。'

-- PECULIAR GEM
L['carefully_penned_note'] = '佩戴 {title:偵探} 頭銜與 {npc:230042} 交談以接受 {quest:84684}。\n\n{note:下一個位置：}{location:艾基-卡赫特}'
L['unfinished_note'] = '在 {location:淵行者小徑} 的一個小洞穴中，周圍是一圈 {npc:229596}。\n\n{note:下一個位置：}{location:千絲之城}'
L['hastily_scrawled_note'] = '在能高高俯瞰 {location:千絲之城} 的岩壁上。\n\n{note:下一個位置：}{location:隕聖峪}'
L['water_resistant_note'] = '在 {location:艾基-卡赫特} 和 {location:隕聖峪} 之間懸崖高處的隱秘湖泊中心。\n\n{note:下一個位置：}{location:艾基-卡赫特} 的 {location:菲琳之邁}'
L['peculiar_gem_note'] = '到達 {location:沃什柱巢}，穿過山洞內隱藏的洞口。\n\n{note:洞口隱藏在牆壁上，需要巧妙跳躍。}\n\n接近 {npc:233550}，她會逃跑並丟下 {item:228938}。\n\n{note:下一個位置：}\n如果 {bug:*沒有*} {item:228941}，請前往 {location:卡利姆多} 的 {location:安戈洛環形山}。\n\n如果 |cFF00FF00有|r {item:228941}，請前往 {location:東部王國} 的 {location:逆風小徑}。'

-- KARAZHAN CATACOMBS
L['karazhan_catacombs_label'] = '卡拉贊墓穴'
L['karazhan_catacombs_entrance_note'] = '從 {location:卡利姆多} 的 {location:安格洛環形山} 開始收集 {item:44124}\n\n從 {location:卡茲阿加} 的 {location:多恩諾加爾} 開始收集 {item:228938}\n\n將寶石和鑰匙組合成 {item:44124}。\n\n將 {item:44124} 放入包中並激活 {item:208092}，接近大門即可看到一個紅色的副本入口。'

-- ORB 1
L['orb_1_label'] = '1號球'
L['orb_1_note'] = '在每個涉及 {npc:228249} 的位置使用 {item:208092}，獲得3層 {spell:153715} 中的1層。'
L['orb_1_locations'] = '1. {location:卡利姆多} 的 {location:北貧瘠之地}\n2. {location:德拉諾} 的 {location:納格蘭}\n3. {location:暗影界} 的 {location:瑪卓克薩斯}'
L['humble_monument'] = '不起眼的紀念碑'
L['olgra_location'] = '{note:位置根據 {quest:35170} 的完成情況而改變。}'

-- ORB 2
L['orb_2_label'] = '2號球'
L['orb_2_note'] = '站在 {npc:153297} 旁邊，使用 {npc:147393} 的以下禮物任意一個：\n\n{item:168123}\n{item:175140}\n{item:168004}\n\n召喚 {item:49912} 並使用以下服裝任意一個：\n\n{item:229413}\n{item:116812}\n\n輸入 {emote:/祈禱}、{emote:/pray} 表情並等待得到 {item:53156}。\n\n{note:周圍的其他玩家完成以上步驟也可獲得 {item:53156}。}\n\n返回 {location:卡拉贊墓穴} 並使用鑰匙打開帶有噴泉的房間的兩扇門。'

-- ORB 3
L['orb_3_label'] = '3號球'

L['astral_soup_label'] = '星界暖湯'
L['astral_chest_label'] = '星界寶箱'
L['astral_rewards_note'] = '在 {object:星界暖湯} 釣魚獲得 {item:228965}。\n\n使用 {item:228965} 打開 {object:星界寶箱} 並獲得 {item:228966}。\n\n現在可以從 {location:卡拉贊墓穴} 周圍的機器收集 {item:228967}。'

L['decryption_machine_label'] = '解碼機器'
L['decryption_console_label'] = '解碼控制台'
L['rubensteins_console'] = '魯布斯坦的控制台'

L['code_machine_note_1'] = '輸入代碼並打開 {object:“長者庫納尼的財物”} 得到 {item:228967}。\n\n{object:代碼}：88224646'
L['code_machine_note_2'] = '輸入代碼並打開 {object:加密的寶箱} 獲得 {item:228967}。\n\n{object:代碼}：10638'
L['code_machine_note_3'] = '輸入代碼並打開 {object:加密的寶箱} 獲得 {item:228967}。\n\n{object:代碼}：5661'
L['code_machine_note_4'] = '輸入代碼並打開 {object:魯布斯坦的保險箱} 獲得 {item:228967}。\n\n{object:代碼}：52233'
L['code_machine_note_5'] = '輸入代碼並打開 {object:加密的寶箱} 獲得 {item:228967}。\n\n{object:代碼}：51567'
L['code_machine_note_6'] = '輸入代碼並打開 {object:加密的寶箱} 獲得 {item:228967}。\n\n{object:代碼}：115'
L['code_machine_note_7'] = '輸入代碼並打開 {object:加密機關盒} 獲得 {item:228967}。\n\n{object:代碼}：17112317'
L['code_machine_note_8'] = '輸入代碼並打開 {object:加密的寶箱} 獲得 {item:228967}。\n\n{object:代碼}：19019'

L['slot_machine_label'] = '“試試手氣！”游戲機'
L['slot_machine_note_a'] = '收集五個幸運物品然後輸入代碼：\n\n'
L['slot_machine_note_b'] = '{location:暴風城} 的 {npc:2795}：\n'
L['slot_machine_note_c'] = '{location:多恩諾加爾} 的 {npc:219197}：\n'
L['slot_machine_note_d'] = '{location:歐恩哈拉平原} 的 {npc:186650}\n'
L['slot_machine_note_e'] = '{object:代碼}：777、77777 或 7777777'
L['slot_machine_vendor_note'] = '為 {object:“試試手氣！”游戲機} 購買這些物品。'

-- ORB 4
L['orb_4_label'] = '4號球'
L['vashti_note'] = '從 {npc:91079} 購買 {item:228987}，花費 %s。'
L['uthers_tomb_label'] = '烏瑟爾之墓'
L['uthers_tomb_note'] = '在 {location:西瘟疫之地} 的 {location:烏瑟爾之墓} 召喚一個 {npc:11859}。\n\n使用 {location:阿蘇納} 的 {npc:91079} 出售的 {item:228987} 或讓術士使用 {spell:342601}。\n\n一旦你死亡並復活，請閱讀隱藏的塗鴉。\n\n{note:只要 {npc:11859} 活著，塗鴉就會一直存在，所以不要殺死它！}'

-- ORB 5
L['orb_5_label'] = '5號球'
L['jeremy_feasel_note'] = '{npc:232048} 隱藏在 {location:永恆島} 的 {location:孤魂岩洞} 中。\n\n僅使用來自過去解密的戰鬥寵物在寵物戰鬥中擊敗 {npc:232048}。%s\n\n獲勝後，完成 {quest:84781} 以獲得 {item:228995}。\n\n現在可以去找 {location:藏寶海灣} 的 {npc:230310}。'
L['zarhym_note'] = '與洞穴內的 {npc:71876} 交談，進入靈魂位面。'
L['pointless_treasure_salesman_location'] = '隱藏於 {location:加尼羅哨站} 的地精雕像內。'
L['pointless_treasure_salesman_note'] = '購買 {item:228996}：'

-- ORB 6
L['orb_6_label'] = '6號球'
L['blood_altar_label'] = '鮮血祭壇'
L['corrupt_altar_label'] = '腐蝕祭壇'
L['lust_altar_label'] = '欲望祭壇'
L['sin_altar_label'] = '原罪祭壇'
L['void_altar_label'] = '虛空祭壇'

L['altar_note'] = '使用 {item:208092} 召喚靈魂。裝備某些坐騎、寵物、玩具或幻化來安撫它：'
L['blood_altar_note'] = '{object:%s}：名稱中帶有“血”的任何坐騎。\n\n{object:%s}：名稱中帶有“血”的任何寵物。\n\n{object:%s}：{item:127709}'
L['corrupt_altar_note'] = '{object:%s}：任何名稱中帶有“墮落或腐化”的坐騎。\n\n{object:%s}：任何名稱中帶有“墮落或腐化”的寵物。\n\n{object:%s}：{item:116067}\n\n{object:%s}：任何與 {item:86316} 外觀相同的披風。'
L['lust_altar_note'] = '{object:%s}：{pet:1628}\n\n{object:%s}：{item:129211}\n\n{object:%s}：完全赤裸或受到 {item:119092} 的影響'
L['sin_altar_note'] = '{object:%s}：{pet:2966}\n\n{object:%s}：{item:183986}\n\n{object:%s}：任意溫西爾罪碑披風幻化'
L['void_altar_note'] = '{object:%s}：{pet:1234}，{pet:2434}，或 {pet:4543}\n\n{object:%s}：{item:119003} 和 {item:174830}\n\n{object:%s}：任何與 {item:24252} 外觀相同的披風'

L['chest_of_acquisitions_label'] = '收獲寶箱'
L['chest_of_acquisitions_note'] = '1. 安撫 {location:北荊棘谷} 的 {location:祖爾格拉布} 祭壇上的所有靈魂。\n\n2. 裝備 {item:228966} 並拾取 {object:收藏品寶箱} 以獲得 {item:229007}。'

-- Orb 7
L['orb_7_label'] = '7號球'
L['orb_7_summary'] = '1. 從 {location:阿蘇納} 的 {location:守望島} 開始。\n\n2. 使用島上各式各樣的 {object:看守者貓頭鷹} 雕像增強您的 {pet:1716} 的能力。\n\n3. 進入 {location:守望者地窟} 並擊敗首領以揭開秘密 {item:229046}。\n\n4. 使用 {item:229046} 開始具有挑戰性的邏輯謎題並最終揭開一個裝有 {item:229054} 的寶箱。'

L['marin_bladewing_note'] = '與 {faction:1894} 到達 %2$s 後，從 {npc:107379} 處以 %1$s 購買 {pet:1716}，或者從 {location:拍賣行} 購買。'
L['owl_of_the_watchers_label'] = '看守者貓頭鷹'
L['owl_of_the_watchers_note'] = '{note:每次只能激活3個雕像。}\n\n站在激活的雕像附近，召喚出 {pet:1716} 來收集全部4個增益：\n\n{spell:225049}\n{spell:225038}\n{spell:223160}\n{spell:225059}。\n\n一旦 {pet:1716} 獲得強化，\n\n{note:{pet:1716} 被白色煙霧跟隨}\n\n即可進入 {location:守望者地窟} 地下城。'

L['sentry_statue_note'] = '1. 擊敗 {npc:95885} 以打開 {location:暗夜大廳} 內的秘密房間。\n\n2. 擊敗其余首領，包括 {npc:95888}。\n\n3. 將 {spell:204481} 和 {pet:1716} 帶回秘密房間將出現 {item:229046}。\n\n4. 將 {item:229046} 帶到 {npc:95887} 房間。'
L['sentry_note'] = '1. 將 {item:229046} 放在入口處將出現 {npc:109300}。\n\n2. 與 {npc:109300} 互動以開始解謎。目標是將所有 {npc:98082} 放入地板。\n\n3. 完成後，拾取 {object:守望者的珍寶} 獲得 {item:229054}。'

-- Orb 8
L['orb_8_label'] = '8號球'

L['enigma_machine_label'] = '謎之機械'
L['enigma_machine_note'] = '1. 將 {item:229007} 和 {item:229054} 插入 {object:謎之機械}。\n\n2. 單擊“開始”，然後單擊“提交”。現在必須解鎖3個隱藏的鎖。\n\n3. 通過計算副本中的每個 {npc:230596}、將正確數量的雕像拖到正確的平台上並再次單擊“提交”來解鎖。\n\n{note:建議殺死每個 {npc:230599}，但不計算，以防止它們站在平台上。}'

L['lock_statue_note'] = '拖拽此雕像到一個平台。'
