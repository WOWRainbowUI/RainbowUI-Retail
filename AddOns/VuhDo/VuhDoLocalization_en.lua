...
VUHDO_I18N_TEXT_PROVIDER_SOURCE_MANA = "Mana";
...
VUHDO_I18N_TEXT_PROVIDER_SOURCE_CHI = "Chi";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_HOLY_POWER = "Holy Power";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_COMBO_POINTS = "Combo Points";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_SOUL_SHARDS = "Soul Shards";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_RUNES = "Runes";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_ARCANE_CHARGES = "Arcane Charges";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_THREAT = "Threat";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_OVERHEAL = "Overheal";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_INCOMING_HEAL = "Incoming Heal";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_SHIELD_ABSORB = "Shield Absorb";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_HEAL_ABSORB = "Heal Absorb";
