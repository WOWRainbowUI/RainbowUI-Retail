...
VUHDO_UNIT_WATCH_TYPE_HEAL = 1;
VUHDO_UNIT_WATCH_TYPE_TARGET = 2;
VUHDO_UNIT_WATCH_TYPE_TOT = 3;
...
VUHDO_I18N_AURA_GROUP_NAMES = {
	...
	["FERAL_DRUID_BUFFS"] = VUHDO_I18N_AURA_GROUP_FERAL_DRUID_BUFFS,
...
VUHDO_UPDATE_HEALTH_LOSS = 44;
VUHDO_UPDATE_AURA_INFERENCE = 50;
VUHDO_UPDATE_BOUQUET_RESET = -1;
...
VUHDO_DEFAULT_AURA_GLOW_STYLE = "vuhdopixel";
...
VUHDO_BOUQUET_CUSTOM_TYPE_AURA_GROUP = 11;

VUHDO_BOUQUET_VALUE_TYPE_NONE = 0;
VUHDO_BOUQUET_VALUE_TYPE_AURA = 1;
VUHDO_BOUQUET_VALUE_TYPE_STATUS = 2;

VUHDO_BOUQUET_STATUS_TYPE_HEALTH = 1;
VUHDO_BOUQUET_STATUS_TYPE_MANA = 2;
VUHDO_BOUQUET_STATUS_TYPE_POWER = 3;
VUHDO_BOUQUET_STATUS_TYPE_ALTPOWER = 4;
VUHDO_BOUQUET_STATUS_TYPE_INCOMING = 5;
VUHDO_BOUQUET_STATUS_TYPE_ABSORB = 6;
VUHDO_BOUQUET_STATUS_TYPE_HEAL_ABSORB = 7;
VUHDO_BOUQUET_STATUS_TYPE_THREAT = 8;
VUHDO_BOUQUET_STATUS_TYPE_FULL = 9;

VUHDO_SECRET_TYPE_NONE = 0;
VUHDO_SECRET_TYPE_BOOLEAN = 1;
VUHDO_MAX_ALPHA_CHAIN_STEPS = 3;
...
VUHDO_BOUQUET_LAYER_TYPE_BOOLEAN = 6;
...
VUHDO_AURA_DATA_RESTRICTED = false;

VUHDO_FORCE_AURA_MODE = nil;

local tAuraModeTemplateInfo = C_XMLUtil.GetTemplateInfo("CustomAuraContainerTemplate");
...
VUHDO_BOUQUET_RESTRICTED_UNSUPPORTED = 3;
VUHDO_BOUQUET_RESTRICTED_MIXED = 4;
