...
VUHDO_BUFF_TARGET_MODE_STANDARD = 1;
VUHDO_BUFF_TARGET_MODE_NAME = 2;
VUHDO_BUFF_TARGET_MODE_ROLE = 3;
VUHDO_BUFF_TARGET_MODE_TARGET = 4;
VUHDO_BUFF_TARGET_MODE_FOCUS = 5;
