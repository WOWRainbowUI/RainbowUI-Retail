...
VUHDO_SPELL_ID.THUNDERSTRIKE_WARD = VUHDO_getSpellInfoSafe(462757);
VUHDO_SPELL_ID.TIDECALLERS_GUARD = VUHDO_getSpellInfoSafe(457481);
...
VUHDO_SPELL_ID.BUFF_RITE_OF_SANCTIFICATION = VUHDO_getSpellInfoSafe(433568);


-- Druid
VUHDO_SPELL_ID.BUFF_MARK_OF_THE_WILD = VUHDO_getSpellInfoSafe(1126);
VUHDO_SPELL_ID.BUFF_SYMBIOTIC_RELATIONSHIP = VUHDO_getSpellInfoSafe(474750);
