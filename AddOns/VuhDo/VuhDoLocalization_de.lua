...
VUHDO_I18N_DEMON_HUNTERS = "Dämonenjäger";
...
VUHDO_I18N_AURA_GROUP_MY_HOTS = "Eigene HoTs (Kampf-Auras)";
VUHDO_I18N_AURA_GROUP_OTHERS_HOTS = "Fremde' HoTs (Kampf-Auras)";
VUHDO_I18N_AURA_GROUP_ALL_HOTS = "Alle HoTs (Kampf-Auras)";
VUHDO_I18N_AURA_GROUP_DISPELLABLE = "Dispellbare Debuffs";
VUHDO_I18N_AURA_GROUP_CC = "CC Effekte";
VUHDO_I18N_AURA_GROUP_BIG_DEF = "Große Defensives";
VUHDO_I18N_AURA_GROUP_EXTERNAL_DEF = "Externe Defensives";
VUHDO_I18N_AURA_GROUP_ALL_DEBUFFS = "Alle Debuffs";
VUHDO_I18N_AURA_GROUP_ALL_BUFFS = "Alle Buffs";
VUHDO_I18N_AURA_GROUP_MY_BUFFS = "Meine klassenrelevanten Buffs";
VUHDO_I18N_AURA_GROUP_OTHERS_BUFFS = "Fremde' klassenrelevante Buffs";
VUHDO_I18N_AURA_GROUP_ALL_RAID_BUFFS = "Alle klassenrelevanten Buffs";
VUHDO_I18N_AURA_GROUP_RAID_DEBUFFS = "Raid Debuffs";
VUHDO_I18N_AURA_GROUP_IMPORTANT_BUFFS = "Wichtige Buffs";
VUHDO_I18N_AURA_GROUP_IMPORTANT_DEBUFFS = "Wichtige Debuffs";
VUHDO_I18N_AURA_GROUP_CANCELABLE = "Cancelbare Buffs";
VUHDO_I18N_AURA_GROUP_NOT_CANCELABLE = "Nicht-Cancelbare Buffs";
VUHDO_I18N_AURA_GROUP_TORGHAST_ANIMA = "Torghast Anima-Kräfte";
VUHDO_I18N_AURA_GROUP_INFERRED_RIPTIDE = "Springflut (Gefolgert)";
VUHDO_I18N_AURA_GROUP_INFERRED_ECHO = "Echo (Gefolgert)";
VUHDO_I18N_AURA_GROUP_INFERRED_ATONEMENT = "Abbitte (Gefolgert)";
VUHDO_I18N_AURA_GROUP_MY_NAMEPLATE = "Eigene Nameplate Debuffs";
VUHDO_I18N_AURA_GROUP_OTHERS_NAMEPLATE = "Fremde Nameplate Debuffs";
VUHDO_I18N_AURA_GROUP_ALL_NAMEPLATE = "Alle Nameplate Debuffs";
VUHDO_I18N_AURA_GROUP_MY_DEBUFFS = "Meine Debuffs";
VUHDO_I18N_AURA_GROUP_MY_EXTERNAL_DEF = "Meine Externen Defensives";
VUHDO_I18N_AURA_GROUP_MY_RAID_DEBUFFS = "Meine Raid Debuffs";
VUHDO_I18N_AURA_GROUP_PRESERVATION_EVOKER_HOTS = "Bewahrung-Rufer HoTs";
VUHDO_I18N_AURA_GROUP_AUGMENTATION_EVOKER_BUFFS = "Verstärkung-Rufer Buffs";
VUHDO_I18N_AURA_GROUP_RESTORATION_DRUID_HOTS = "Wiederherstellung-Druide HoTs";
VUHDO_I18N_AURA_GROUP_DISCIPLINE_PRIEST_HOTS = "Disziplin-Priester HoTs";
VUHDO_I18N_AURA_GROUP_HOLY_PRIEST_HOTS = "Heilig-Priester HoTs";
VUHDO_I18N_AURA_GROUP_MISTWEAVER_MONK_HOTS = "Nebelwirker-Mönch HoTs";
VUHDO_I18N_AURA_GROUP_RESTORATION_SHAMAN_HOTS = "Wiederherstellung-Shamane HoTs";
VUHDO_I18N_AURA_GROUP_HOLY_PALADIN_HOTS = "Heilig-Paladin HoTs";
VUHDO_I18N_AURA_GROUP_RAID_BUFFS = "Raid Buffs";
VUHDO_I18N_AURA_GROUP_BLESSING_OF_BRONZE = "Segen der Bronzenen";
VUHDO_I18N_AURA_GROUP_ROGUE_POISONS = "Schurken-Gifte";
VUHDO_I18N_AURA_GROUP_SHAMAN_WEAPON_IMBUEMENTS = "Shamanen-Waffenverzauberungen";
VUHDO_I18N_AURA_GROUP_PALADIN_WEAPON_IMBUEMENTS = "Paladin-Waffenverzauberungen";
VUHDO_I18N_AURA_GROUP_ENHANCEMENT_SHAMAN_BUFFS = "Verstärkung-Shamanen Buffs";
VUHDO_I18N_AURA_GROUP_BREWMASTER_MONK_BUFFS = "Braumeister-Mönch Buffs";
VUHDO_I18N_AURA_GROUP_WARLOCK_METAMORPHOSIS = "Hexenmeister-Metamorphose";
VUHDO_I18N_AURA_GROUP_MIGRATED_HOTS = "Migrierte HoTs";
VUHDO_I18N_AURA_GROUP_MIGRATED_HOT_ICONS = "Migrierte HoT Symbole";
VUHDO_I18N_AURA_GROUP_MIGRATED_HOT_BARS = "Migrierte HoT Balken";

VUHDO_I18N_BOUQUET_AURA_GROUP_ACTIVE = "Flag: Aura Group Active";
VUHDO_I18N_AURA_GROUP_FERAL_DRUID_BUFFS = "Wildheit-Druiden Buffs";
VUHDO_I18N_BW_MISS = "|cffff0000MISS|r";
VUHDO_I18N_BW_LOCK = "|cff4488ffLOCK|r";
VUHDO_I18N_BW_TARGET_MODE = "Anvisieren basierend auf:";
VUHDO_I18N_BW_TARGET_BY_NAME = "Spielername";
VUHDO_I18N_BW_TARGET = "Ziel";
VUHDO_I18N_BW_FOCUS = "Fokus";

VUHDO_I18N_AURA_GROUP_ALL_DISPELLABLE = "Alle Dispelbaren Debuffs";
