...
VUHDO_DEFER_REFRESH_PRIVATE_AURA_DISPEL_OVERLAY = 31;
VUHDO_DEFER_SHOW_PRIVATE_AURA_DISPEL_OVERLAY = 32;
...
local VUHDO_DEFERRED_TASK_TYPES = {
	...
	VUHDO_DEFER_REFRESH_PRIVATE_AURA_DISPEL_OVERLAY,
	VUHDO_DEFER_SHOW_PRIVATE_AURA_DISPEL_OVERLAY,
...
function VUHDO_initTaskSystem()
	...
	if not VUHDO_DEFERRED_TASK_STATE["isInit"] then
		sDeferredTaskDelegates = {
			...
			[VUHDO_DEFER_REFRESH_PRIVATE_AURA_DISPEL_OVERLAY] = _G["VUHDO_refreshPrivateAuraDispelOverlay"],
			[VUHDO_DEFER_SHOW_PRIVATE_AURA_DISPEL_OVERLAY] = _G["VUHDO_showPrivateAuraDispelOverlay"],
