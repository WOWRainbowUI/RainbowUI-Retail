...
VUHDO_DEFER_UPDATE_UNIT_VISIBILITY_CHARM_RANGE = 33;
VUHDO_DEFER_REFRESH_PANEL = 34;
VUHDO_DEFER_REFRESH_UI_COMPLETE = 35;
VUHDO_DEFER_REFRESH_PANEL_COMPLETE = 36;
VUHDO_DEFER_INIT_AURA_CONTAINERS_FOR_BUTTON = 37;
VUHDO_DEFER_SYNC_AURA_CONTAINERS_FOR_UNIT = 38;
VUHDO_DEFER_SYNC_OVERLAYS_FOR_UNIT = 39;
VUHDO_DEFER_DEGRADE_AURA_CACHE_FOR_UNIT = 40;
...
local VUHDO_DEFERRED_TASK_TYPES = {
	...
	VUHDO_DEFER_UPDATE_UNIT_VISIBILITY_CHARM_RANGE,
	VUHDO_DEFER_REFRESH_PANEL,
	VUHDO_DEFER_REFRESH_UI_COMPLETE,
	VUHDO_DEFER_REFRESH_PANEL_COMPLETE,
	VUHDO_DEFER_INIT_AURA_CONTAINERS_FOR_BUTTON,
	VUHDO_DEFER_SYNC_AURA_CONTAINERS_FOR_UNIT,
	VUHDO_DEFER_SYNC_OVERLAYS_FOR_UNIT,
	VUHDO_DEFER_DEGRADE_AURA_CACHE_FOR_UNIT,
...
local VUHDO_COMBAT_HELD_TASKS = {
	[VUHDO_DEFER_REFRESH_PRIVATE_AURAS] = true,
	[VUHDO_DEFER_ACQUIRE_OVERLAY_CONTAINER] = true,
	[VUHDO_DEFER_FLUSH_PENDING_OVERLAY_REBUILD] = true,
};
...
--
function VUHDO_deferInitAuraContainersForButton(aButton, aPanelNum, aPriority)

	VUHDO_deferTask(VUHDO_DEFER_INIT_AURA_CONTAINERS_FOR_BUTTON, aPriority or VUHDO_DEFERRED_TASK_PRIORITY_HIGH, aButton, aPanelNum);
...
--
function VUHDO_deferSyncAuraContainersForUnit(aUnit, aPriority)

	VUHDO_deferTask(VUHDO_DEFER_SYNC_AURA_CONTAINERS_FOR_UNIT, aPriority or VUHDO_DEFERRED_TASK_PRIORITY_HIGH, aUnit);
...
--
function VUHDO_deferSyncOverlaysForUnit(aUnit, aPriority)

	VUHDO_deferTask(VUHDO_DEFER_SYNC_OVERLAYS_FOR_UNIT, aPriority or VUHDO_DEFERRED_TASK_PRIORITY_NORMAL, aUnit);
...
--
function VUHDO_deferDegradeAuraCacheForUnit(aUnit, aPriority)

	VUHDO_deferTask(VUHDO_DEFER_DEGRADE_AURA_CACHE_FOR_UNIT, aPriority or VUHDO_DEFERRED_TASK_PRIORITY_NORMAL, aUnit);
...
--
function VUHDO_deferRefreshUnitAuras(aUnit, aPriority)

	VUHDO_deferTask(VUHDO_DEFER_REFRESH_UNIT_AURAS, aPriority or VUHDO_DEFERRED_TASK_PRIORITY_NORMAL, aUnit);
...
--
function VUHDO_deferAcquireOverlayContainer(aButton, anIndicatorKey, anEntryKey, aPriority)

	VUHDO_deferTask(VUHDO_DEFER_ACQUIRE_OVERLAY_CONTAINER, aPriority or VUHDO_DEFERRED_TASK_PRIORITY_NORMAL, aButton, anIndicatorKey, anEntryKey);
...
--
function VUHDO_deferFlushPendingOverlayRebuild(aPriority)

	VUHDO_deferTask(VUHDO_DEFER_FLUSH_PENDING_OVERLAY_REBUILD, aPriority or VUHDO_DEFERRED_TASK_PRIORITY_NORMAL);
...
function VUHDO_initTaskSystem()
	...
	if not VUHDO_DEFERRED_TASK_STATE["isInit"] then
		sDeferredTaskDelegates = {
			...
			[VUHDO_DEFER_UPDATE_UNIT_VISIBILITY_CHARM_RANGE] = _G["VUHDO_updateUnitVisibilityCharmRange"],
			[VUHDO_DEFER_REFRESH_PANEL] = _G["VUHDO_deferRefreshPanelDelegate"],
			[VUHDO_DEFER_REFRESH_UI_COMPLETE] = _G["VUHDO_deferRefreshUiCompleteDelegate"],
			[VUHDO_DEFER_REFRESH_PANEL_COMPLETE] = _G["VUHDO_deferRefreshPanelCompleteDelegate"],
			[VUHDO_DEFER_INIT_AURA_CONTAINERS_FOR_BUTTON] = _G["VUHDO_initAuraContainersForButton"],
			[VUHDO_DEFER_SYNC_AURA_CONTAINERS_FOR_UNIT] = _G["VUHDO_syncAuraContainersForUnit"],
			[VUHDO_DEFER_SYNC_OVERLAYS_FOR_UNIT] = _G["VUHDO_syncOverlaysForUnit"],
			[VUHDO_DEFER_DEGRADE_AURA_CACHE_FOR_UNIT] = _G["VUHDO_degradeAuraCacheForUnit"],
