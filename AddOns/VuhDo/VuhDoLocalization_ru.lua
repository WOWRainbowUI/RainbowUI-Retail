...
VUHDO_I18N_BOUQUET_AURA_GROUP_ACTIVE = "Flag: Aura Group Active";
VUHDO_I18N_AURA_GROUP_FERAL_DRUID_BUFFS = "Feral Druid Buffs";
VUHDO_I18N_BW_MISS = "|cffff0000MISS|r";
VUHDO_I18N_BW_LOCK = "|cff4488ffLOCK|r";
VUHDO_I18N_BW_TARGET_MODE = "Target by";
VUHDO_I18N_BW_TARGET_BY_NAME = "Player name";
VUHDO_I18N_BW_TARGET = "Target";
VUHDO_I18N_BW_FOCUS = "Focus";

VUHDO_I18N_AURA_GROUP_ALL_DISPELLABLE = "All Dispellable Debuffs";

VUHDO_I18N_TEXT_PROVIDER_SOURCE_MANA = "Мана";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_RAGE = "Rage";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_FOCUS = "Focus";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_ENERGY = "Energy";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_RUNIC_POWER = "Runic Power";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_LUNAR_POWER = "Astral Power";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_MAELSTROM = "Maelstrom";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_INSANITY = "Insanity";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_FURY = "Fury";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_PAIN = "Pain";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_ESSENCE = "Essence";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_ALL_POWERS = "All Powers";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_CHI = "Ци";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_HOLY_POWER = "Энергия света";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_COMBO_POINTS = "Очки комбо";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_SOUL_SHARDS = "Осколки души";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_RUNES = "Руны";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_ARCANE_CHARGES = "Чародейские заряды";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_THREAT = "Угроза";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_OVERHEAL = "Избыточное исцеление";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_INCOMING_HEAL = "Входящее исцеление";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_SHIELD_ABSORB = "Защищающий щит";
VUHDO_I18N_TEXT_PROVIDER_SOURCE_HEAL_ABSORB = "Общее поглощение исцеления";
VUHDO_I18N_TEXT_PROVIDER_FORMAT_PERCENT = "<#n>%";
VUHDO_I18N_TEXT_PROVIDER_FORMAT_PERCENT_TENTH = "<#n/10%>";
VUHDO_I18N_TEXT_PROVIDER_FORMAT_UNIT_OF_UNIT = "<#n>/<#n>";
VUHDO_I18N_TEXT_PROVIDER_FORMAT_KILO_OF_KILO = "<#nk>/<#nk>";
