...
local btnName = {
    {name="啟用世界文字名字", tab=2, dop=false, space=false},
    
}

local btcNameGeneral = {
    {name="只顯示名字", tab=1, dop=false, space=false},
}
...
worldTextSizeSlider.textBox:SetText("世界文字大小:")
...
worldTextMinAlphaSlider.textBox:SetText("世界文字透明度:")
