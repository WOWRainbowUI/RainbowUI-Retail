...
local function AscendingDescendingSec(self, var1, var2)
	if self.casting then
		if VCBrBoss[var1]["Decimals"] == 2 then
			if VCBrBoss[var1]["Sec"] == "顯示" then
				if VCBrBoss[var1]["Direction"] == "正數" or VCBrBoss[var1]["Direction"] == "兩者" then
					var2:SetFormattedText("%.2f 秒", self.value)
				elseif VCBrBoss[var1]["Direction"] == "倒數" then
					local VCBdescending = self.maxValue - self.value
					var2:SetFormattedText("%.2f 秒", VCBdescending)
				end
			elseif VCBrBoss[var1]["Sec"] == "隱藏" then
				if VCBrBoss[var1]["Direction"] == "正數" or VCBrBoss[var1]["Direction"] == "兩者" then
		...
		elseif VCBrBoss[var1]["Decimals"] == 1 then
			if VCBrBoss[var1]["Sec"] == "顯示" then
				if VCBrBoss[var1]["Direction"] == "正數" or VCBrBoss[var1]["Direction"] == "兩者" then
					var2:SetFormattedText("%.1f 秒", self.value)
				elseif VCBrBoss[var1]["Direction"] == "倒數" then
					local VCBdescending = self.maxValue - self.value
					var2:SetFormattedText("%.1f 秒", VCBdescending)
				end
			elseif VCBrBoss[var1]["Sec"] == "隱藏" then
				if VCBrBoss[var1]["Direction"] == "正數" or VCBrBoss[var1]["Direction"] == "兩者" then
		...
		elseif VCBrBoss[var1]["Decimals"] == 0 then
			if VCBrBoss[var1]["Sec"] == "顯示" then
				if VCBrBoss[var1]["Direction"] == "正數" or VCBrBoss[var1]["Direction"] == "兩者" then
					var2:SetFormattedText("%.0f 秒", self.value)
				elseif VCBrBoss[var1]["Direction"] == "倒數" then
					local VCBdescending = self.maxValue - self.value
					var2:SetFormattedText("%.0f 秒", VCBdescending)
				end
			elseif VCBrBoss[var1]["Sec"] == "隱藏" then
				if VCBrBoss[var1]["Direction"] == "正數" or VCBrBoss[var1]["Direction"] == "兩者" then
	...
	elseif self.channeling then
		if VCBrBoss[var1]["Decimals"] == 2 then
			if VCBrBoss[var1]["Sec"] == "顯示" then
				if VCBrBoss[var1]["Direction"] == "倒數" or VCBrBoss[var1]["Direction"] == "兩者" then
					var2:SetFormattedText("%.2f 秒", self.value)
				elseif VCBrBoss[var1]["Direction"] == "正數" then
					local VCBdescending = self.maxValue - self.value
					var2:SetFormattedText("%.2f 秒", VCBdescending)
				end
			elseif VCBrBoss[var1]["Sec"] == "隱藏" then
