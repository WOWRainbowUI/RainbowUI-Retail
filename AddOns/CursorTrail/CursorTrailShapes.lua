...
function ShapeDropDown_AddLines(dropdown)
    ...
    dropdown:AddItem( "圓形 1",                   kMediaPath.."Circle 1.tga" )
    dropdown:AddItem( "圓形 2",                   kMediaPath.."Circle 2.tga" )
    dropdown:AddItem( "十字 1",                    kMediaPath.."Cross 1.tga" )
    dropdown:AddItem( "十字 2",                    kMediaPath.."Cross 2.tga" )
    dropdown:AddItem( "十字 3",                    kMediaPath.."Cross 3.tga" )
    dropdown:AddItem( "發光",                       kMediaPath.."Glow 1.tga" )
    dropdown:AddItem( "發光 (反向)",            kMediaPath.."Glow Reversed.tga" )
    dropdown:AddItem( "環形 - 祕法",              "Interface\\UnitPowerBarAlt\\Arcane_Circular_Frame" )
    dropdown:AddItem( "環形 - 火焰",                "Interface\\UnitPowerBarAlt\\Fire_Circular_Frame" )
    dropdown:AddItem( "環形 1",                     kMediaPath.."Ring 1.tga" )
    dropdown:AddItem( "環形 1 (柔和)",              kMediaPath.."Ring Soft 1.tga" )
    dropdown:AddItem( "環形 2",                     kMediaPath.."Ring 2.tga" )
    dropdown:AddItem( "環形 2 (柔和)",              kMediaPath.."Ring Soft 2.tga" )
    dropdown:AddItem( "環形 3",                     kMediaPath.."Ring 3.tga" )
    dropdown:AddItem( "環形 3 (柔和)",              kMediaPath.."Ring Soft 3.tga" )
    dropdown:AddItem( "環形 4",                     kMediaPath.."Ring 4.tga" )
    dropdown:AddItem( "環形 4 (柔和)",              kMediaPath.."Ring Soft 4.tga" )
    dropdown:AddItem( "球體",                     kMediaPath.."Sphere Edge 2.tga" )
    dropdown:AddItem( "星星",                       kMediaPath.."Star 1.tga" )
    dropdown:AddItem( "漩渦",                      kMediaPath.."Swirl.tga" )
