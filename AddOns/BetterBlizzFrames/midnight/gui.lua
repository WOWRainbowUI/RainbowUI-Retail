...
--[=[
    ...
    local starterButton = CreateClassButton(BetterBlizzFrames, "STARTER", L["Starter"], nil, function()
        ShowProfileConfirmation("Starter", "STARTER", BBF.StarterProfile, L["|cff808080(If you want to completely reset BBF there\nis a button in Advanced Settings)|r\n\n"])
    end)
...
function BBF.InitializeOptions()
    if not BetterBlizzFrames then
        ...
        BetterBlizzFrames.name = L["Better|cff00c0ffBlizz|rFrames |A:gmchat-icon-blizz:16:16|a"]
