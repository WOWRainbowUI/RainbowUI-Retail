...
L["Auto Close"] = "自動關閉"
L["Auto Close Tooltip"] = "點擊使用爐石後自動關閉遊戲主選單"
...
L["Teleports:Items:Filters:Items_To_Be_Obtained"] = "無法使用的物品"
...
L["ABOUT_ADDON"] = "|CFFFFFFFF此插件會將你可用的爐石與傳送技能加入到遊戲選單 (Esc)。\n\n你可以在遊戲中輸入 /tpm 並依照指令來更換所使用的爐石。\n\n若有問題、疑問，或缺少傳送/爐石項目，歡迎到 Github 與我聯繫。\n\n支援項目：\n\n 爐石\n 法師傳送/傳送門\n 工程學蟲洞\n 英雄之路傳送\n 各職業傳送技能 (禪修、死亡之門、星界傳送等)|r"
L["ABOUT_CONTRIBUTORS"] = "活躍貢獻者: |CFFFFFFFF\n\n%s\n\n|r"