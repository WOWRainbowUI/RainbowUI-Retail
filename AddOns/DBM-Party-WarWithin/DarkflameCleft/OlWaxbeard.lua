...
local specWarnRecklessCharge				= mod:NewSpecialWarningYouCount(422122, nil, nil, nil, 2, 2, nil, nil, "runout")
local yellCharge							= mod:NewShortYell(422122)
local yellChargeFades						= mod:NewShortFadesYell(422122)
local specWarnRockBuster					= mod:NewSpecialWarningDefensive(422245, nil, nil, nil, 1, 2, nil, nil, "defensive")
local specWarnCandle						= mod:NewSpecialWarningYou(423693, nil, nil, nil, 1, 2, nil, nil, "justrun")
local yellCandle							= mod:NewShortYell(423693, nil, false)
local specWarnUnderhandedTactic				= mod:NewSpecialWarningSwitchCount(428268, "Dps", nil, nil, 1, 2, nil, nil, "targetchange")
