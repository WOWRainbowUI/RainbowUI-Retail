...
--Custom Aura Sounds
mod:AddAuraSoundOption({434406,439790}, true, 434407, 1, 1, "targetyou", 2)--Rolling Acid target
mod:AddAuraSoundOption({439783,434090}, true, 434089, 1, 1, "runout", 12)--Spineret's Strands target
mod:AddAuraSoundOption(438957, true, 438957, 1, 2, "watchfeet", 8)--GTFO
