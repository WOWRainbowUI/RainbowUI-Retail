...
local specWarnThrowCinderBrew				= mod:NewSpecialWarningYou(432179, nil, nil, nil, 1, 17, nil, nil, "debuffyou")
local specWarnBlazingBelch					= mod:NewSpecialWarningDodgeCount(432198, nil, nil, nil, 2, 2, nil, nil, "breathsoon")
local specWarnKegSmash						= mod:NewSpecialWarningCount(432229, nil, nil, nil, 1, 2, nil, nil, "carefly")
local specWarnBrawl							= mod:NewSpecialWarningDodge(445180, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnGTFO							= mod:NewSpecialWarningGTFO(432196, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
