		-------------------------------------------------
		-- Paragon Reputation 1.53 by Fail US-Ragnaros --
		-------------------------------------------------
...
function ParagonReputation:LockButton()
	...
	InterfaceOptionsFrame_OpenToCategory(PR.L["Paragon Reputation"])
	InterfaceOptionsFrame_OpenToCategory(PR.L["Paragon Reputation"]) --Done twice just because of an odd glitch on this function.
	PR.toast:Hide()
	PR.toast.reset:Hide()
	PR.toast.lock:Hide()
