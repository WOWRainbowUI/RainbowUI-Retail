    ...
    rotation = {
      {
        ...
        context = "單目標",
        steps = {
          "{107574} shortly before或with Colossus Smash",
          "{167105}",
          ...
          "{7384}",
          "{772} to apply或refresh at <4 seconds remaining",
      ...
      },
      {
        ...
        context = "單目標",
        steps = {
          "{772} to apply或refresh Rend at <4 seconds remaining",
      ...
      },
      {
        ...
        steps = {
          ...
          "{228920} just before Colossus Smash",
          "{107574} just before或with Colossus Smash",
          "{167105}",
    ...
    rotation = {
      {
        ...
        steps = {
          ...
          "{163201} targets at或below 20%(35% if you have the talent) health.",
