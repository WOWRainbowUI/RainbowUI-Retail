...
ClassCodexIcyVeinsTalentData["PRIEST"] = {
  ["discipline"] = {
    talents = {
      { context = "團隊", buildLabel = "團隊", exportString = "CAQAAAAAAAAAAAAAAAAAAAAAAADsAz2MzMYmhZbmtZmZmhZAAAAAAAAAAMDLzgZmZYGmBmpZamBYmFMEGzyAMGsAAAjxMjBzAMzMaGG" },
      { context = "傳奇+", buildLabel = "傳奇+", exportString = "CAQAAAAAAAAAAAAAAAAAAAAAAADsYwyMjZmZGMbzYmZmZMzAAAAAAAAAAYGWmBzMzMMmZwmpZiBYmFMEGzyAMGsAAAjZmZMYGgZmRwA" },
      { context = "升級", buildLabel = "升級", exportString = "CAQAAAAAAAAAAAAAAAAAAAAAAADsYMzGjxYmZMbsNzMzMzAAAAAAAAAAgBLzgZmZwYmBbmmpZAzAAAYbWAGbGAAGDzYwMYmBjmB", leveling = true },
    },
  },
  ["holy"] = {
    talents = {
      { context = "升級", buildLabel = "升級", exportString = "CEQAAAAAAAAAAAAAAAAAAAAAAwYAAAAAAAMMzsMmxMzYMzALzMzMAAAAmZsNDGPwM2MGjZDmpAYmFMEGWGgBYxMmFAmxMMzgZAMjBA", leveling = true },
    },
  },
  ["shadow"] = {
    talents = {
