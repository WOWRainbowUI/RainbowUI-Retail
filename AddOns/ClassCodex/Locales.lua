...
-- Tooltip
L["Stat Priority on Tooltips"] = "滑鼠提示屬性優先級"
...
L["Wowhead BiS on Tooltips"] = "滑鼠提示Wowhead最佳裝備資訊"
L["Icy Veins BiS on Tooltips"] = "滑鼠提示Icy Veins最佳裝備資訊"
L["BiS Source"] = "最佳裝備來源"
L["Trinket Tier on Tooltips"] = "滑鼠提示飾品等級"
...
-- Settings: tooltip descriptions
L["Show stat priority rank (#1, #2, #3) next to stat names on item tooltips."] = "在物品滑鼠提示的屬性名稱旁顯示優先排名（#1、#2、#3）。"
L["Show which specs an item is Best in Slot for (Wowhead) on item tooltips."] = "在物品滑鼠提示中顯示該物品是哪些專精的最佳裝備 (Wowhead)。"
L["Show which specs an item is Best in Slot for (Icy Veins) on item tooltips."] = "在物品滑鼠提示中顯示該物品是哪些專精的最佳裝備 (Icy Veins)。"
L["Show trinket tier rankings and the tier badge on item tooltips."] = "在物品滑鼠提示中顯示飾品等級排名與等級標誌。"
L["Only show BiS and trinket tier info for your current class on tooltips."] = "滑鼠提示中僅顯示目前職業的最佳裝備與飾品等級資訊。"
