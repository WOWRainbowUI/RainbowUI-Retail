...
L["settings.label.dock_show_codexbuilds"] = "Show u.gg recommendations in menu"
...
L["settings.tooltip.dock_show_codexbuilds"] = "Include the u.gg-sourced recommended builds in the dock's click menu."
