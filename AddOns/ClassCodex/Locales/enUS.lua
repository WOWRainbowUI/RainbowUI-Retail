...
L["bis.help.ugg"] = "u.gg shows the gear top players actually run in Mythic+ and Raid this season — popularity-based, not a curated Best in Slot list."
...
L["empty.no_rotation_for"] = "No rotation for %s — check u.gg."
...
L["about.source_role.icyveins"] = "Editorial guides"
L["about.source_role.ugg"] = "Data-driven meta"
...
L["settings.tooltip.pin_talent_source"] = "Lock the talent pane to your manually selected source. When off, the source follows what you're doing — u.gg in dungeons and raids, PvP in arenas and battlegrounds, Icy Veins elsewhere."
...
L["settings.tooltip.dock_show_stat_targets"] = "Show the Stat Targets section (live bars vs u.gg BiS targets) on the Stats tab when the panel is docked."
L["settings.tooltip.float_show_stat_targets"] = "Show the Stat Targets section (live bars vs u.gg BiS targets) on the Stats tab when the panel is floating."
...
L["crafting.help.star"] = "u.gg's best-in-slot pick."
L["crafting.help.check"] = "Owned — in your bags, bank, equipped, or applied as an embellishment."
L["crafting.help.popular_ugg"] = "Popular on u.gg — top-2 most-played picks in u.gg's PvE top-player sample."
...
L["crafting.tooltip.popular_ugg"] = "Popular on u.gg"
...
L["settings.tooltip.crafting_top_picks_only"] = "Hide trailing entries on the Crafting tab — show only u.gg BiS and most-played picks."
