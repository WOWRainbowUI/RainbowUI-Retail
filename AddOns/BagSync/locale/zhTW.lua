...
L.DisplayCurrentPlayerOnly = "|cFFFFD700只顯示|r當前玩家的 BagSync 浮動提示資訊! |cFFDF2B2B(不建議)|r"
L.DisplayCurrentRealmName = "顯示玩家的 |cFF4CBB17[當前伺服器]|r"
L.DisplayCurrentRealmShortName = "|cFF4CBB17[當前伺服器]|r 顯示短名稱"
