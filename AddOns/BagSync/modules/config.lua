...
local function makeConfigPanel()
    ...
    if _G.Settings and type(_G.Settings) == "table" and _G.Settings.RegisterAddOnCategory then
		...
		frame = configDialog:AddToBlizOptions("BagSync", L.BagSync)
    else
...
BSYC.blizzPanel = configDialog:AddToBlizOptions("BagSync-General", options.args.main.name, L.BagSync)

-- Keybindings Options
config:RegisterOptionsTable("BagSync-Keybindings", options.args.keybindings)
configDialog:AddToBlizOptions("BagSync-Keybindings", options.args.keybindings.name, L.BagSync)

-- Tracking Options
config:RegisterOptionsTable("BagSync-Tracking", options.args.tracking)
configDialog:AddToBlizOptions("BagSync-Tracking", options.args.tracking.name, L.BagSync)

-- Display Options
config:RegisterOptionsTable("BagSync-Display", options.args.display)
configDialog:AddToBlizOptions("BagSync-Display", options.args.display.name, L.BagSync)

-- Color Options
config:RegisterOptionsTable("BagSync-Color", options.args.color)
configDialog:AddToBlizOptions("BagSync-Color", options.args.color.name, L.BagSync)

-- FAQ / Help Options
config:RegisterOptionsTable("BagSync-FAQ", options.args.faq)
configDialog:AddToBlizOptions("BagSync-FAQ", options.args.faq.name, L.BagSync)
