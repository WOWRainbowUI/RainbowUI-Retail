...
local specWarnConsumption			= mod:NewSpecialWarningDodge(322450, nil, nil, nil, 2, 2, nil, nil, "watchstep")
--local specWarnConsumptionKick		= mod:NewSpecialWarningInterrupt(322450, "HasInterrupt", nil, 2, 1, 2)
local specWarnAcceleratedIncubation	= mod:NewSpecialWarningSwitchCount(322550, "Dps", nil, nil, 1, 2, nil, nil, "killmob")
local specWarnMindLink				= mod:NewSpecialWarningMoveAway(322648, nil, nil, nil, 1, 11, nil, nil, "lineapart")
local yellMindLink					= mod:NewYell(322648)
local specWarnMarkedPrey			= mod:NewSpecialWarningYou(322563, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local specWarnAcidExpulsion			= mod:NewSpecialWarningDodgeCount(322654, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnCoalescingPoison		= mod:NewSpecialWarningRunCount(463602, nil, nil, nil, 4, 12, 4, nil, "pullin")
...
local specWarnGTFO					= mod:NewSpecialWarningGTFO(326309, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
