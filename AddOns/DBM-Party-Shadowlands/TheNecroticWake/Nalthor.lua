...
local specWarnCometStorm			= mod:NewSpecialWarningDodgeCount(320772, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnFrozenBinds			= mod:NewSpecialWarningYou(323730, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local yellFrozenBinds				= mod:NewYell(323730)
local yellFrozenBindsFades			= mod:NewShortYell(323730)
local specWarnDarkExile				= mod:NewSpecialWarningYou(321894, nil, nil, nil, 1, 5, nil, nil, "teleyou")
