	...
	function gameCooltip:TextAndIcon(index, frame, menuButton, leftTextSettings, rightTextSettings, leftIconSettings, rightIconSettings, isSecondFrame)
		...
		if (leftTextSettings) then
			...
			elseif (leftTextSettings[7]) then
				...
				--end
				DF:SetFont(menuButton.leftText, parseFont(gameCooltip.defaultFont), leftTextSettings[6] or gameCooltip.OptionsTable.TextSize or 14, leftTextSettings[8] or gameCooltip.OptionsTable.TextShadow or "")
			end
		...
		if (rightTextSettings) then
			...
			elseif (rightTextSettings[7]) then
				...
				DF:SetFontSize(menuButton.rightText, rightTextSettings[6] or gameCooltip.OptionsTable.TextSize or 14)
