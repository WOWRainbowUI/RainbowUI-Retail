	...
	function gameCooltip:TextAndIcon(index, frame, menuButton, leftTextSettings, rightTextSettings, leftIconSettings, rightIconSettings, isSecondFrame)
		...
		if (leftTextSettings) then
			...
			elseif (leftTextSettings[7]) then
				...
				--end
				menuButton.leftText:SetFont(parseFont(gameCooltip.defaultFont), leftTextSettings[6] or gameCooltip.OptionsTable.TextSize or 14, leftTextSettings[8] or gameCooltip.OptionsTable.TextShadow or "")
			end
		...
		if (rightTextSettings) then
			...
			elseif (rightTextSettings[7]) then
				...
				menuButton.rightText:SetFont(parseFont(gameCooltip.defaultFont), rightTextSettings[6] or gameCooltip.OptionsTable.TextSize or 14, rightTextSettings[8] or gameCooltip.OptionsTable.TextShadow or "")
			end
