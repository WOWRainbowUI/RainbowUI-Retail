...
frame.label.text = frame.label:CreateFontString(nil, "BORDER", "GameFontNormal")frame.label.text:SetFont(UNIT_NAME_FONT, 13, "")
...
local function GetButton(parent, index)
    if (not parent["button"..index]) then
        ...
        local buttonFont = GameFontNormal:GetFont()
        button.spec:SetFont(buttonFont, 11, "THINOUTLINE")
