...
function widgets:quickfocus(parent, config)
    ...
    for i, value in ipairs(config.dropdata or {}) do
        ...
        local rowFontFile = GameFontHighlightSmall:GetFont()
        row.text:SetFont(rowFontFile, 14, "THINOUTLINE")
...
frame.title:SetText(format("%s |cff33eeff%s|r", L["Tooltip"], L["menu.general"]))
...
framePC.title:SetText(format("%s |cff33eeff%s|r", L["Tooltip"], L["menu.player"]))
...
frameNPC.title:SetText(format("%s |cff33eeff%s|r", L["Tooltip"], L["menu.npc"]))
...
frameStatusbar.title:SetText(format("%s |cff33eeff%s|r", L["Tooltip"], L["menu.statusbar"]))
...
frameSpell.title:SetText(format("%s |cff33eeff%s|r", L["Tooltip"], L["menu.spell"]))
...
frameFont.title:SetText(format("%s |cff33eeff%s|r", L["Tooltip"], L["menu.font"]))
...
frameVariables.title:SetText(format("%s |cff33eeff%s|r", L["Tooltip"], L["menu.variables"]))
...
local diyTipsFontFile = frameDIY.tips:GetFont()
frameDIY.tips:SetFont(diyTipsFontFile, 12, "")
