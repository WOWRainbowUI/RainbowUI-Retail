...
local T = {
    ...
    ["dropdown.class"] = "職業顏色",
    ["dropdown.ctrl"] = "Ctrl",
    ["dropdown.cursor"] = "|cff33ccff滑鼠游標|r",
    ["dropdown.cursorRight"] = "滑鼠游標右側",
    ["dropdown.dark"] = "深黑",
    ...
    ["quickfocus.help"] = "按住輔助按鍵並點擊目標以設為專注目標，按住輔助按鍵並點擊空白處以專注目標。(點擊單位框架時該功能無效)",

    ["spell.background"] = "背景顔色",
    ["spell.borderColor"] = "邊框顔色",
    ["spell.modifierShowAll"] = "按住輔助按鍵顯示全部資訊",
    ["spell.showIcon"] = "法術圖示",
    ["spell.showSpellIconId"] = "顯示法術圖示 ID",
