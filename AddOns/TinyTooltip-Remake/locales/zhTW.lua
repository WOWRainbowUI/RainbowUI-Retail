...
["general.mask"]                        = "頂部光澤",
    ...
    ["general.alwaysShowIdInfo"]            = "總是顯示ID資訊",
    ["general.alwaysShowIdInfo.short"]      = "總是顯示ID資訊",
    ["general.alwaysShowIdInfo.hint"]       = "停用時可按住 Alt 或 Shift 鍵來顯示",
    ["general.idInfoMode.spellItem"]        = "顯示物品/法術ID",
    ["general.idInfoMode.icon"]             = "顯示圖示ID",
